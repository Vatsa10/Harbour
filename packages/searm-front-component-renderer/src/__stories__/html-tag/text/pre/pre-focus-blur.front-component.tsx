...
const PreFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="pre:focus-blur">
      <pre
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-pre-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'pre-focus-blur-front-component',
  description: 'Front component covering focus-blur on <pre>',
  component: PreFocusBlurFrontComponent,
});
