...
const RpFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="rp:focus-blur">
      <ruby>
        kanji
        <rp
          data-testid="subject"
...
export default defineFrontComponent({
  universalIdentifier: 'fc-rp-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'rp-focus-blur-front-component',
  description: 'Front component covering focus-blur on <rp>',
  component: RpFocusBlurFrontComponent,
});
