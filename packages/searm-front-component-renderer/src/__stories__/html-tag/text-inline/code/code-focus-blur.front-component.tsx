...
const CodeFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="code:focus-blur">
      <code
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-code-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'code-focus-blur-front-component',
  description: 'Front component covering focus-blur on <code>',
  component: CodeFocusBlurFrontComponent,
});
