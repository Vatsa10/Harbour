...
const UFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="u:focus-blur">
      <u
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-u-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'u-focus-blur-front-component',
  description: 'Front component covering focus-blur on <u>',
  component: UFocusBlurFrontComponent,
});
