...
const BFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="b:focus-blur">
      <b
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-b-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'b-focus-blur-front-component',
  description: 'Front component covering focus-blur on <b>',
  component: BFocusBlurFrontComponent,
});
