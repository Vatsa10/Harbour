...
const IClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="i:click">
      <i
        data-testid="subject"
        onClick={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-i-c-click-00000000-0000-0000-0000-000000000020',
  name: 'i-click-front-component',
  description: 'Front component covering click on <i>',
  component: IClickFrontComponent,
});
