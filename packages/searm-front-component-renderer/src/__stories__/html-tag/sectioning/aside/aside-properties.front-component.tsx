...
const AsidePropertiesFrontComponent = () => (
  <FrontComponentCard title="aside:properties">
    <aside
      data-testid="subject"
...
export default defineFrontComponent({
  universalIdentifier: 'fc-aside-props-00000000-0000-0000-0000-000000000020',
  name: 'aside-properties-front-component',
  description: 'Front component covering property reflection on <aside>',
  component: AsidePropertiesFrontComponent,
});
