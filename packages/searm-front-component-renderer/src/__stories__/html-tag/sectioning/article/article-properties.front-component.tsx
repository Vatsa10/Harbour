...
const ArticlePropertiesFrontComponent = () => (
  <FrontComponentCard title="article:properties">
    <article
      data-testid="subject"
...
export default defineFrontComponent({
  universalIdentifier: 'fc-article-props-00000000-0000-0000-0000-000000000020',
  name: 'article-properties-front-component',
  description: 'Front component covering property reflection on <article>',
  component: ArticlePropertiesFrontComponent,
});
