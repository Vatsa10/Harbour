...
const H4ClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="h4:click">
      <h4
        data-testid="subject"
        onClick={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-h4-c-click-00000000-0000-0000-0000-000000000020',
  name: 'h4-click-front-component',
  description: 'Front component covering click on <h4>',
  component: H4ClickFrontComponent,
});
