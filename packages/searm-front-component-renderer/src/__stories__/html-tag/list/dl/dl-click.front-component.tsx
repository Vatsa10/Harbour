...
const DlClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="dl:click">
      <dl
        data-testid="subject"
        onClick={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-dl-c-click-00000000-0000-0000-0000-000000000020',
  name: 'dl-click-front-component',
  description: 'Front component covering click on <dl>',
  component: DlClickFrontComponent,
});
