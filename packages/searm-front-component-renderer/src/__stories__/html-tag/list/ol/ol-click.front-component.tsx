...
const OlClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="ol:click">
      <ol
        data-testid="subject"
        onClick={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-ol-c-click-00000000-0000-0000-0000-000000000020',
  name: 'ol-click-front-component',
  description: 'Front component covering click on <ol>',
  component: OlClickFrontComponent,
});
