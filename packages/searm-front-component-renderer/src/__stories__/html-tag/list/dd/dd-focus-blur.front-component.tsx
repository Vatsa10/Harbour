...
const DdFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="dd:focus-blur">
      <dl>
        <dd
          data-testid="subject"
          onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-dd-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'dd-focus-blur-front-component',
  description: 'Front component covering focus-blur on <dd>',
  component: DdFocusBlurFrontComponent,
});
