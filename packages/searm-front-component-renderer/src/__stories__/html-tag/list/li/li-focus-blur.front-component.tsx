...
const LiFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="li:focus-blur">
      <li
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-li-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'li-focus-blur-front-component',
  description: 'Front component covering focus-blur on <li>',
  component: LiFocusBlurFrontComponent,
});
