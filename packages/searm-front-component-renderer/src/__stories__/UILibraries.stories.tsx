...
const searmUiTest: Story['play'] = async ({ canvasElement }) => {
  const canvas = within(canvasElement);

  await canvas.findByTestId('searm-ui-component', {}, { timeout: 30000 });
...
export const SearmUiReact: Story = createComponentStory('searm-ui-example', {
  play: searmUiTest,
});
export const SearmUiPreact: Story = createComponentStory('searm-ui-example', {
  runtime: 'preact',
  play: searmUiTest,
});
