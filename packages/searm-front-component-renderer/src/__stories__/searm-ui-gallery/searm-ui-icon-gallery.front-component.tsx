...
const IconGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="searm-ui/icon" entries={ICON_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000109',
  name: 'searm-ui-icon-gallery',
  description:
    'Renders searm-ui custom and illustration icons plus a Tabler sample in the sandbox',
