...
import { IconStar } from 'searm-ui/icon';
...
export default defineFrontComponent({
  ...
  name: 'searm-ui-data-display-gallery',
  description: 'Renders every searm-ui/data-display component in the sandbox',
