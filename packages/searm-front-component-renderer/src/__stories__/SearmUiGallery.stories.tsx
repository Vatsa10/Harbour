...
const meta: Meta<typeof FrontComponentRenderer> = {
  title: 'FrontComponent/SeaRM UI Gallery',
...
export const IconReact: Story = createGalleryStory('searm-ui-icon-gallery');
export const IconPreact: Story = createGalleryStory(
  'searm-ui-icon-gallery',
  'preact',
);
...
export const JsonVisualizerReact: Story = createGalleryStory(
  'searm-ui-json-visualizer-gallery',
);
...
export const ModalOpenReact: Story = {
  ...createGalleryStory('searm-ui-modal-open-gallery'),
  play: modalOpenHangTest,
};
export const ModalOpenPreact: Story = {
  ...createGalleryStory('searm-ui-modal-open-gallery', 'preact'),
  play: modalOpenTest,
};
...
export const CodeEditorReact: Story = {
  ...createGalleryStory('searm-ui-code-editor-gallery'),
  play: codeEditorTest,
};
export const CodeEditorPreact: Story = {
  ...createGalleryStory('searm-ui-code-editor-gallery', 'preact'),
  play: codeEditorTest,
};

export const TypographyReact: Story = createGalleryStory(
  'searm-ui-typography-gallery',
);
