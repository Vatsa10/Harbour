...
const nextConfig: LinariaConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/',
        has: [{ type: 'host', value: 'www.searm.com' }],
        destination: 'https://searm.com/',
        permanent: true,
      },
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.searm.com' }],
        destination: 'https://searm.com/:path*',
        permanent: true,
      },
      {
        source: '/',
        has: [{ type: 'host', value: 'www.searm-main.com' }],
        destination: 'https://searm-main.com/',
        permanent: true,
      },
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.searm-main.com' }],
        destination: 'https://searm-main.com/:path*',
        permanent: true,
      },
      ...
      {
        source: '/user-guide',
        destination: 'https://docs.searm.com/user-guide/introduction',
        permanent: true,
      },
      {
        source: '/user-guide/section/:folder/:slug*',
        destination: 'https://docs.searm.com/user-guide/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/developers',
        destination: 'https://docs.searm.com/developers/introduction',
        permanent: true,
      },
      {
        source: '/developers/section/:folder/:slug*',
        destination: 'https://docs.searm.com/developers/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/searm-ui',
        destination: 'https://docs.searm.com/searm-ui/introduction',
        permanent: true,
      },
      {
        source: '/searm-ui/section/:folder/:slug*',
        destination: 'https://docs.searm.com/searm-ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/searm-ui/:folder/:slug*',
        destination: 'https://docs.searm.com/searm-ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/resources/why-searm',
        destination: '/why-searm',
        permanent: true,
      },
      {
        source: '/story',
