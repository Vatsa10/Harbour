    ...
    highlights: [
      {
        ...
        description: (
          <Trans>
            Forward shared inboxes such as support@yourcompany.com into SeaRM
    ...
    highlights: [
      {
        ...
        description: (
          <Trans>
            ...
            you need to ship an app on top of SeaRM, in one place.
          </Trans>
        ),
    ...
    highlights: [
      {
        ...
        description: (
          <Trans>
            To maintain the simplicity of SeaRM, we are introducing "Advanced
