...
const SEARM_CARD_ICON = {
  alt: 'SeaRM Organization plan icon',
...
const CardIcon = styled.div`
  ...
  overflow: hidden;
  position: relative;
  width: ${SEARM_CARD_ICON.widthPx}px;
        ...
        <CardShell>
          <CardHeader>
            <CardHeaderInfo>
              ...
              <PriceLine>
                <Heading as="h4" family="sans" size="sm" weight="regular">
                  {i18n._(receipt.searmTotalAmount)}
                </Heading>
                <Body as="span" className={priceSuffixClassName} size="sm">
                  {i18n._(receipt.searmTotalSuffix)}
                </Body>
            ...
            <CardIcon>
              <NextImage
                alt={SEARM_CARD_ICON.alt}
                fill
                sizes={`${SEARM_CARD_ICON.widthPx}px`}
                src={SEARM_CARD_ICON.src}
              />
            </CardIcon>
          </CardHeader>
          <CardRule />
          <ReceiptLines lines={receipt.searmLines} />
          <PerUserLine>{i18n._(receipt.searmPerUser)}</PerUserLine>
          <CtaRow>
            <Button
              href="https://app.searm.com/welcome"
