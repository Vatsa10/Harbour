...
const COMPARE_LINKS = [
  { label: msg`SeaRM vs HubSpot`, href: '/compare-pricing/hubspot' },
  { label: msg`SeaRM vs Salesforce`, href: '/compare-pricing/salesforce' },
  {
    label: msg`SeaRM vs SAP Sales Cloud`,
    href: '/compare-pricing/sap-sales-cloud',
  },
  { label: msg`SeaRM vs Pipedrive`, href: '/compare-pricing/pipedrive' },
  {
    label: msg`SeaRM vs Microsoft Dynamics`,
    href: '/compare-pricing/microsoft-dynamics',
  },
  // Attio comparison parked, may return:
  // { label: msg`SeaRM vs Attio`, href: '/compare-pricing/attio' },
];
