  ...
  navItems: [
    { href: '/product', label: msg`Product` },
    {
      ...
      children: [
        {
          label: msg`Why`,
          description: msg`The story behind SeaRM`,
          href: '/why-searm',
          icon: IconBulb,
          preview: {
            image: '/images/menu/why.webp',
            imageAlt: msg`Why SeaRM illustration`,
            imagePosition: 'center',
            title: msg`Why teams choose SeaRM`,
            description: msg`The principles and product philosophy behind the open source CRM.`,
          },
        },
        {
          label: msg`User Guide`,
          description: msg`Learn how to use SeaRM`,
          href: SITE_URLS.docsUserGuide,
          external: true,
          icon: IconBook,
          preview: {
            image: '/images/menu/user-guide.webp',
            imageAlt: msg`SeaRM user guide preview`,
            imagePosition: 'center',
            title: msg`Master every corner of SeaRM`,
        ...
        },
        {
          ...
          description: msg`Create apps on SeaRM`,
          ...
          preview: {
            ...
            description: msg`APIs, SDKs and webhooks to extend SeaRM and ship apps on top of your CRM data.`,
          },
        },
        {
          label: msg`Apps`,
          ...
          preview: {
            image: '/images/menu/developers.webp',
            imageAlt: msg`SeaRM apps marketplace`,
            imagePosition: 'center',
            imageScale: 1.6,
            title: msg`Vetted apps for your workspace`,
            description: msg`Install call recording, enrichment, Slack, Linear and more — every app built and maintained by SeaRM.`,
          },
        },
        {
          label: msg`Partners`,
          description: msg`Find a SeaRM partner`,
          href: '/partners',
          icon: IconUsers,
          preview: {
            image: '/images/menu/partners.webp',
            imageAlt: msg`SeaRM partner ecosystem`,
            imagePosition: 'center',
            title: msg`Team up with a SeaRM expert`,
            description: msg`Meet the certified agencies and consultants implementing SeaRM for teams worldwide.`,
          },
        },
        {
          label: msg`Releases`,
          ...
          preview: {
            ...
            imageAlt: msg`SeaRM release ${LATEST_RELEASE.release} — ${LATEST_RELEASE.title}`,
            imageScale: 1.04,
