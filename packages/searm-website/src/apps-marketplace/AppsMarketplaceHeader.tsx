    ...
    <SectionShell rhythm="hero" scheme="light">
      <HeaderStack>
        ...
        <Heading as="h1" size="lg" weight="light">
          {i18n._(msg`Apps for *SeaRM*`)}
        </Heading>
        <HeaderBody>
          <Body muted size="md">
            {i18n._(
              msg`Extend your CRM with apps built and maintained by SeaRM. Every app here is vetted by our team — install one in a click and it's live in your workspace.`,
            )}
          </Body>
        </HeaderBody>
      </HeaderStack>
