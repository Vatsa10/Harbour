...
export const DUMMY_PARTNERS: MarketplacePartner[] = [
  {
    slug: 'atelier-sigma',
    name: 'Atelier Sigma',
    description: `**Senior CRM partner for venture-backed teams, with SeaRM at the core.**

We migrate startups, scale-ups and investment firms onto SeaRM and design the RevOps layer around it: data model, pipelines, automations and the integrations that keep everything clean. Five years in, with more than 40 rollouts behind us across France, the UK and the wider EU.

SeaRM is the foundation. Around it we build modular GTM stacks that are structured, automated and genuinely maintainable, so your team can run them without us in the room.
...
#### Why teams pick us
- 100% focused on SeaRM and its ecosystem
...
- Open-source-native: we build on the core, not around it`,
    ...
    services: [
      ...
      {
        title: 'Custom SeaRM development',
        description:
          "Workflows, custom objects and API or SDK integrations built on SeaRM's open-source core.",
      },
      {
    ...
    portfolio: [
      {
        ...
        title: 'Salesforce to SeaRM, 22k contacts, zero downtime',
        body: `We restructured a nine-year-old Salesforce org into a clean SeaRM data model, then cut a 40-person sales team over in a single weekend.
...
- Sequenced outreach synced back into SeaRM
- Qualified-meeting throughput up across the quarter`,
      ...
      },
      {
        ...
        title: 'Self-hosted SeaRM for a regulated client',
        body: `Deployed and hardened a self-hosted SeaRM instance for a private-bank client with strict EU data residency.
    ...
    portfolio: [
      {
        ...
        title: 'Board-ready forecasting on SeaRM',
...
- Board dashboard wired to live SeaRM data
- Forecast accuracy improved within one quarter`,
  ...
  },
  {
    ...
    description:
      'Boutique CRM implementer for real-estate workflows and WhatsApp automation, with self-hosted SeaRM deployments across APAC.',
    ...
    services: [
      ...
      },
      {
        ...
        description:
          'Lead capture and follow-up flows that connect WhatsApp conversations back into SeaRM.',
      },
    ],
    portfolio: [
      {
        client: 'Harbour Estates',
        title: 'WhatsApp leads into SeaRM for a property group',
        body: `Connected WhatsApp Business to SeaRM so inbound property enquiries land as qualified leads automatically.

- WhatsApp conversations synced to contact records
- Agent assignment rules based on listing region
- Response-time SLAs tracked in SeaRM`,
  ...
  },
  {
    ...
    name: 'Kioko Labs',
    description:
      'Self-hosted SeaRM deployments and API work for teams across Africa and the Gulf.',
  ...
  },
  {
    ...
    name: 'Tomas Brandt',
    description:
      'Independent SeaRM consultant, ex-Salesforce admin. Available for short solutioning engagements.',
