...
//
// SeaRM is multi-tenant, so anchors use a `{your-workspace-url}` placeholder
// (a workspace host such as `mycompany.searm.com` or a custom domain).
...
const apiCatalog = {
  linkset: [
    ...
    },
    {
      ...
      'service-desc': [
        {
          href: 'https://searm.com/.well-known/mcp/server-card.json',
          type: 'application/json',
        },
      ],
