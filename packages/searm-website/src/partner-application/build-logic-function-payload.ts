...
export type PartnerApplicationLogicFunctionPayload = {
  ...
  searmExperience: readonly PartnerSearmExperienceValue[];
...
export function buildLogicFunctionPayload(
  ...
  const payload: PartnerApplicationLogicFunctionPayload = {
    ...
    searmExperience: request.searmExperience,
    searmExperienceNotes: request.searmExperienceNotes,
    searmExperienceProofLink: request.searmExperienceProofLink,
  };
