...
import { ViewKey } from 'searm-shared/types';
...
export class DemoteAndBackfillApplicationIndexViewCommand extends ProvisionedWorkspaceCommandRunner {
  ...
  override async runOnWorkspace({
    ...
    const { searmStandardFlatApplication, workspaceCustomFlatApplication } =
