...
export class UpgradeGaugeService implements OnModuleInit {
  ...
  onModuleInit() {
    this.metricsService.createObservableGauge({
      metricName: 'searm_upgrade_instance_health',
      options: {
        description:
    ...
    this.metricsService.createObservableGauge({
      metricName: 'searm_upgrade_workspaces_behind_total',
      options: {
    ...
    this.metricsService.createObservableGauge({
      metricName: 'searm_upgrade_workspaces_failed_total',
      options: {
    ...
    this.metricsService.createObservableGauge({
      metricName: 'searm_upgrade_workspaces_up_to_date_total',
      options: {
    ...
    this.metricsService.createInfoGauge({
      metricName: 'searm_upgrade_instance',
      options: {
        description:
