...
import { ENTERPRISE_INSTANCE_TYPE } from 'searm-shared/constants';

describe('ClientConfigService', () => {
  let service: ClientConfigService;
  let searmConfigService: SearmConfigService;
  ...
  beforeEach(async () => {
    ...
    searmConfigService = module.get<SearmConfigService>(SearmConfigService);
  ...
  describe('getClientConfig', () => {
      ...
      jest
        ...
        .mockImplementation((key: string) => {
          const mockValues: Record<string, any> = {
            ...
            CALENDAR_BOOKING_PAGE_ID: 'team/searm/talk-to-us',
            CLOUDFLARE_API_KEY: undefined,
            CLOUDFLARE_ZONE_ID: undefined,
            ALLOW_REQUESTS_TO_SEARM_ICONS: false,
    ...
    it('should return complete client config with all properties', async () => {
      ...
      expect(result).toEqual({
        ...
        allowRequestsToSearmIcons: false,
        calendarBookingPageId: 'team/searm/talk-to-us',
