...
const searmConfigServiceGetMock = jest.fn();
...
describe('AuthService', () => {
  ...
  beforeEach(() => {
    searmConfigServiceGetMock.mockReturnValue(false);
