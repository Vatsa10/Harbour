...
import { SEARM_MCP_HELPER } from 'src/engine/core-modules/tool/tools/code-interpreter-tool/searm-mcp-helper.const';
import {
...
export class CodeInterpreterTool implements Tool {
  ...
  async execute(
    ...
    try {
      ...
      const codeWithHelper = SEARM_MCP_HELPER + '\n\n' + code;
      ...
      const result = await this.codeInterpreterService.execute(
        ...
        {
          env: {
            SEARM_SERVER_URL: serverUrl,
            SEARM_API_TOKEN: sessionToken,
          },
