...
import { toPlainText } from 'searm-emails';
import { MAX_EMAIL_RECIPIENTS } from 'searm-shared/constants';
import {
...
export class EmailComposerService {
  ...
  // References chain so replies thread on both SeaRM and recipient mail clients.
