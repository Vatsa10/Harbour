...
import * as typeTransformersModule from 'src/engine/core-modules/searm-config/utils/type-transformers.registry';
import { TypedReflect } from 'src/utils/typed-reflect';

jest.mock(
  'src/engine/core-modules/searm-config/utils/type-transformers.registry',
  () => {
