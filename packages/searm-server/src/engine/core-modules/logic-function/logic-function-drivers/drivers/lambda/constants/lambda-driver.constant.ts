...
export const COMMON_LAYER_NAME_PREFIX = 'searm-common-layer';
export const YARN_INSTALL_FUNCTION_NAME_PREFIX = 'searm-yarn-install';
export const BUILDER_FUNCTION_NAME_PREFIX = 'searm-builder';

export const SDK_LAYER_PREFIX_IN_ZIP = 'nodejs/node_modules/searm-client-sdk';

export const LAMBDA_PREBUILT_BUNDLE_CHECKSUM_TAG = 'searm:bundle-checksum';
