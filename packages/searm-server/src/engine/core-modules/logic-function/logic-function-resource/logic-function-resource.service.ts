...
`,
  ...
  // searm-sdk is build-time only and searm-client-sdk is injected at runtime
  // by SeaRM (Lambda SDK layer / server-served modules), so neither needs to
  ...
  private async removeBuildTimeSdkFromDependencies(
    ...
    const packagesToRemove = ['searm-sdk', 'searm-client-sdk'];
