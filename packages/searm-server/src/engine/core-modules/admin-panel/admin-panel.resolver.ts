...
import { ConfigVariableGraphqlApiExceptionFilter } from 'src/engine/core-modules/searm-config/filters/config-variable-graphql-api-exception.filter';
...
export class AdminPanelResolver {
  ...
  async getDatabaseConfigVariable(
    ...
    this.searmConfigService.validateConfigVariableExists(key as string);
  ...
  async createDatabaseConfigVariable(
    ...
    await this.searmConfigService.set(key, value);
  ...
  async updateDatabaseConfigVariable(
    ...
    await this.searmConfigService.update(key, value);
  ...
  async deleteDatabaseConfigVariable(
    ...
    await this.searmConfigService.delete(key);
  ...
  async addAiProvider(
    ...
    const customProviders = {
      ...this.searmConfigService.get('AI_PROVIDERS'),
    };

    customProviders[providerName] = providerConfig;
    await this.searmConfigService.set('AI_PROVIDERS', customProviders);
  ...
  async getAdminAiUsageByWorkspace(
    ...
    const useDollarMode = !this.searmConfigService.get('IS_BILLING_ENABLED');
