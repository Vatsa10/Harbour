...
access to your workspace is the **SeaRM MCP server**, not this OpenAPI schema.
...
\`\`\`bash
curl -H 'Authorization: Bearer <token>' \\
  ${serverUrl}/rest/open-api/${schemaName} > searm-${schemaName}.json
\`\`\`
`,
      termsOfService:
        'https://github.com/Vatsa10/Harbour?tab=coc-ov-file#readme',
      contact: {
        email: 'felix@searm.com',
      },
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/Vatsa10/Harbour?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
    ...
    externalDocs: {
      description: 'Find out more about **SeaRM**',
      url: 'https://searm.com',
    },
