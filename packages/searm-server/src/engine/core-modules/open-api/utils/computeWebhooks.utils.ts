  ...
  return {
    post: {
      ...
      parameters: [
        {
          in: 'header',
          name: 'X-SeaRM-Webhook-Signature',
          schema: {
            type: 'string',
          },
          description:
            'HMAC SHA256 signature of the request payload using the webhook secret. To compute the signature:\n' +
            '1. Concatenate `X-SeaRM-Webhook-Timestamp`, a colon (:), and the JSON string of the request payload.\n' +
        ...
        {
          in: 'header',
          name: 'X-SeaRM-Webhook-Timestamp',
          schema: {
            type: 'string',
          },
          description:
