...
import ms from 'ms';
import { SendEmailVerificationLinkEmail, renderEmail } from 'searm-emails';
...
export class EmailVerificationService {
  ...
  async sendVerificationEmail({
    ...
    if (!this.searmConfigService.get('IS_EMAIL_VERIFICATION_REQUIRED')) {
    ...
    const emailVerificationMsg =
      verificationTrigger === EmailVerificationTrigger.EMAIL_UPDATE
        ...
        : msg`Welcome to SeaRM: Please Confirm Your Email`;
