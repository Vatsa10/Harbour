...
import { type UpgradeAwareRepositoryState } from 'src/engine/searm-orm/upgrade-aware/upgrade-aware-repository-state';
import { UpgradeUnavailableEntityWriteException } from 'src/engine/searm-orm/upgrade-aware/exceptions/upgrade-unavailable-entity-write.exception';
