...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/searm-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/searm-orm/entity-manager/utils/get-entity-target';
...
import { type GlobalWorkspaceDataSource } from 'src/engine/searm-orm/global-workspace-datasource/global-workspace-datasource';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/searm-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/searm-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/searm-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/searm-orm/storage/orm-workspace-context.storage';
