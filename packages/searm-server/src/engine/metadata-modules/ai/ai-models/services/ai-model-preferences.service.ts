...
export class AiModelPreferencesService {
  ...
  getPreferences(): AiModelPreferences {
    return {
      defaultFastModels: this.searmConfigService.get('AI_MODELS_DEFAULT_FAST'),
      defaultSmartModels: this.searmConfigService.get(
        'AI_MODELS_DEFAULT_SMART',
      ),
      recommendedModels: this.searmConfigService.get(
        'AI_MODELS_DEFAULT_RECOMMENDED',
      ),
      disabledModels: this.searmConfigService.get(
