...
import { compositeTypeDefinitions, RelationType } from 'searm-shared/types';
...
import { MAX_CUSTOM_INDEXES_PER_OBJECT } from 'searm-shared/constants';
  ...
  async deleteOne({
    ...
    if (!flatIndexToDelete.isCustom) {
      throw new IndexMetadataException(
        ...
        {
          userFriendlyMessage: msg`System indexes are required for SeaRM to work and cannot be deleted.`,
        },
      );
    }
