...
import { ViewVisibility } from 'searm-shared/types';
import { isDefined, uncapitalize } from 'searm-shared/utils';
  ...
  async getMinimalMetadata(
    ...
    const objectMetadataItems: MinimalObjectMetadataDTO[] = Object.values(
      ...
      .map((flatObjectMetadata) => {
        const isStandardApp = belongsToSearmStandardApp(flatObjectMetadata);
