...
import { formatColumnNameForRelationField } from 'src/engine/searm-orm/utils/format-column-name-for-relation-field.util';
  ...
  private async addFiltersFromView({
    ...
    const recordFilterGroups = viewFilterGroups.map((viewFilterGroup) => {
      return {
        ...
        logicalOperator:
          viewFilterGroup.logicalOperator as unknown as RecordFilterGroupLogicalOperator, // TODO - https://github.com/Vatsa10/Harbour/issues/14746
