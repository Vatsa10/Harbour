...
import { SearmORMException } from 'src/engine/searm-orm/exceptions/searm-orm.exception';
import { searmORMGraphqlApiExceptionHandler } from 'src/engine/searm-orm/utils/searm-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof SearmORMException:
      return searmORMGraphqlApiExceptionHandler(error);
