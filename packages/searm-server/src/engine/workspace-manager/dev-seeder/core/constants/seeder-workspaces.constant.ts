...
export const SEEDER_CREATE_WORKSPACE_INPUT = {
  [SEED_APPLE_WORKSPACE_ID]: {
    ...
    logo: 'https://Vatsa10.github.io/placeholder-images/workspaces/apple-logo.png',
  ...
  [SEED_YCOMBINATOR_WORKSPACE_ID]: {
    ...
    logo: 'https://Vatsa10.github.io/placeholder-images/workspaces/ycombinator-logo.png',
    activationStatus: WorkspaceActivationStatus.PENDING_CREATION, // will be set to active after default role creation
    isTwoFactorAuthenticationEnforced: false,
  },
