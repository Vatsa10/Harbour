import { type ConfigVariableValue } from 'searm-shared/types';

import { createConfigVariable } from 'test/integration/searm-config/utils/create-config-variable.util';
import { deleteConfigVariable } from 'test/integration/searm-config/utils/delete-config-variable.util';
import { getConfigVariable } from 'test/integration/searm-config/utils/get-config-variable.util';
import { updateConfigVariable } from 'test/integration/searm-config/utils/update-config-variable.util';
