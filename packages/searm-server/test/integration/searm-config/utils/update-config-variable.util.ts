import { type PerformSearmConfigQueryParams } from 'test/integration/searm-config/types/perform-searm-config-query.type';
...
export const updateConfigVariable = async ({
  input,
  expectToFail = false,
}: PerformSearmConfigQueryParams<UpdateConfigVariableFactoryInput>) => {
