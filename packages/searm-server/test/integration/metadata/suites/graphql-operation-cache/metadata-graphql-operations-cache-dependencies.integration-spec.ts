...
// Mirrors OBJECT_METADATA_FRAGMENT from searm-front
// (packages/searm-front/src/modules/object-metadata/graphql/fragment.ts):
...
// Mirrors VIEW_FRAGMENT from searm-front
// (packages/searm-front/src/modules/views/graphql/fragments/viewFragment.ts).
