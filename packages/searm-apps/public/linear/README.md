...
Connect your Linear account to SeaRM to create issues and look up teams
...
> notice on the Connections tab, ask your SeaRM admin to follow the
...
### 2. Wire the credentials into SeaRM
