...
The SeaRM Partners app relies on two **manual-trigger workflows** built in the SeaRM
...
staging, prod). After `yarn searm install`, prod is empty until an admin follows this
runbook.

## Prerequisites

- SeaRM Partners app installed and synced (`yarn searm apply`).
