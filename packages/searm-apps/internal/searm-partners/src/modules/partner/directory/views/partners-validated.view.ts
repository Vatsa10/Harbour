import { ViewFilterOperand, ViewType, defineView } from 'searm-sdk/define';
...
// object's existing view in place instead of deleting it (SeaRM blocks deleting an object's only view).
