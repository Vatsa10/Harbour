# SeaRM Helm Chart - Quick Install
...
- Create the PostgreSQL database "searm" and schema "core" automatically
...
```bash
kubectl get secret tokens -n searmcrm -o jsonpath='{.data.accessToken}' | base64 --decode && echo
```
...
```bash
helm uninstall my-searm -n searmcrm
kubectl delete namespace searmcrm
```
