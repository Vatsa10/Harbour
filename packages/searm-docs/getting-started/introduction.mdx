...
You've been choosing between software that's easy to start but impossible to change, and software that's flexible but takes months to set up. SeaRM is the third option: **a production-ready CRM you can reshape as you go.**


## What makes SeaRM different

SeaRM is a platform you can build on, not a product you configure.
...
<CardGroup cols={2}>
  ...
  <Card img="/images/user-guide/halftone/dev-api.png">
    ...
    React, TypeScript. Your team already knows how to extend SeaRM. No proprietary languages, no gatekeeping.
  </Card>
...
and PostgreSQL. SeaRM opens the CRM market
to you without learning APEX or getting proprietary certifications.

## Who SeaRM is not for


- **Teams that want a CRM they never have to think
  about.** SeaRM rewards teams that want to stay close to
...
<Card title="Ready to get started?" icon="rocket" href="/getting-started/quickstart">
  Set up SeaRM in under 5 minutes — cloud or self-hosted.
</Card>
