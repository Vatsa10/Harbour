...
<CardGroup cols={3}>
  <Card href="/l/it/developers/extend/apps/getting-started/quick-start" img="/images/user-guide/halftone/dev-apps.png">
    ...
    Estendi SeaRM con oggetti personalizzati, logica lato server, componenti UI e agenti IA — tutto come pacchetti TypeScript.
  </Card>
  ...
  <Card href="/l/it/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    Esegui SeaRM sulla tua infrastruttura.
  </Card>
