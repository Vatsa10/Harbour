...
sabbiato all'interno di SeaRM. La nostra legge il record selezionato, carica i modelli di persona
...
`searm-ui`. Gli SDK mocks che il pacchetto durante la build, quindi le importazioni a livello di modulo di costanti del tema
sarebbero `indefinite`. Vedi il [componente completo]
(https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/front-components/generate-document-form.front-component.tsx).
</Warning>
...
tramite un piccolo [`Markdown`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/markdown-to-react.tsx)
helper.
