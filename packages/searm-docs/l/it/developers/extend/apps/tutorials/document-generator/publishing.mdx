...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/it/developers/extend/apps',
...
Aggiungi anche la parola chiave `searm-app` a `package.json` così l'app è scopribile:
...
su un registro privato di SeaRM server. Per superficiare un'app pubblicata
