...
<AccordionGroup>
<Accordion title="Quali ruoli sono inclusi in SeaRM per impostazione predefinita?">
...
Vai su **Impostazioni → Membri → Ruoli**, trova l'opzione **Ruolo predefinito** e seleziona quale ruolo i nuovi membri devono ricevere automaticamente quando si uniscono.
</Accordion>
...
I permessi a livello di riga sono disponibili nel piano **Organization**. Ciò consente di limitare l'accesso a record specifici in base a criteri (ad es., vedere solo le proprie opportunità).
</Accordion>
...
Puoi controllare:
* **Invia email**: Possibilità di inviare email da SeaRM
...
Con il provisioning JIT, gli account utente vengono creati automaticamente in SeaRM quando qualcuno accede tramite SSO per la prima volta. Viene assegnato loro automaticamente il ruolo predefinito.
</Accordion>
