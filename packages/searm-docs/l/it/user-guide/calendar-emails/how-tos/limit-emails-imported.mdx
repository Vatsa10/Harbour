...
description: Controlla quali email vengono importate in SeaRM.
---

## Panoramica

Per impostazione predefinita, SeaRM sincronizza tutte le email esterne dalla tua casella di posta collegata. Puoi limitare ciò che viene importato utilizzando la **selezione delle cartelle** e le **impostazioni di visibilità**.
...
I messaggi tra colleghi (stesso dominio) possono essere sincronizzati in SeaRM:
