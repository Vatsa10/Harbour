...
description: Segui una guida passo passo su come registrarti su SeaRM, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su SeaRM](https://app.searm.com).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@searm.com](mailto:contact@searm.com) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
