...
description: Guida passo-passo per migrare la tua istanza SeaRM self-hosted verso SeaRM Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza SeaRM self-hosted a SeaRM Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.searm.com](https://app.searm.com) e crea un nuovo spazio di lavoro
...
<Tip>
  Stai eseguendo la migrazione di uno spazio di lavoro grande o complesso? [Trova un partner SeaRM certificato](https://searm.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) per gestire l’intera migrazione end-to-end. *(Oppure coinvolgi il nostro team: [contact@searm.com](mailto:contact@searm.com).)*
</Tip>
