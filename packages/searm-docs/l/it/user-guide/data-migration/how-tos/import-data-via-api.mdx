...
description: Quando e come usare le API di SeaRM per importazioni di dati su larga scala.
---

## Panoramica

SeaRM offre sia **GraphQL** che **API REST** per l'importazione programmatica dei dati. Usa l'API quando l'importazione CSV non è pratica per il tuo volume di dati o quando hai bisogno di importazioni automatizzate e ricorrenti.
...
SeaRM applica limiti di frequenza per garantire la stabilità del sistema:
...
SeaRM supporta due tipi di API:
...
* Verifica che i formati soddisfino i requisiti di SeaRM (vedi [Mappatura dei campi](/l/it/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica che i dati compaiano correttamente in SeaRM
...
Contattaci a [contact@searm.com](mailto:contact@searm.com) oppure scopri i nostri [Servizi di implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
