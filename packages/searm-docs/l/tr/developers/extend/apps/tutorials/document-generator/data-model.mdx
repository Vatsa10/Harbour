...
`RICH_TEXT` alanıdır, bu nedenle SeaRM ona tam özellikli bir zengin metin düzenleyicisi verir.
...
[`document.object.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/objects/document.object.ts).
...
`yarn searm dev` çalışırken **Settings → Data model** bölümünü açın. Her iki nesne de
