...
* `objectUniversalIdentifier`, bu görünümün hangi nesneye uygulanacağını belirtir. Bu, tanımladığınız özel bir nesne veya standart bir SeaRM nesnesi olabilir.
...
Yukarıdaki tüm enum'lar `searm-sdk/define` içinden dışa aktarılır.
