...
* Koşullar, uygulamanıza ait nesnelere ve alanlara veya SeaRM'nin standart nesnelerine başvurabilir.
...
* Çalışan bir örnek için bkz.: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
