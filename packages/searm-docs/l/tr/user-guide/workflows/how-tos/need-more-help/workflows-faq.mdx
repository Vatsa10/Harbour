...
description: SeaRM'deki iş akışları hakkında sıkça sorulan sorular.
---
...
<AccordionGroup>
  ...
  <Accordion title="Single, Global ve Bulk manuel tetikleyiciler arasındaki fark nedir?">
    ...
    \| **Bulk** | Bir veya daha fazlası seçili | Bir kez, tüm kayıtlar bir dizi olarak |
  ...
  <Accordion title="İş akışı çalıştırmalarımı neden görmüyorum?">
    İş akışı çalıştırmaları hız sınırları nedeniyle anında başarısız oluyor olabilir. SeaRM, çalışma alanı başına saatte 5.000 çalıştırma için katı bir sınır uygular.
  ...
  <Accordion title="İş akışlarına ilişkin hız sınırları nelerdir?">
    SeaRM, sistem kararlılığını sağlamak için iki hız sınırına sahiptir:
