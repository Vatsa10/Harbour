---
title: SeaRM'den Teklif veya Fatura Oluşturun
...
* [SeaRM'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — oluşturulan PDF'leri kayıtlara ekleyin
