...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak SeaRM'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
SeaRM, SSO'yu şu sağlayıcılarla destekler:
...
* SeaRM çalışma alanınıza yönetici erişimi
...
* SeaRM çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını SeaRM rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza SeaRM'yi dahil edin
...
<Tip>
Kuruluşunuz için SSO yapılandırılması mı gerekiyor? SSO ve kimlik kurulumunda uzmanlaşmış [sertifikalı bir SeaRM iş ortağı bulun](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso). *(SeaRM'yi doğrudan sürece dahil etmeyi mi tercih edersiniz? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
