---
title: Ayarlar SSS
description: SeaRM ayarları hakkında sıkça sorulan sorular.
---
...
E-posta adresinizi değiştirmek için lütfen [contact@searm.com](mailto:contact@searm.com) ile iletişime geçin.
</Accordion>
...
* **Alt alan adı**: `yourcompany.searm.com` gibi bir SeaRM alt alan adı kullanın
