...
Tüm alt veri işleyenlerin listesi [Güven Merkezi](https://trust.searm.com/?tab=subprocessors) sayfamızda mevcuttur.
</Accordion>
...
İmzalı DPA’nızı https://{your-domain}/settings/legal/dpa adresinde (ör. https://getting-started.searm.com/settings/legal/dpa) oluşturabilirsiniz.
</Accordion>
<Accordion title="CRM’de saklanan satıcı ve kişi bilgileri için SeaRM veri işleyen, şirketimiz ise veri sorumlusu olarak mı kalır?">
[Gizlilik Politikamıza](https://searm.com/privacy-policy) göre SeaRM, CRM’de saklanan satıcı ve kişi bilgileri için veri işleyen olarak hareket ederken, şirketiniz veri sorumlusu olarak kalır.
</Accordion>
<Accordion title="CRM içeriği, SeaRM veya üçüncü taraf yapay zeka modellerini eğitmek için hiç kullanılıyor mu?">
Alt veri işleyenlerin Şartlar ve Koşullarına bağlı olarak, CRM içeriği yapay zeka modellerini eğitmek için kullanılabilir. SeaRM'nin kendi yapay zeka modeli yoktur — SeaRM Cloud'da sunulan tüm yapay zeka modelleri alt veri işleyenlerimiz tarafından sağlanmaktadır.
</Accordion>
...
<Accordion title="Hangi SeaRM personeli veya alt veri işleyenler müşteri çalışma alanlarına hangi amaçlarla erişebilir ve bu erişim nasıl onaylanıp kayda alınır?">
SeaRM'nin mühendislik ve destek ekipleri, sorunları araştırmak ve çözmek için müşteri çalışma alanlarına erişebilir. Çalışma alanı sahipleri bunu kontrol eder: destek erişimi, herhangi bir zamanda Ayarlar → Genel → Güvenlik bölümünden devre dışı bırakılabilir ve siz tekrar açana kadar kapalı kalır.
</Accordion>
...
Veri saklama ile ilgili daha fazla bilgi için, [Güven Merkezi](https://trust.searm.com/?tab=documents) sayfamızda bulunan Veri Yönetimi ve Saklama Politikamızı talep edebilirsiniz.
</Accordion>
<Accordion title="SeaRM, tam silme talebi yerine getirildiğinde yazılı teyit sağlayabilir mi?">
...
<Accordion title="SeaRM Cloud için hedef kurtarma noktası (RPO) ve hedef kurtarma süresi (RTO) nedir?">
Hem RTO hem de RPO 6 saattir (DPA’mıza göre).
</Accordion>
<Accordion title="Yeniden yükleme talep etme veya gerçekleştirme süreci nedir?">
Bir geri yükleme talep etmek için lütfen destek sohbeti üzerinden veya [contact@searm.com](mailto:contact@searm.com) adresine e-posta göndererek ekibimizle iletişime geçin.
</Accordion>
...
<AccordionGroup>
<Accordion title="SeaRM GDPR ile uyumlu mu?">
Evet, SeaRM [GDPR ile uyumludur](https://trust.searm.com/?tab=securityControls\&frameworks=gdpr_v1).
</Accordion>
<Accordion title="SeaRM SOC 2 ile uyumlu mu?">
Evet, SeaRM [SOC 2 ile uyumludur](https://trust.searm.com/?tab=securityControls\&frameworks=soc2_v1).
</Accordion>
<Accordion title="SeaRM HIPAA ile uyumlu mu?">
Hayır, SeaRM HIPAA ile uyumlu hâle gelme sürecindedir.
</Accordion>
</AccordionGroup>
...
<Accordion title="Ayrı bir front end oluşturup SeaRM'yi olduğu gibi bir backend olarak kullanırsam, bu değişiklikleri yayımlamak zorunda mıyım?">
Hayır. Front end'iniz size ait, bağımsız bir çalışmadır; SeaRM'nin API'leri üzerinden onunla iletişim kurmak bu durumu değiştirmez. SeaRM'nin kendisi değiştirilmediği için yayımlanacak bir şey yoktur.
</Accordion>
...
Daha fazla sorunuz varsa, lütfen [Şartlar ve Koşullarımızı](https://searm.com/terms), [Gizlilik Politikamızı](https://searm.com/privacy-policy) ve [Güven Merkezimizi](https://trust.searm.com/) inceleyin. Sorularınız hâlâ yanıtlanmadıysa, bunları [contact@searm.com](mailto:contact@searm.com) adresine veya destek sohbeti üzerinden gönderin.
