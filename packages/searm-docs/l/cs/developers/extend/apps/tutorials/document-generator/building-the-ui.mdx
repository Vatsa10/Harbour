...
`searm-ui`. SDK mocniny, které balí během sestavení, takže importy
téma na úrovni modulů by byly `nedefinované`. Podívejte se na
[plnou komponentu](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/front-components/generate-document-form.front-component.tsx).
</Warning>
...
pomocí malého [`Markdown`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/markdown-to-react.tsx)
helper.
