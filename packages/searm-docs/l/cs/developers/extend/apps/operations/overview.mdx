...
**Provozní vrstva** je všechno, co děláte *na* své aplikaci, nikoli *pomocí* ní: spouštění příkazů CLI, provádění integračních testů proti reálnému serveru SeaRM, konfigurace CI a vydávání verzí — buď jako tarball nasazený na jednom serveru, nebo jako balíček npm uvedený v Marketplace.
...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/l/cs/developers/extend/apps/operations/cli">
    Referenční přehled `yarn searm` — exec, logs, uninstall, remotes.
  </Card>
