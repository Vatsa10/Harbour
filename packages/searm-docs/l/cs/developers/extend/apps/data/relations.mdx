...
Relace propojují dva objekty. Ve SeaRM jsou relace vždy **obousměrné** — každá relace má dvě strany a každá strana je deklarována jako pole, které odkazuje na tu druhou.
...
Chcete-li vytvořit relaci s vestavěným objektem SeaRM (Person, Company atd.), použijte `STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS`:
