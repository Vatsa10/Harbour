...
Systém oprávnění SeaRM vám umožňuje řídit, kdo může ve vašem pracovním prostoru přistupovat k datům a kdo je může upravovat. Vytvářejte role, přiřazujte oprávnění a konfigurujte SSO pro zabezpečený přístup.
...
<CardGroup cols={2}>
  ...
  <Card title="Konfigurace SSO" icon="key" href="/l/cs/user-guide/permissions-access/capabilities/sso-configuration">
