...
<AccordionGroup>
<Accordion title="Jaké role jsou ve SeaRM ve výchozím nastavení?">
...
Můžete řídit:
* **Odeslat e-mail**: Možnost odesílat e-maily z SeaRM
...
Při zřizování JIT se uživatelské účty v SeaRM vytvoří automaticky, když se někdo poprvé přihlásí přes SSO. Automaticky jim je přiřazena výchozí role.
</Accordion>
