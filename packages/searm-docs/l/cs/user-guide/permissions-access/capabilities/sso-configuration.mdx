...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do SeaRM pomocí poskytovatele identity vaší organizace. To přináší:
...
* Odeberte je z pracovního prostoru SeaRM
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v SeaRM (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte SeaRM do svého pracovního postupu deprovisioningu
...
<Tip>
Potřebujete pro svou organizaci nastavit SSO? [Najděte certifikovaného partnera SeaRM](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso), který se specializuje na SSO a nastavení identity. *(Raději byste do toho přímo zapojili SeaRM? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
