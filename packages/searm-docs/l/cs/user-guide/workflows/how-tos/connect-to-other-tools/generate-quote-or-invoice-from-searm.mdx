---
title: Vytvořte nabídku nebo fakturu z SeaRM
...
* [Vygenerovat PDF z SeaRM](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — připojte vygenerované soubory PDF k záznamům
