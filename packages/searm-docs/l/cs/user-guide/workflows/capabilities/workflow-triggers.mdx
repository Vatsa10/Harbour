...
* Pro požadavky POST definujte očekávanou strukturu těla, aby SeaRM vědělo, jaká data očekávat. Zde přidejte pole, která obdržíte a která budou dále ve vašem pracovním postupu potřeba.
