...
Standardní pole jsou předem vestavěná v systému SeaRM, aby pokryla běžné obchodní potřeby.
...
SeaRM podporuje různé typy polí:
...
3. Pokračujte kliknutím na `+ Nové pole`.
...
Databázové indexy jsou spravovány automaticky — přidávání vlastních je jen zřídka nutné a je snadné je udělat špatně. Když je zapnutý pokročilý režim, má každý objekt sekci **Indexy** v `Settings → Data Model → <object>` pro případy, kdy víte, že ho potřebujete.
