...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do SeaRM.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který SeaRM očekává.
...
SeaRM vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v SeaRM existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v SeaRM)
...
* Musí být jedinečné v rámci vašeho souboru i v SeaRM
...
* **Odkazy / Štítek odkazu**: `SeaRM`
* **Odkazy / URL odkazu**: `https://searm.com`
...
* **Volitelné**: SeaRM automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v SeaRM již existovat
...
## Krok 6: Ujistěte se, že pole v SeaRM existují
