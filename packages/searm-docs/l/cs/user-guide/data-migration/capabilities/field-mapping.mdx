...
Když nahrajete soubor, SeaRM analyzuje vaše sloupce a pokusí se je spárovat s existujícími poli.

### Automatické mapování

SeaRM se snaží spárovat sloupce na základě:

* Názvů záhlaví sloupců (přesné nebo podobné shody)
* Detekce typů dat (datumů, čísel, e‑mailů)
* Běžné vzory polí

<Note>**Rychlý tip:** Exportujte několik řádků z objektu, který chcete importovat. Exportovaný soubor bude mít přesně takové názvy sloupců, jaké SeaRM očekává, což při importu usnadní automatické mapování.</Note>

### Možnosti ručního mapování

U každého sloupce můžete:

* **Namapovat na pole**: Vyberte odpovídající pole SeaRM z rozbalovací nabídky
...
Zadání `id` při importu je volitelné. Pokud není uvedeno, SeaRM jej automaticky vygeneruje.
