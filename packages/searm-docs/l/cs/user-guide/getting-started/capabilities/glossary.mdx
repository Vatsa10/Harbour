---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci SeaRM.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení SeaRM s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v SeaRM CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v SeaRM CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z SeaRM na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající SeaRM. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do SeaRM přidáte.
...
Členové pracovního prostoru jsou uživatelé SeaRM z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
