---
title: Orientace v prostředí SeaRM
...
Nabídka příkazů vám v SeaRM poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (SeaRM podporuje logické i trvalé mazání)
