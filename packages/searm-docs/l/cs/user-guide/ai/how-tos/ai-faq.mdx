...
description: Často kladené otázky k funkcím AI v SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="Jaké možnosti AI jsou k dispozici?">
    ...
    1. **AI Chatbot**: Asistent s kontextovým povědomím, který může přistupovat k vašim datům v SeaRM a pomůže vám s dotazy
  ...
  <Accordion title="Mohu používat vlastní modely AI?">
    V cloudu můžete používat pouze modely AI poskytované SeaRM. Ve své self‑hostované instanci můžete po získání licence Organization používat vlastní modely AI.
  </Accordion>

  <Accordion title="Nevidím roli přiřazenou agentovi AI, kde je?">
