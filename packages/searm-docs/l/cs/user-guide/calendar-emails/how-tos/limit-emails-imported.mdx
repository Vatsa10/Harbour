...
description: Ovládejte, které emaily se importují do SeaRM.
---

## Přehled

Ve výchozím nastavení SeaRM synchronizuje všechny externí emaily z vaší připojené poštovní schránky. Můžete omezit, co se importuje, pomocí **výběru složek** a **nastavení viditelnosti**.
...
Zprávy mezi kolegy (stejná doména) je možné synchronizovat v SeaRM:
