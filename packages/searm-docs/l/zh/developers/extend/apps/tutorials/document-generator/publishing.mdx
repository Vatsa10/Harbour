...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/zh/developers/extend/apps',
...
已完成的应用位于
[\`软件包/二十个应用/示例/文件生成器'](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/examples/document-generator)。
