...
* 谓词可以引用由你的应用拥有的对象和字段，或由 SeaRM 的标准对象拥有的对象和字段。
...
* 查看一个可运行示例：[`hello-world/src/roles/function-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/hello-world/src/roles/function-role.ts)。
