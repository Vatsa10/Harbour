...
* 述語は、あなたのアプリが所有するオブジェクトやフィールド、または SeaRM の標準オブジェクトを参照できます。
...
* 動作例を参照してください。[`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts)。
