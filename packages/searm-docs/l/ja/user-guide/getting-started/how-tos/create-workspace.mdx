---
title: ワークスペースを作成する
description: SeaRM に登録し、サブスクリプションプランを選択して、アカウントを設定するためのステップバイステップガイドに従ってください。
---
...
1. [SeaRMへのサインアップ](https://app.searm.com)に移動します。
...
ご質問やサポートが必要な場合は、[contact@searm.com](mailto:contact@searm.com) または [Discord](https://discord.gg/cx5n4Jzs57) で専属のサポートチームに連絡してください。
