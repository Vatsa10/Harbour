...
* Предикаты могут ссылаться на объекты и поля, принадлежащие вашему приложению, или на стандартные объекты и поля SeaRM.
...
* См. рабочий пример: [`hello-world/src/roles/function-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/hello-world/src/roles/function-role.ts).
