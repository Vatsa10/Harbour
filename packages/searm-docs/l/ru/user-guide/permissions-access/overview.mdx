...
Система разрешений SeaRM позволяет контролировать, кто может получать доступ и изменять данные в вашем рабочем пространстве. Создавайте роли, назначайте разрешения и настраивайте SSO для безопасного доступа.
...
<CardGroup cols={2}>
  ...
  <Card title="Конфигурация SSO" icon="key" href="/l/ru/user-guide/permissions-access/capabilities/sso-configuration">
