---
title: Создание PDF в SeaRM
description: Создайте рабочий процесс для создания и прикрепления PDF (например, коммерческого предложения) к записи.
---

Автоматически создавайте или получайте PDF и прикрепляйте его к записи в SeaRM. Это часто используют для создания коммерческих предложений, счетов или отчетов, связанных с компаниями, сделками или другими объектами.
...
* [Создание коммерческого предложения или счета в SeaRM](/l/ru/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-searm)
