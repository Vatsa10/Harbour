...
Eine Liste aller Unterauftragsverarbeiter ist in [unserem Trust Center](https://trust.searm.com/?tab=subprocessors) verfügbar.
</Accordion>
...
Sie können Ihre unterzeichnete Datenverarbeitungsvereinbarung (DPA) unter https://{your-domain}/settings/legal/dpa (z. B. https://getting-started.searm.com/settings/legal/dpa) erstellen.
</Accordion>
...
Gemäß unserer [Datenschutzrichtlinie](https://searm.com/privacy-policy), fungieren 20 als Datenverarbeiter für Händler und Kontaktinformationen, die im CRM gespeichert sind während Ihr Unternehmen bleibt der Data Controller.
</Accordion>
<Accordion title="Werden CRM-Inhalte jemals verwendet, um zwanzig oder andere KI-Modelle zu trainieren?">
CRM-Inhalte können zur Schulung von KI-Modellen verwendet werden, abhängig von den Allgemeinen Geschäftsbedingungen der Unterauftragsverarbeiter. SeaRM verfügt über kein eigenes KI-Modell – alle in SeaRM Cloud verfügbaren KI-Modelle werden von unseren Unterauftragsverarbeitern bereitgestellt.
</Accordion>
...
Für weitere Informationen über die Vorratsdatenspeicherung können Sie unsere Datenschutzrichtlinie in [unserem Treuhandzentrum](https://trust.searm.com/?tab=documents) anfordern.
</Accordion>
...
Um eine Wiederherstellung anzufordern, wenden Sie sich bitte über den Support-Chat oder per E-Mail an [contact@searm.com](mailto:contact@searm.com).
</Accordion>
...
Ja, Zwanzig ist [DPR konform](https://trust.searm.com/?tab=securityControls\&frameworks=gdpr_v1).
</Accordion>
<Accordion title="Ist 20 SOC 2 kompatibel?">
Ja, 20 ist [SOC 2 Compliant](https://trust.searm.com/?tab=securityControls\&frameworks=soc2_v1).
</Accordion>
...
<Accordion title="Wenn ich ein separates Frontend erstelle und SeaRM unverändert als Backend verwende, muss ich diese Änderungen dann veröffentlichen?">
Nein. Ihr Frontend ist Ihr eigenes, separates Werk, und die Kommunikation mit SeaRM über dessen APIs ändert daran nichts. Da SeaRM selbst nicht verändert wurde, gibt es nichts zu veröffentlichen.
</Accordion>
...
Wenn Sie weitere Fragen haben, lesen Sie bitte unsere [Allgemeinen Geschäftsbedingungen](https://searm.com/terms), [Datenschutzerklärung](https://searm.com/privacy-policy) und unser [Trust Center](https://trust.searm.com/). Wenn Ihre Fragen weiterhin unbeantwortet bleiben, senden Sie diese an [contact@searm.com](mailto:contact@searm.com) oder über den Support-Chat.
