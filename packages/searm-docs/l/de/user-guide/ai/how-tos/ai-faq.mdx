---
title: KI-FAQ
description: Häufig gestellte Fragen zu KI-Funktionen in SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="Welche KI-Funktionen sind verfügbar?">
    ...
    1. **KI-Chatbot**: Ein kontextbewusster Assistent, der auf Ihre SeaRM-Daten zugreifen kann und Sie bei Anfragen unterstützt
  ...
  <Accordion title="Kann ich meine eigenen KI-Modelle verwenden?">
    In der Cloud können Sie nur von SeaRM bereitgestellte KI-Modelle verwenden. Auf Ihrer selbstgehosteten Instanz können Sie nach Erhalt einer Organization-Lizenz Ihre eigenen KI-Modelle verwenden.
  </Accordion>
