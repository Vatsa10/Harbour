---
title: Abrechnung
description: Verstehen Sie die Preisgestaltung von SeaRM und verwalten Sie Ihr Abonnement.
---

SeaRM bietet flexible Preispläne, die den Bedürfnissen Ihres Teams entsprechen. Verwalten Sie Ihr Abonnement, verfolgen Sie Workflow-Guthaben und greifen Sie auf Rechnungen zu – alles über **Einstellungen → Abrechnung**.

## Was enthält dieser Abschnitt

<CardGroup cols={2}>
  <Card title="Preispläne" icon="tags" href="/l/de/user-guide/billing/capabilities/pricing-plans">
    Erfahren Sie mehr über die Preispläne von SeaRM und was enthalten ist.
  </Card>
...
| **Organisation (Selbstgehostet)** | Alles aus Pro + die Premiumfunktionen (SSO, zeilenbasierte Berechtigungen und mehr), SeaRM-Team-Support, keine Verpflichtung, benutzerdefinierten Code vor der Verteilung als Open Source zu veröffentlichen |
...
**Kann ich SeaRM kostenlos nutzen?**
Ja! Hosten Sie SeaRM selbst und erhalten Sie alle Pro-Funktionen kostenlos.
