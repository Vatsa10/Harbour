...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in SeaRM.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das SeaRM erwartet.
...
SeaRM erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in SeaRM bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in SeaRM)
...
* Muss innerhalb deiner Datei und in SeaRM eindeutig sein
...
* **Links / Link-Label**: `SeaRM`
* **Links / Link-URL**: `https://searm.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://searm.com","label":"SeaRM"}]
```
...
* **Optional**: SeaRM erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in SeaRM vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in SeaRM vorhanden sind
