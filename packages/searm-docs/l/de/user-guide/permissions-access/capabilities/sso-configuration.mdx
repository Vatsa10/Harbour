...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei SeaRM anzumelden. Dies bietet:
...
* Entfernen Sie sie aus dem SeaRM-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen SeaRM-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie SeaRM in Ihren Deprovisioning-Workflow ein
...
<Tip>
Benötigen Sie eine SSO-Konfiguration für Ihre Organisation? [Finden Sie einen zertifizierten SeaRM-Partner](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso), der auf SSO und Identitätseinrichtung spezialisiert ist. *(Sie möchten SeaRM lieber direkt einbeziehen? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
