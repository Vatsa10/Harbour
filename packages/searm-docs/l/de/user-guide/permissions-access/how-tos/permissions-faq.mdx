...
<AccordionGroup>
<Accordion title="Welche Rollen sind in SeaRM standardmäßig enthalten?">
...
Sie können steuern:
* **E-Mail senden**: Möglichkeit, E-Mails aus SeaRM zu senden
...
Mit JIT-Bereitstellung werden Benutzerkonten in SeaRM automatisch erstellt, wenn sich jemand zum ersten Mal über SSO anmeldet. Ihnen wird automatisch die Standardrolle zugewiesen.
</Accordion>
