...
<CardGroup cols={3}>
  <Card href="/l/de/developers/extend/apps/getting-started/quick-start" img="/images/user-guide/halftone/dev-apps.png">
    <CardTitle>Apps</CardTitle>
    Erweitern Sie SeaRM mit benutzerdefinierten Objekten, serverseitiger Logik, UI-Komponenten und KI-Agenten — alles als TypeScript-Pakete.
  </Card>
  ...
  <Card href="/l/de/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    Betreiben Sie SeaRM auf Ihrer eigenen Infrastruktur.
  </Card>
