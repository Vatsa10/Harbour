...
et auto-hébergées, ce chemin est géré par votre serveur SeaRM
(par exemple, `http://localhost:2020/s/documents/generate`). Sur SeaRM Cloud, `RestApiClient`
...
[Voir l'aide](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/render-document.ts).
...
`yarn searm dev:function:logs`, ou l'appeler directement avec
