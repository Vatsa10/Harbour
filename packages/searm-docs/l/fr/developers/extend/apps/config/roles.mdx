...
* Les prédicats peuvent référencer des objets et des champs appartenant à votre application ou aux objets standard de SeaRM.
...
* Voir un exemple fonctionnel : [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
