...
info: Apprenez comment vous pouvez collaborer avec le Figma de SeaRM
---
...
1. **Accédez au lien partagé :** Vous pouvez accéder au fichier Figma du projet [ici](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/SeaRM).
...
Sur la barre latérale gauche, vous pouvez accéder aux différentes pages du Figma de SeaRM. Voici comment elles sont organisées :
