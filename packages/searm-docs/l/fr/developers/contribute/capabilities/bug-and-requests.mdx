...
Pour signaler un bogue, veuillez [créer un problème sur GitHub](https://github.com/Vatsa10/Harbour/issues/new).

Vous pouvez également demander de l'aide sur [Discord](https://discord.gg/cx5n4Jzs57).

## Demandes de fonctionnalités

Si vous n'êtes pas sûr qu'il s'agisse d'un bogue, et que vous pensez que cela ressemble plus à une demande de fonctionnalité, alors vous devriez probablement [ouvrir une discussion à la place](https://github.com/Vatsa10/Harbour/discussions/new).

## Soumettre une pull request

La contribution au code de SeaRM commence par une pull request (PR).

### Avant de démarrer

1. Consultez les [problèmes existants](https://github.com/Vatsa10/Harbour/issues) pour repérer les travaux liés
2. Pour les nouvelles fonctionnalités, ouvrez d’abord un problème pour en discuter
3. Consultez notre [Code de conduite](https://github.com/Vatsa10/Harbour/blob/main/.github/CODE_OF_CONDUCT.md)
...
```bash
git clone https://github.com/YOUR_USERNAME/searm.git
cd searm
```
...
```bash
git remote add upstream https://github.com/Vatsa10/Harbour.git
```
