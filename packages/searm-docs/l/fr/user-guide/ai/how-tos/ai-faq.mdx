---
title: FAQ sur l'IA
description: Foire aux questions sur les fonctionnalités d'IA dans SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="Quelles capacités d'IA sont disponibles ?">
    ...
    1. **AI Chatbot** : Un assistant contextuel capable d'accéder à vos données SeaRM et de vous aider avec vos requêtes
  ...
  <Accordion title="Puis-je utiliser mes propres modèles d'IA ?">
    Sur le cloud, vous pouvez utiliser uniquement les modèles d'IA fournis par SeaRM. Sur votre instance auto-hébergée, vous pouvez utiliser vos propres modèles d'IA après avoir obtenu une licence Organization.
  </Accordion>
