...
| **Intégrations personnalisées** | Votre application → automatisation dans SeaRM                 |
...
3. Vous recevrez une URL de webhook unique, par exemple :
   ```
   https://api.searm.com/webhooks/workflow/abc123...
   ```
...
```bash
curl -X POST https://api.searm.com/webhooks/workflow/abc123... \
