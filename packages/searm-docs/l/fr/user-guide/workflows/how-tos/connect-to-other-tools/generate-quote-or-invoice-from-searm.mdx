---
title: Générer un devis ou une facture depuis SeaRM
...
* [Générer un PDF à partir de SeaRM](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — joindre les PDF générés aux enregistrements
