...
<AccordionGroup>
<Accordion title="Quels rôles sont inclus par défaut avec SeaRM ?">
...
* **Envoyer des e-mails** : Possibilité d'envoyer des e-mails depuis SeaRM
...
Avec l'approvisionnement JIT, les comptes utilisateur sont automatiquement créés dans SeaRM lorsqu'une personne se connecte via SSO pour la première fois. Le rôle par défaut leur est attribué automatiquement.
</Accordion>
