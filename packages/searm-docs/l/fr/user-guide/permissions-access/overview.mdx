...
Le système d’autorisations de SeaRM vous permet de contrôler qui peut accéder aux données de votre espace de travail et les modifier. Créez des rôles, attribuez des autorisations et configurez l’authentification unique (SSO) pour un accès sécurisé.
...
<CardGroup cols={2}>
  ...
  <Card title="Configuration SSO" icon="key" href="/l/fr/user-guide/permissions-access/capabilities/sso-configuration">
