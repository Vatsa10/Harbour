...
Le menu de commandes vous donne **un accès rapide aux actions** dans SeaRM. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (SeaRM prend en charge les suppressions logiques et définitives)
