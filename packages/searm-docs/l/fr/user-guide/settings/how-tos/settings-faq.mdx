...
description: Foire aux questions sur les paramètres de SeaRM.
---
...
Pour changer votre adresse e-mail, veuillez contacter [contact@searm.com](mailto:contact@searm.com).
</Accordion>
...
* **Sous-domaine** : Utilisez un sous-domaine SeaRM comme `yourcompany.searm.com`
