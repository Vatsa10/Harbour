...
O sistema de permissões do SeaRM permite controlar quem pode acessar e modificar dados no seu espaço de trabalho. Crie funções, atribua permissões e configure SSO para um acesso seguro.
...
<CardGroup cols={2}>
  ...
  <Card title="Configuração do SSO" icon="key" href="/l/pt/user-guide/permissions-access/capabilities/sso-configuration">
