...
description: Perguntas frequentes sobre fluxos de trabalho na SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="Por que não vejo minhas execuções de fluxo de trabalho?">
    As execuções de fluxo de trabalho podem estar falhando imediatamente devido a limites de taxa. SeaRM impõe um limite rígido de 5.000 execuções por hora por espaço de trabalho.
    ...
    * Espaçe as operações em lotes grandes
  ...
  <Accordion title="Quais são os limites de taxa dos fluxos de trabalho?">
    A SeaRM tem dois limites de taxa para garantir a estabilidade do sistema:
