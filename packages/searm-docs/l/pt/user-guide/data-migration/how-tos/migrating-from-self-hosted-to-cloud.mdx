...
description: Guia passo a passo para migrar a sua instância SeaRM auto-hospedada para a SeaRM Cloud.
---

## Visão Geral

Este guia orienta-o na migração dos seus dados de uma instância SeaRM auto-hospedada para a SeaRM Cloud. O processo envolve configurar o seu espaço de trabalho na cloud, exportar os seus dados e voltar a importá-los.
...
1. Aceda a [app.searm.com](https://app.searm.com) e crie um novo espaço de trabalho
...
<Tip>
  Migrando um espaço de trabalho grande ou complexo? [Encontre um parceiro SeaRM certificado](https://searm.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) para cuidar da migração de ponta a ponta. *(Ou envolva a nossa equipe: [contact@searm.com](mailto:contact@searm.com).)*
</Tip>
