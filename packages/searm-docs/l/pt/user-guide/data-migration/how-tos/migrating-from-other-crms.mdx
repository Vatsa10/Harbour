...
description: Guia passo a passo para migrar os seus dados de qualquer CRM para o SeaRM.
---

## Visão Geral

Este guia explica como migrar os seus dados de qualquer CRM para o SeaRM. O processo envolve auditar os seus dados, preparar o seu espaço de trabalho no SeaRM, exportar do seu sistema atual e importar para o SeaRM.
...
Crie um documento de mapeamento entre o seu CRM atual e o SeaRM:
...
## Passo 3: Configure o seu espaço de trabalho no SeaRM

Antes de importar dados, prepare o seu espaço de trabalho no SeaRM:
...
Se os seus dados incluírem referências a utilizadores (Proprietário da conta, Responsável, etc.), esses utilizadores devem existir no SeaRM antes da importação. Caso contrário, essas relações não podem ser mapeadas.
</Warning>
...
Abra cada CSV exportado numa aplicação de folha de cálculo e prepare-o para o SeaRM.

### Remova duplicados

1. Ordene pelo campo único (e-mail para Pessoas, domínio para Empresas)
2. Remova ou una linhas duplicadas
3. Verifique se não existem já duplicados no SeaRM
...
Use `https://domain.com` (não `domain.com` nem `www.domain.com`). Isto corresponde ao formato do SeaRM e evita duplicados quando ligar a sincronização de e-mail/calendário.
</Warning>
...
2. Use os mesmos endereços de e-mail que os utilizadores usaram para aderir ao seu espaço de trabalho no SeaRM
...
1. Navegue até ao objeto no SeaRM
...
* O SeaRM começará a sincronizar e-mails com os registos de contactos
...
<AccordionGroup>
  <Accordion title="Posso migrar fluxos de trabalho automaticamente?">
    De momento, não. Os fluxos de trabalho devem ser recriados manualmente no SeaRM.
  </Accordion>
...
<Tip>
  Quer ajuda com a sua migração? [Encontre um Vinte Parceiro certificado](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) para mover seus dados, pipelines e usuários de ponta a ponta.
</Tip>
