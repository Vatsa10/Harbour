...
O SeaRM suporta a importação de relações entre objetos durante a importação por CSV. Isto permite-lhe ligar registos (por exemplo, associar Pessoas a Empresas) como parte da sua migração de dados.
...
## Como funcionam as relações no SeaRM

### Um para Muitos / Muitos para Um

O SeaRM suporta relações padrão em que um registo se liga a muitos outros:
...
<Note>Relações muitos-para-muitos estão planeadas para o 2.º semestre de 2026.</Note>
...
Antes de importar o lado "muitos", os registos do lado "um" já devem existir no SeaRM.
...
4. O SeaRM ligará automaticamente cada registo ao pai correspondente
...
<Note>**Ligação a Membros do Espaço de Trabalho**: Quando a relação aponta para Membros do Espaço de Trabalho (a sua equipa que inicia sessão no SeaRM), refira-os pelo seu **endereço de email**, não pelo nome.</Note>
