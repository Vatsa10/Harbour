...
description: Perguntas frequentes sobre painéis na SeaRM.
---

<AccordionGroup>
  <Accordion title="Posso criar painéis privados?">
    Não, os painéis atualmente são visíveis para todos que têm acesso ao seu espaço de trabalho da SeaRM. Painéis privados ainda não estão disponíveis.
  </Accordion>
  ...
  <Accordion title="Posso compartilhar painéis com usuários externos?">
    Não, compartilhar painéis com usuários fora do seu espaço de trabalho da SeaRM (usuários que não são da SeaRM) não é suportado no momento.
  </Accordion>
  ...
  <Accordion title="Gráficos de medidor estão disponíveis?">
    Ainda não. Gráficos de medidor estão em nosso roadmap e serão adicionados em uma versão futura.
  </Accordion>
