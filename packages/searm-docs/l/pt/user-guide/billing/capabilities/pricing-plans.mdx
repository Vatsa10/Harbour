...
description: Saiba mais sobre os planos de preços do SeaRM e como alternar entre eles.
---

## Visão Geral

O SeaRM oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o SeaRM na sua própria infraestrutura sem custo:
