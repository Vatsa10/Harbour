...
O menu de comandos oferece **acesso rápido a ações** no SeaRM. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (SeaRM dá suporte a exclusões lógicas e permanentes)
