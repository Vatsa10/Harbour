---
title: O que é SeaRM
description: O SeaRM é um CRM de código aberto que oferece os blocos de construção para criar exatamente o que a sua empresa precisa.
---
...
À primeira vista, o SeaRM parece como a maioria dos CRMs que você já conhece: você pode acompanhar negócios, organizar contatos, gerenciar tarefas e anotações.
...
O código aberto é a base da nossa abordagem, garantindo que o SeaRM evolua com sua comunidade, para sua comunidade.
...
[Registre-se aqui](https://app.searm.com) ou [torne-se um colaborador no GitHub](https://github.com/Vatsa10/Harbour).
