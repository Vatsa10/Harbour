---
title: Posso enviar e-mails a partir do SeaRM?
description: Informações sobre o envio de e-mails diretamente a partir do SeaRM.
---

## Estado atual

A integração de e-mail do SeaRM foi concebida para **sincronizar e apresentar** o seu histórico de e-mails, bem como redigir e enviar e-mails.
...
## Como enviar uma mensagem a partir do SeaRM
...
Para sequências de e-mails e boletins informativos, recomendamos utilizar Fluxos de Trabalho para ligar o SeaRM a uma ferramenta dedicada de marketing por e-mail.
...
A redação nativa de e-mails dentro do SeaRM está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/Vatsa10/Harbour/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
