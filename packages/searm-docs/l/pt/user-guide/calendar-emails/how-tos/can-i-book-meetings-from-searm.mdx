---
title: Posso agendar reuniões a partir do SeaRM?
description: Informações sobre o agendamento de reuniões diretamente a partir do SeaRM.
---

## Estado atual

A integração de calendário do SeaRM foi concebida para **sincronizar e apresentar** os seus eventos de calendário existentes.
