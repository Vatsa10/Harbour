...
O SeaRM vem com objetos padrão:
...
Cada empresa trabalha de maneira diferente. Personalizar seu modelo de dados significa que você pode moldar o SeaRM em torno dos **seus** processos, em vez de forçar os seus a caber em um sistema rígido.

O SeaRM oferece total flexibilidade:
...
Identifique os principais conceitos com os quais você trabalha. O SeaRM já oferece:
...
<Tip>
  Quer ajuda para projetar seu modelo de dados? [Encontre um Vinte Parceiro certificado](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) para projetar e construir seus objetos, campos e relacionamentos.
</Tip>
