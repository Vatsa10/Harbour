...
* Os predicados podem referenciar objetos e campos pertencentes ao seu app ou aos objetos padrão da SeaRM.
...
* Veja um exemplo funcional: [`hello-world/src/roles/function-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/hello-world/src/roles/function-role.ts).
