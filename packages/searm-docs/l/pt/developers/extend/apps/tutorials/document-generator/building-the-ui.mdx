...
sandboxed dentro de SeaRM. Ours lê o registro selecionado, carrega o modelo de pessoa
...
[componente inteiro](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/front-components/generate-document-form.front-component.tsx).
</Warning>
...
através de um pequeno [`Markdown`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/markdown-to-react.tsx)
helper.
...
`RICH_TEXT`, SeaRM já fornece um editor de rich text completo para ele — o
...
veja o
[`template-record. leiaute-idade.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/page-layouts/template-record.page-layout.ts).
