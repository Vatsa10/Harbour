...
description: Crie um aplicativo SeaRM real que gera documentos personalizados a partir dos seus dados de CRM.
---
...
um servidor SeaRM local em execução na porta `2020` e o CLI autenticado nele.
...
Deixe `yarn searm dev` rodando em um terminal durante todo o tutorial. Toda vez que
