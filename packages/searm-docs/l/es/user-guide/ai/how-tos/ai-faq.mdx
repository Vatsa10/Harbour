...
description: Preguntas frecuentes sobre las funciones de IA en SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="¿Qué capacidades de IA están disponibles?">
    ...
    1. **Chatbot de IA**: Un asistente con conocimiento del contexto que puede acceder a tus datos de SeaRM y ayudarte con consultas
  ...
  <Accordion title="¿Puedo usar mis propios modelos de IA?">
    En la nube, solo puedes usar modelos de IA proporcionados por SeaRM. En tu instancia autohospedada, puedes usar tus propios modelos de IA después de obtener una licencia de Organización.
  </Accordion>
