...
description: Controla qué correos electrónicos se importan en SeaRM.
---

## Resumen

De forma predeterminada, SeaRM sincroniza todos los correos electrónicos externos de tu buzón conectado. Puedes limitar lo que se importa usando la **selección de carpetas** y los **ajustes de visibilidad**.
...
Los mensajes entre colegas (mismo dominio) se pueden sincronizar en SeaRM:
