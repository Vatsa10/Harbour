---
title: Generar un PDF desde SeaRM
description: Cree un flujo de trabajo para generar y adjuntar un PDF (como una cotización) a un registro.
---

Genere u obtenga automáticamente un PDF y adjúntelo a un registro en SeaRM. Esto se usa comúnmente para crear cotizaciones, facturas o informes vinculados a Empresas, Oportunidades u otros objetos.
...
* [Generar una cotización o factura desde SeaRM](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-searm)
