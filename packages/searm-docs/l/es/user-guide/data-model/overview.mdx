...
SeaRM incluye objetos estándar:
...
Cada empresa funciona de manera diferente. Personalizar tu modelo de datos significa que puedes adaptar SeaRM a **tus** procesos en lugar de forzar los tuyos en un sistema rígido.

SeaRM ofrece total flexibilidad:
...
Identifica los conceptos principales con los que trabajas. SeaRM ya ofrece:
...
<Tip>
  ¿Quieres ayuda para diseñar tu modelo de datos? [Encuentra un Veinte socio certificado](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) para diseñar y construir tus objetos, campos y relaciones.
</Tip>
