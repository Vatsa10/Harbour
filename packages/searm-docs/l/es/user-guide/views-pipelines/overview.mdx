...
description: Aprende a crear y gestionar vistas en SeaRM.
---
...
1. Ve a cualquier objeto (Personas, Empresas, etc.)
2. Elige un diseño (Tabla, Kanban o Calendario) en **Opciones** y agrega filtros y ordenación según sea necesario
