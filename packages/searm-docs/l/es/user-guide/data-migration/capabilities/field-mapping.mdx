...
Cuando cargas un archivo, SeaRM analiza las columnas e intenta hacerlas coincidir con los campos existentes.

### Asignación automática

SeaRM intenta hacer coincidir las columnas en función de:
...
<Note>**Consejo rápido:** Exporta algunas filas del objeto que quieres importar. El archivo exportado tendrá los nombres de columna exactos que SeaRM espera, lo que hará que la asignación automática sea fluida durante la importación.</Note>

### Opciones de asignación manual

Para cada columna, puedes:

* **Asignar a un campo**: Selecciona el campo correspondiente de SeaRM desde un menú desplegable
...
Es opcional especificar un `id` durante la importación. SeaRM lo genera automáticamente si no se proporciona.
