...
description: Guía paso a paso para migrar tus datos desde cualquier CRM a SeaRM.
---

## Resumen

Esta guía te lleva paso a paso para migrar tus datos desde cualquier CRM a SeaRM. El proceso implica auditar tus datos, preparar tu espacio de trabajo de SeaRM, exportar desde tu sistema actual e importar en SeaRM.
...
Crea un documento de mapeo entre tu CRM actual y SeaRM:
...
## Paso 3: Configura tu espacio de trabajo en SeaRM

Antes de importar datos, prepara tu espacio de trabajo en SeaRM:
...
Si tus datos incluyen referencias a usuarios (propietario de la cuenta, asignado, etc.), esos usuarios deben existir en SeaRM antes de la importación. De lo contrario, esas relaciones no se podrán asignar.
</Warning>
...
Abre cada CSV exportado en una aplicación de hojas de cálculo y prepáralo para SeaRM.

### Elimina duplicados

1. Ordena por el campo único (correo electrónico para Personas, dominio para Empresas)
2. Elimina o combina filas duplicadas
3. Verifica que no existan duplicados ya en SeaRM
...
Usa `https://domain.com` (no `domain.com` ni `www.domain.com`). Esto coincide con el formato de SeaRM y evita duplicados cuando conectas la sincronización de correo/calendario.
</Warning>
...
2. Usa las mismas direcciones de correo electrónico que los usuarios utilizaron para unirse a tu espacio de trabajo en SeaRM
...
1. Navega hasta el objeto en SeaRM
...
* SeaRM comenzará a sincronizar los correos electrónicos con los registros de contactos
...
<AccordionGroup>
  <Accordion title="¿Puedo migrar los flujos de trabajo automáticamente?">
    Actualmente no. Los flujos de trabajo deben recrearse manualmente en SeaRM.
  </Accordion>
...
<Tip>
  ¿Quieres ayuda con tu migración? [Encuentra un Veinte socio certificado](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) para mover tus datos, tuberías y usuarios de extremo a extremo.
</Tip>
