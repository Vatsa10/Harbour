...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en SeaRM utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Elimínelos del espacio de trabajo de SeaRM
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de SeaRM (si está disponible)
* **Proceso de desvinculación**: Incluya SeaRM en su flujo de trabajo de desaprovisionamiento
...
<Tip>
¿Necesitas configurar SSO para tu organización? [Encuentra un partner certificado de SeaRM](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) especializado en la configuración de SSO e identidad. *(¿Prefieres involucrar directamente a SeaRM? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
