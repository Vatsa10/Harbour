...
description: Crea una aplicación real de SeaRM que genere documentos personalizados a partir de los datos de tu CRM.
---
...
Deja `yarn searm dev` corriendo en un terminal para el tutorial completo. Cada vez que
