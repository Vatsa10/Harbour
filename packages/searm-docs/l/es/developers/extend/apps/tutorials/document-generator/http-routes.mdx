...
y autoalojadas, esa ruta la sirve tu servidor de SeaRM
(p. ej., `http://localhost:2020/s/documents/generate`). En SeaRM Cloud, `RestApiClient`
...
[Ver el ayudante](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/render-document.ts).
...
`yarn searm dev:function:logs`, o invocarlo directamente con
