...
[`load-record-values.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/utils/load-record-values.ts)를 참조하세요.
...
입력 스키마는 `templateId`와 `recordId`를 설명하는 일반 JSON 스키마입니다. 자세한 내용은 [`generate-document-input.schema.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/schemas/generate-document-input.schema.ts)를 참조하세요.
...
전체 헬퍼 코드는
[`generate-document-pdf.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/utils/generate-document-pdf.ts)에 있습니다.
...
[call-recorder 앱](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/public/call-recorder)이 녹음을 위해 사용하는 것과 동일한 패턴입니다.
</Note>
