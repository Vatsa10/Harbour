...
* 프레디킷은 앱에서 소유한 오브젝트와 필드뿐만 아니라 SeaRM의 표준 오브젝트가 소유한 오브젝트와 필드를 참조할 수 있습니다.
...
* 동작 예제를 참조하세요: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
