...
* `objectUniversalIdentifier` يحدّد الكائن الذي ينطبق عليه هذا العرض. يمكن أن يكون كائنًا مخصصًا قمتَ بتعريفه أو كائن SeaRM قياسيًا.
...
يتم تصدير جميع التعدادات أعلاه من `searm-sdk/define`.
