---
title: إنشاء عرض سعر أو فاتورة من SeaRM
...
* [إنشاء PDF من عشرين سنتي](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) - إرفاق ملفات PDFs التي تم إنشاؤها بالسجلات
