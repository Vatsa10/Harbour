...
Când încărcați un fișier, SeaRM analizează coloanele și încearcă să le potrivească cu câmpurile existente.

### Mapare automată

SeaRM încearcă să potrivească coloanele pe baza:
...
<Note>**Sfat rapid:** Exportați câteva rânduri din obiectul pe care doriți să-l importați. Fișierul exportat va avea exact numele de coloane pe care SeaRM le așteaptă, ceea ce face ca maparea automată să fie fără probleme în timpul importului.</Note>

### Opțiuni de mapare manuală

Pentru fiecare coloană, puteți:

* **Mapați la un câmp**: Selectați câmpul SeaRM corespunzător dintr-un meniu derulant
...
Specificarea unui `id` în timpul importului este opțională. SeaRM generează automat unul dacă nu este furnizat.
