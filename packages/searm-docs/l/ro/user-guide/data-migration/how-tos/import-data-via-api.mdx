...
description: Când și cum să utilizați API-urile SeaRM pentru importuri de date la scară mare.
---

## Prezentare generală

SeaRM oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
SeaRM impune limitări de rată pentru a asigura stabilitatea sistemului:
...
SeaRM acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor SeaRM (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în SeaRM
...
Contactați-ne la [contact@searm.com](mailto:contact@searm.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
