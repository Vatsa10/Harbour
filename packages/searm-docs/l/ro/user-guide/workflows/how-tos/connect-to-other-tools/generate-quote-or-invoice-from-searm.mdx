---
title: Generați o ofertă sau o factură din SeaRM
...
* [Generați un PDF din SeaRM](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — atașați PDF-uri generate la înregistrări
