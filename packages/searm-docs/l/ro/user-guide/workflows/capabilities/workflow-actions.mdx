...
description: Aflați despre acțiunile disponibile în fluxurile de lucru SeaRM.
---
...
<Note>
Puteți trimite emailuri doar din căsuțele poștale sincronizate cu propriul dvs. cont SeaRM. Trimiterea din căsuțele poștale ale altor membri ai echipei (de ex., emailul proprietarului contului) este pe roadmap.
</Note>
...
În fundal, fiecare acțiune de cod este susținută de propria **funcție logică** — o funcție TypeScript pe server, care rulează pe platforma SeaRM. Când adaugi o acțiune de cod, SeaRM creează o funcție logică dedicată pentru acel pas și îi afișează editorul inline, astfel încât codul pe care îl scrii rămâne asociat cu workflow-ul.
