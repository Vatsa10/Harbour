...
description: Aflați despre planurile tarifare ale SeaRM și cum să comutați între ele.
---

## Prezentare generală

SeaRM oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
<Note>
Funcționalitățile Premium (SSO, permisiuni la nivel de rând, date privind utilizarea AI și altele) nu sunt incluse în planul Pro.
</Note>
...
* Tot ce include Pro
* **Funcționalități Premium**: integrare SSO, permisiuni la nivel de rând, date privind utilizarea AI și altele
* Suport prioritar
...
Găzduiți SeaRM pe propria infrastructură, fără costuri:
...
* **Funcționalități Premium**: integrare SSO, permisiuni la nivel de rând, date privind utilizarea AI și altele
* Asistență din partea echipei SeaRM
...
1. Accesați **Setări → Facturare → Planuri**
...
1. Accesați **Setări → Facturare → Planuri**
2. Faceți clic pe **Treceți la Pro**
3. Confirmați retrogradarea

### Treceți la facturarea anuală

1. Accesați **Setări → Facturare**
2. Faceți clic pe **Treceți la anual**
3. Economisiți cu facturarea anuală

### Treceți la facturarea lunară

1. Accesați **Setări → Facturare**
2. Faceți clic pe **Treceți la lunar**
3. Economisiți cu facturarea lunară
