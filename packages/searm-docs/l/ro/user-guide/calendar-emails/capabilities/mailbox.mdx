...
description: Înțelegerea funcțiilor de integrare a emailului în SeaRM.
---
...
SeaRM leagă automat e-mailurile din căsuțele poștale conectate la înregistrările CRM relevante, păstrând toate istoricul comunicațiilor într-un singur loc.
...
SeaRM importă e-mailuri cu aproximativ **400 de mesaje pe minut**. Această rată este în prezent limitată de restricțiile de rată ale API-ului Gmail (și se aplică în mod similar altor furnizori).
...
Alegeți dacă e-mailurile interne sunt sincronizate în SeaRM:
...
* **E-mailuri lipsă**: Verificați dacă:
  ...
  * Crearea automată a contactelor este dezactivată (e-mailurile necesită existența înregistrărilor SeaRM)
