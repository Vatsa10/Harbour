...
Sistemul de permisiuni SeaRM vă permite să controlați cine poate accesa și modifica datele din spațiul dvs. de lucru. Creați roluri, atribuiți permisiuni și configurați SSO pentru acces securizat.
...
<CardGroup cols={2}>
  ...
  <Card title="Configurare SSO" icon="key" href="/l/ro/user-guide/permissions-access/capabilities/sso-configuration">
