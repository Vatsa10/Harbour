...
<AccordionGroup>
<Accordion title="Ce roluri sunt incluse implicit în SeaRM?">
...
Puteți controla:
* **Send Email**: Posibilitatea de a trimite e-mailuri din SeaRM
...
Cu provisionarea JIT, conturile de utilizator sunt create automat în SeaRM atunci când cineva se autentifică prin SSO pentru prima dată. Li se atribuie automat rolul implicit.
</Accordion>
