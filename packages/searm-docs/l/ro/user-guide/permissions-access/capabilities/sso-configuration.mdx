...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în SeaRM folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Eliminați-i din spațiul de lucru SeaRM
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile SeaRM (dacă este disponibilă)
* **Proces de offboarding**: Includeți SeaRM în fluxul dvs. de deprovisionare
...
<Tip>
Aveți nevoie de configurarea SSO pentru organizația dvs.? [Găsiți un partener SeaRM certificat](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializat în SSO și configurarea identității. *(Preferiți să implicați SeaRM direct? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
