...
<CardGroup cols={3}>
  <Card href="/l/ro/developers/extend/apps/getting-started/quick-start" img="/images/user-guide/halftone/dev-apps.png">
    ...
    Extindeți SeaRM cu obiecte personalizate, logică pe partea de server, componente UI și agenți AI — toate sub formă de pachete TypeScript.
  </Card>
  ...
  <Card href="/l/ro/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    Rulați SeaRM pe propria infrastructură.
  </Card>
