...
inserată în SeaRM. Ours citeşte înregistrarea selectată, încarcă şabloanele pentru persoane
...
[componenta completă](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/front-components/generate-document-form.front-component.tsx).
</Warning>
...
stiluri mici [`Markdown`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/markdown-to-react.tsx)
hel.
...
vezi tot
[`template-record. layout-ul vârstei`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/page-layouts/template-record.page-layout.ts).
Editorii scriu șabloane într-un adevărat editor de text bogat:

<Frame caption="Tab-ul modelului: Editorul nativ de text bogat al SeaRM's legat de câmpul corpului.">
