...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/ro/developers/extend/apps',
...
[`pachete/douăzeci de aplicații/exemple/document-generator`](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/examples/document-generator).
