...
și auto-găzduite, această cale este servită de serverul tău SeaRM
(de ex. `http://localhost:2020/s/documents/generate`). Pe SeaRM Cloud, `RestApiClient`
...
sanitizat) şi îl introduce într-o curată, pagina printabilă care afișează doar conținutul șablonului- aceeași imagine ca PDF și previzualizarea in-app.
  [Vezi ajutorul](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/render-document.ts).
