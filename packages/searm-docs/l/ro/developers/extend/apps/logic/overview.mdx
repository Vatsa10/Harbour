...
description: TypeScript pe server care rulează în SeaRM — declanșat de rute HTTP, programări cron, evenimente de bază de date, instrumente IA sau acțiuni de workflow.
icon: bolt
---

**Stratul de logică** al unei aplicații SeaRM este codul care *rulează* — handler-e TypeScript pe server care reacționează la cereri HTTP, programări cron și modificări ale înregistrărilor; abilități și agenți IA care trăiesc în workspace; și conexiuni OAuth care permit funcțiilor tale să acționeze în numele utilizatorului în servicii terțe.
...
<CardGroup cols={2}>
  ...
  <Card title="Stocare cheie-valoare" icon="database" href="/l/ro/developers/extend/apps/logic/key-value-store">
    Păstrează starea între execuțiile funcțiilor de logică — cache-uri, cursoare și revendicări între spații de lucru.
  </Card>
  <Card title="Sarcini în fundal" icon="layer-group" href="/l/ro/developers/extend/apps/logic/background-jobs">
    Pune în coadă execuția unei funcții logice de către workeri pentru a depăși limita de timp per execuție.
  </Card>
</CardGroup>
...
| **Instrument IA**             | O funcționalitate IA din SeaRM decide să apeleze funcția ta      | `toolTriggerSettings`           |
