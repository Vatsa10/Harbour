...
* `objectUniversalIdentifier` specifică la ce obiect se aplică această vizualizare. Poate fi un obiect personalizat pe care l-ați definit sau un obiect standard SeaRM.
...
Toate enum-urile de mai sus sunt exportate din `searm-sdk/define`.
