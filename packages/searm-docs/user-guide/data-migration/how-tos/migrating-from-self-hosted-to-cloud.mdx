...
description: Step-by-step guide to migrate your SeaRM self-hosted instance to SeaRM Cloud.
---

## Overview

This guide walks you through migrating your data from a SeaRM self-hosted instance to SeaRM Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.searm.com](https://app.searm.com) and create a new workspace
...
<Tip>
  Migrating a large or complex workspace? [Get a certified SeaRM partner](https://searm.com/partners/list?categories=HOSTING&ref=docs-migrate-cloud) to handle the move end-to-end. *(Or loop in our team: [contact@searm.com](mailto:contact@searm.com).)*
</Tip>
