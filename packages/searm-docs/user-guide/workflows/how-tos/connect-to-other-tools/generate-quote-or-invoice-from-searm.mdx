---
title: Generate a Quote or Invoice from SeaRM
...
- [Generate a PDF from SeaRM](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — attach generated PDFs to records
