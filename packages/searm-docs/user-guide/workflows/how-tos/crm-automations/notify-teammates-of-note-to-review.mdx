...
You want to tag a colleague in a note so they receive a notification to review it. Today, SeaRM doesn't support @mentions in notes or tasks.
...
<Note>
Replace `yourSubDomain` with your actual SeaRM workspace subdomain.
</Note>
