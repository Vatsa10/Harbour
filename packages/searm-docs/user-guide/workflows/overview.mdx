---
title: Workflows
description: Learn how to build automations in SeaRM.
---

## Why Workflows Matter

SeaRM was built to bring maximum flexibility to its users. Rather than forcing you to adapt your business processes to rigid, pre-built features, workflows enable you to build automations that create the CRM that best supports your unique business use cases.

Workflows are SeaRM's in-app feature for building these automations. They give you the building blocks to create exactly what your business needs, when it needs it.
...
2. **Bring data in and out of SeaRM**: Connect SeaRM via API calls and webhooks to your database and other tools.
...
- **Form**: Get inputs from users within SeaRM UI at the time of execution
...
<Tip>
  Want help automating your workflows? [Find a certified SeaRM partner](https://searm.com/partners/list?categories=SOLUTIONING&ref=docs-workflows) to design and build your automations end-to-end.
</Tip>
