...
description: Frequently asked questions about dashboards in SeaRM.
---

<AccordionGroup>
  <Accordion title="Can I create private dashboards?">
    No, dashboards are currently visible to everyone with access to your SeaRM workspace. Private dashboards are not yet available.
  </Accordion>
  ...
  <Accordion title="Can I share dashboards with external users?">
    No, sharing dashboards with users outside your SeaRM workspace (non-SeaRM users) is not currently supported.
  </Accordion>
