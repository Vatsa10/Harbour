---
title: Dashboards
description: Learn the basics of reporting and dashboards in SeaRM.
---

## Understanding Dashboards

Dashboards in SeaRM provide a visual way to track your key performance metrics and gain insights from your CRM data.
...
<Note>
**Current limitations**:
- Exporting dashboards and sharing with external users (non-SeaRM users) are not available at the moment.
