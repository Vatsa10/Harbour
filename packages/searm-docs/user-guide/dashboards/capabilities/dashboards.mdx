...
Dashboards in SeaRM are organized in a hierarchy: **Dashboards → Tabs → Widgets**. Each dashboard can contain multiple tabs, and each tab contains widgets (charts, numbers, iFrames).
...
Dashboards are visible to everyone who has access to your SeaRM workspace. There is no private dashboard option at the moment.
