...
Email sync takes time, especially for large mailboxes. SeaRM imports emails at approximately **400 messages per minute** (limited by Gmail API rate limiting).
...
### 2. Contact Doesn't Exist in SeaRM
