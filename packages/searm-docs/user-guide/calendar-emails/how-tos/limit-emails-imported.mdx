...
description: Control which emails are imported into SeaRM.
---

## Overview

By default, SeaRM syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.
...
Messages between colleagues (same domain) can be synchronized in SeaRM:
