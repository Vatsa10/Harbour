...
The command menu gives you **quick access to actions** in SeaRM. You can access it in two ways:
...
- Create new views
- Access deleted records (SeaRM supports soft and hard deletes)
