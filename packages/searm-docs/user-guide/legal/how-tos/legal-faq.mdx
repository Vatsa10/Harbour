...
SeaRM Cloud runs on AWS servers located in Frankfurt, Germany.
</Accordion>
<Accordion title="Can the hosting region be contractually fixed for our workspace?">
Hosting region selection will be available starting in 2027, initially for new workspaces. Users will be able to request a region change for an existing workspace at a later date. Alternatively, you can reach out to [our Partners](https://searm.com/partners/list?categories=HOSTING) to help you set up your instance.
</Accordion>
<Accordion title="Which sub-processors may process or access our CRM data, and in which countries are they located?">
A list of all sub-processors is available in [our Trust Center](https://trust.searm.com/?tab=subprocessors).
</Accordion>
...
You can generate your signed DPA at https://{your-domain}/settings/legal/dpa (e.g. https://getting-started.searm.com/settings/legal/dpa).
</Accordion>
<Accordion title="Does SeaRM act as the data processor for merchant and contact information stored in the CRM, while our company remains the data controller?">
As per our [Privacy Policy](https://searm.com/privacy-policy), SeaRM acts as the data processor for merchant and contact information stored in the CRM, while your company remains the data controller.
</Accordion>
<Accordion title="Is CRM content ever used to train SeaRM or third-party AI models?">
CRM content can be used to train AI models depending on sub-processors' Terms and Conditions. SeaRM does not have its own AI model — all AI models available on SeaRM Cloud are provided by our sub-processors.
</Accordion>
...
<Accordion title="Which SeaRM personnel or sub-processors may access customer workspaces, for what purposes, and how is access approved and logged?">
SeaRM's engineering and support teams may access customer workspaces to investigate and resolve issues. Workspace owners control this: support access can be disabled at any time in Settings → General → Security, and it stays off until you turn it back on.
</Accordion>
...
For more info about data retention, you can request our Data Management and Retention Policy available in [our Trust Center](https://trust.searm.com/?tab=documents).
</Accordion>
<Accordion title="Can SeaRM provide written confirmation when a full deletion request has been completed?">
...
<Accordion title="What are the recovery-point objective and recovery-time objective for SeaRM Cloud?">
...
To request a restoration, please reach out to our team via support chat or mail to [contact@searm.com](mailto:contact@searm.com).
</Accordion>
...
<AccordionGroup>
<Accordion title="Is SeaRM GDPR compliant?">
Yes, SeaRM is [GDPR compliant](https://trust.searm.com/?tab=securityControls&frameworks=gdpr_v1).
</Accordion>
<Accordion title="Is SeaRM SOC 2 compliant?">
Yes, SeaRM is [SOC 2 compliant](https://trust.searm.com/?tab=securityControls&frameworks=soc2_v1).
</Accordion>
<Accordion title="Is SeaRM HIPAA compliant?">
No, SeaRM is in the process of becoming HIPAA compliant.
</Accordion>
</AccordionGroup>
...
<Accordion title="If I create a separate front end and use SeaRM as a backend as-is, do I have to publish those changes?">
No. Your front end is your own, separate work, and talking to SeaRM through its APIs does not change that. Since SeaRM itself is unmodified, there is nothing to publish.
</Accordion>
...
If you have more questions, please check our [Terms and Conditions](https://searm.com/terms), [Privacy Policy](https://searm.com/privacy-policy) and [Trust Center](https://trust.searm.com/). If your questions are still unanswered, send them to [contact@searm.com](mailto:contact@searm.com) or via support chat.
