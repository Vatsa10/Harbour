...
if [ -d "packages/searm-docs" ]; then
  DOCS_DIR="packages/searm-docs/l"
elif [ -d "l" ]; then
  DOCS_DIR="l"
else
...
for lang_dir in "$DOCS_DIR"/*/ ; do
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|href=\"/searm-ui/|href=\"/l/$lang_code/searm-ui/|g" {} \;
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|](/searm-ui/|](/l/$lang_code/searm-ui/|g" {} \;

  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.searm\.com/getting-started/|https://docs.searm.com/l/$lang_code/getting-started/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.searm\.com/user-guide/|https://docs.searm.com/l/$lang_code/user-guide/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.searm\.com/developers/|https://docs.searm.com/l/$lang_code/developers/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.searm\.com/searm-ui/|https://docs.searm.com/l/$lang_code/searm-ui/|g" {} \;
