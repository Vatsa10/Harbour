...
- `objectUniversalIdentifier` specifies which object this view applies to. It can be a custom object you defined or a standard SeaRM object.
...
All enums above are exported from `searm-sdk/define`.
