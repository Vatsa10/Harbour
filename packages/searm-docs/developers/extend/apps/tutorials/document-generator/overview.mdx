...
description: Build a real SeaRM app that generates personalized documents from your CRM data.
---
...
a local SeaRM server running on port `2020` and the CLI authenticated to it.
...
Leave `yarn searm dev` running in a terminal for the whole tutorial. Every time
