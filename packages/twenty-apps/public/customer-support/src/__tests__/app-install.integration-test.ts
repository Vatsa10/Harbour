...
// ---------------------------------------------------------------------------
// Opt-in: requires a live Twenty instance and credentials. vitest.config.ts's
...
//
// Structure copied from packages/twenty-apps/examples/hello-world/src/
...
//     packages/twenty-apps/internal/self-hosting/src/logic-functions/
...
describe('Customer Support app installation', () => {
  ...
  it('should remove the ticket object on uninstall and leave Company untouched', async () => {
    ...
    // twenty-server. Verified against packages/twenty-server/test/integration/
