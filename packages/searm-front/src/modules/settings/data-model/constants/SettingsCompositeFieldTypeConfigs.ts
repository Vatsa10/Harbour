...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/Vatsa10/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@searm.com',
        additionalEmails: [
          'tim@searm.com',
          'timapple@searm.com',
          'johnappletim@searm.com',
        ],
      },
      {
        primaryEmail: 'jane@searm.com',
        additionalEmails: ['jane@searm.com', 'jane.doe@searm.com'],
      },
      {
        primaryEmail: 'john@searm.com',
        additionalEmails: ['john.doe@searm.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'searm.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'searm.com', label: 'SeaRM' }],
      },
      {
        primaryLinkUrl: 'github.com/Vatsa10/Harbour',
        primaryLinkLabel: 'SeaRM Repo',
        secondaryLinks: [{ url: 'searm.com', label: '' }],
      },
      {
