...
import { IconArrowRight, IconGoogle, IconMicrosoft } from 'searm-ui/icon';
...
const StyledSearmLogo = styled.img`
...
export const OnboardingImportPreviewSyncBadge = () => {
  ...
  return (
    <StyledBadge>
      ...
      />
      <StyledSearmLogo src="/images/integrations/searm-logo.svg" alt="" />
    </StyledBadge>
  );
};
