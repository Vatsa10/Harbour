...
import { ComponentDecorator } from 'searm-ui/testing';
  ...
  args: {
    value: {
      ...
      secondaryLinks: [
        ...
        { url: 'https://www.searm.com', label: 'Valid Link' },
      ],
    },
  },
  play: async ({ canvasElement }) => {
    ...
    expect(validLink).toHaveAttribute('href', 'https://www.searm.com');
...
export const SingleLink: Story = {
  args: {
    value: {
      primaryLinkUrl: 'https://www.searm.com',
      primaryLinkLabel: 'SeaRM Website',
      secondaryLinks: null,
    },
  },
  play: async ({ canvasElement }) => {
    ...
    expect(link).toHaveAttribute('href', 'https://www.searm.com');
    expect(link).toHaveTextContent('SeaRM Website');
...
export const MultipleLinks: Story = {
  args: {
    value: {
      ...
      primaryLinkLabel: 'SeaRM Website',
      secondaryLinks: [
        { url: 'https://docs.searm.com', label: 'Documentation' },
        { url: 'https://blog.searm.com', label: 'Blog' },
      ],
    },
  },
  play: async ({ canvasElement }) => {
    ...
    const primaryLink = await canvas.findByText('SeaRM Website');
    expect(primaryLink).toBeVisible();
    expect(primaryLink).toHaveAttribute('href', 'https://www.searm.com');

    const docsLink = await canvas.findByText('Documentation');
    expect(docsLink).toBeVisible();
    expect(docsLink).toHaveAttribute('href', 'https://docs.searm.com');

    const blogLink = await canvas.findByText('Blog');
    expect(blogLink).toBeVisible();
    expect(blogLink).toHaveAttribute('href', 'https://blog.searm.com');
  },
};
...
export const SocialMediaLinks: Story = {
  args: {
    value: {
      primaryLinkUrl: 'https://www.linkedin.com/company/searm',
      primaryLinkLabel: '',
      secondaryLinks: [
        { url: 'https://twitter.com/searmcrm', label: null },
        {
          url: 'https://www.instagram.com/searm_hq',
          label: null,
        },
      ],
    },
  ...
  play: async ({ canvasElement }) => {
    ...
    const linkedinLink = await canvas.findByText('searm');
    expect(linkedinLink).toBeVisible();
    expect(linkedinLink).toHaveAttribute(
      'href',
      'https://www.linkedin.com/company/searm',
    );

    const twitterLink = await canvas.findByText('@searmcrm');
    expect(twitterLink).toBeVisible();
    expect(twitterLink).toHaveAttribute(
      'href',
      'https://twitter.com/searmcrm',
    );

    const instagramLink = await canvas.findByText('@searm_hq');
    expect(instagramLink).toBeVisible();
    expect(instagramLink).toHaveAttribute(
      'href',
      'https://www.instagram.com/searm_hq',
    );
  },
};
...
export const InstagramLinks: Story = {
  args: {
    value: {
      primaryLinkUrl: 'https://www.instagram.com/searm_hq',
      primaryLinkLabel: '',
      secondaryLinks: [
  ...
  play: async ({ canvasElement }) => {
    ...
    const handleLink = await canvas.findByText('@searm_hq');
...
export const SocialLinksWithCustomLabels: Story = {
  args: {
    value: {
      primaryLinkUrl: 'https://www.linkedin.com/company/searm',
      primaryLinkLabel: 'SeaRM on LinkedIn',
      secondaryLinks: [
        {
          url: 'https://www.instagram.com/searm_hq',
          label: 'SeaRM on Instagram',
        },
      ],
    },
  },
  play: async ({ canvasElement }) => {
    ...
    const linkedinLink = await canvas.findByText('SeaRM on LinkedIn');
    expect(linkedinLink).toBeVisible();
    expect(linkedinLink).toHaveAttribute(
      'href',
      'https://www.linkedin.com/company/searm',
    ...
    const instagramLink = await canvas.findByText('SeaRM on Instagram');
    expect(instagramLink).toBeVisible();
    expect(instagramLink).toHaveAttribute(
      'href',
      'https://www.instagram.com/searm_hq',
