...
import { ComponentDecorator, RouterDecorator } from 'searm-ui/testing';
...
const CONFIGURED_SEND_EMAIL_ACTION: WorkflowSendEmailAction = {
  ...
  settings: {
    input: {
      ...
      subject: 'Welcome to SeaRM!',
      body: 'Dear Tim,\n\nWelcome to SeaRM! We are excited to have you on board.\n\nBest regards,\nThe Team',
      files: [],
      inReplyTo: '',
    },
    outputSchema: {},
...
export const Configured: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const emailInput = await canvas.findByText('test@searm.com');
    expect(emailInput).toBeVisible();

    const subjectInput = await canvas.findByText('Welcome to SeaRM!');
