...
import { isSearmStandardApplication } from '@/applications/utils/isSearmStandardApplication';
...
export const SettingsApplicationDetails = () => {
  ...
  const isStandardApplication = isSearmStandardApplication(application);
