...
import 'searm-ui/theme-dark.css';
...
const remoteImageMockHandlers = [
  ...
  http.get('https://searm-icons.com/*', respondWithMockImage),
  http.get('https://Vatsa10.github.io/*', respondWithMockImage),
  http.get('https://via.placeholder.com/*', respondWithMockImage),
  http.get(
    'https://searm-front-screenshots.s3.eu-west-3.amazonaws.com/*',
