...
Use this reference for SeaRM app objects, fields, relations, roles, and permissions.
...
- Prefer generated app entity patterns from `yarn searm dev:add`.
...
- Avoid duplicating data that already exists on core SeaRM objects.
