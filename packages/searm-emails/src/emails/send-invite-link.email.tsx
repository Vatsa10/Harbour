...
import { WhatIsSeaRM } from 'src/components/WhatIsSeaRM';
import { capitalize } from 'src/utils/capitalize';
import { createI18nInstance } from 'src/utils/i18n.utils';
import { type APP_LOCALES } from 'searm-shared/translations';
import { getImageAbsoluteURI } from 'searm-shared/utils';
...
export const SendInviteLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      <Title value={i18n._('Join your team on SeaRM')} />
      <MainText>
        <Trans
      ...
      <WhatIsSeaRM i18n={i18n} />
    </BaseEmail>
  );
};

SendInviteLinkEmail.PreviewProps = {
  link: 'https://app.searm.com/invite/123',
  workspace: {
    name: 'Acme Inc.',
