...
// independently — one in twenty-front, one in twenty-server — with no shared
...
const SERVER_RESOLVER_PATH = join(
  __dirname,
  '../../../../../../twenty-server/src/engine/metadata-modules/ai/ai-write-approval/resolvers/proposal.resolver.ts',
);
