...
const esmNodeGlobalsBanner = [
  "import { createRequire as __searmCreateRequire } from 'node:module';",
  "import { fileURLToPath as __searmFileURLToPath } from 'node:url';",
  "import { dirname as __searmDirname } from 'node:path';",
  'const require = __searmCreateRequire(import.meta.url);',
  'const __filename = __searmFileURLToPath(import.meta.url);',
  'const __dirname = __searmDirname(__filename);',
].join('\n');
...
export default defineConfig(() => {
  return {
    root: __dirname,
    cacheDir: '../../node_modules/.vite/packages/searm-sdk-node',
    resolve: {
      tsconfigPaths: true,
      alias: {
