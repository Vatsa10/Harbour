...
// Records credit usage against the running application via the SeaRM
// server's `/app/billing/charge` endpoint. Reads `SEARM_API_URL` and
// `SEARM_APP_ACCESS_TOKEN` from the execution env (injected by the
