import { type ObjectFieldManifest } from 'searm-shared/application';
import { COMPOSITE_FIELD_TYPE_SUB_FIELDS_NAMES } from 'searm-shared/constants';
import {
  fieldMetadataDefaultValueFunctionName,
  type FieldMetadataDefaultValueFunctionNames,
  FieldMetadataType,
} from 'searm-shared/types';
import { isDefined, isPlainObject } from 'searm-shared/utils';
