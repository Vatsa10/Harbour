...
import { createStubSearmSdkDefinePlugin } from '@/cli/utilities/build/common/plugins/stub-searm-sdk-define.plugin';
import {
...
import { NODE_ESM_CJS_BANNER, OUTPUT_DIR } from 'searm-shared/application';
import { FileFolder } from 'searm-shared/types';

export const LOGIC_FUNCTION_EXTERNAL_MODULES: string[] = [
  'searm-client-sdk/core',
  'searm-client-sdk/metadata',
  'path',
  'fs',
  'crypto',
  'stream',
  ...
  new EsbuildWatcher({
    ...
    config: {
      ...
      extraPlugins: [
        ...
        createStubSearmSdkDefinePlugin(),
      ],
