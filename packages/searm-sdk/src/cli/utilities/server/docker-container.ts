...
export const CONTAINER_NAME = 'searm-app-dev';
export const TEST_CONTAINER_NAME = 'searm-app-dev-test';
export const IMAGE = 'searmcrm/searm-app-dev:latest';
...
export const getImageForVersion = (version = 'latest'): string => {
  ...
  return `searmcrm/searm-app-dev:${tag}`;
};
