...
Thanks for considering contributing to SeaRM!

Please make sure to go through the [documentation](https://docs.searm.com) before.
...
```shell
git clone https://github.com/yourusername/searm.git
cd searm
```
...
4. **Make Changes:** Make your desired changes and ensure that your code adheres to SeaRM's coding standards.
...
8. **Create a Pull Request:** Go to the original SeaRM repository and create a pull request. Please provide a detailed description of your changes. Submitting a PR means you agree to the CLA.
...
If you face any issues or have suggestions, please feel free to [create an issue on SeaRM's GitHub repository](https://github.com/Vatsa10/Harbour/issues/new). Please provide as much detail as possible.
