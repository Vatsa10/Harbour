...
export const successfulFilterInputByFieldMetadataType: {
  ...
  [FieldMetadataType.LINKS]: [
    {
      gqlFilterInput: {
        linksField: { primaryLinkUrl: { eq: 'searm.com' } },
      },
      restFilterInput: 'linksField.primaryLinkUrl[eq]:"searm.com"',
      validateFilter: (record: Record<string, any>) => {
        return record.linksField.primaryLinkUrl === 'searm.com';
      },
    },
    {
      gqlFilterInput: {
        linksField: {
          primaryLinkLabel: { eq: 'searm - #1 Open source CRM' },
        },
      },
      restFilterInput:
        'linksField.primaryLinkLabel[eq]:"searm - #1 Open source CRM"',
      validateFilter: (record: Record<string, any>) => {
        return (
          record.linksField.primaryLinkLabel === 'searm - #1 Open source CRM'
        );
      },
    },
    {
      gqlFilterInput: { linksField: { secondaryLinks: { like: '%searm%' } } },
      restFilterInput: 'linksField.secondaryLinks[like]:"%searm%"',
      validateFilter: (record: Record<string, any>) => {
