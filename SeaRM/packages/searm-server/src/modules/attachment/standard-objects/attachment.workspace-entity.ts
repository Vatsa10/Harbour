...
import { BaseWorkspaceEntity } from 'src/engine/searm-orm/base.workspace-entity';
import { type CustomWorkspaceEntity } from 'src/engine/searm-orm/custom.workspace-entity';
