...
import { SEARM_COMPANIES_BASE_URL } from 'searm-shared/constants';
import {
  type ConnectedAccountProvider,
  type FieldActorSource,
} from 'searm-shared/types';
import { isDefined, normalizeUrlOrigin } from 'searm-shared/utils';
...
export class CreateCompanyService {
  ...
  constructor(
    ...
    this.httpService = this.secureHttpClientService.getHttpClient({
      baseURL: SEARM_COMPANIES_BASE_URL,
    });
  }
