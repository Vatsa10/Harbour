...
import { type SearmAllVersion } from 'src/engine/core-modules/upgrade/constants/searm-all-versions.constant';

const VERSION_A = '10.20.0' as SearmAllVersion;
const VERSION_B = '30.40.0' as SearmAllVersion;
