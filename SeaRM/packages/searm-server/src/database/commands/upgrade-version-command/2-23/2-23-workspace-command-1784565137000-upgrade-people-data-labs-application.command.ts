...
// packages/searm-apps/public/people-data-labs APPLICATION_UNIVERSAL_IDENTIFIER
...
// bundle React 19 to match the searm-sdk runtime (fixed in 1.0.9).
  ...
  override async runOnWorkspace({
    ...
    try {
      await this.applicationUpgradeService.upgradeApplication({
        ...
        workspaceId,
        // 1.0.9 pins engines.searm >=2.23.0, but this command runs as part of
