import { fromArrayToValuesByKeyRecord, isDefined } from 'searm-shared/utils';
...
// Backfill skips the searm-standard and workspace-custom applications (their GIN index is
...
> => {
  ...
  for (const flatObjectMetadata of Object.values(
    ...
    if (
      flatObjectMetadata.applicationId === searmStandardApplicationId ||
