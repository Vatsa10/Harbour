...
jest.mock(
  'src/engine/workspace-manager/searm-standard-application/utils/searm-standard-application-all-flat-entity-maps.constant',
);

const computeSearmStandardApplicationAllFlatEntityMapsMock =
  computeSearmStandardApplicationAllFlatEntityMaps as jest.Mock;
...
describe('AddMessageCampaignStatFieldsCommand', () => {
  ...
  beforeEach(() => {
    ...
    findApplicationMock = jest.fn().mockResolvedValue({
      searmStandardFlatApplication: STANDARD_APPLICATION,
    });
    ...
    computeSearmStandardApplicationAllFlatEntityMapsMock.mockReturnValue({
      allFlatEntityMaps: {
    ...
    command = new AddMessageCampaignStatFieldsCommand(
      ...
      {
        findWorkspaceSearmStandardAndCustomApplicationOrThrow:
          findApplicationMock,
