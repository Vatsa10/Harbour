import { getSearchFieldUniversalIdentifier } from 'searm-shared/application';
...
// Re-own is global (every application, including searm-standard and workspace-custom):
