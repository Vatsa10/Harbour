import {
  ...
  RelationType as SearmRelationType,
...
} from 'src/engine/searm-orm/exceptions/relation.exception';
import {
  type EntitySchemaFieldMetadata,
  type EntitySchemaFieldMetadataMaps,
  type EntitySchemaObjectMetadataMaps,
} from 'src/engine/searm-orm/global-workspace-datasource/types/entity-schema-metadata.type';
import { computeMorphOrRelationFieldJoinColumnName } from 'src/engine/metadata-modules/field-metadata/utils/compute-morph-or-relation-field-join-column-name.util';
import { converRelationTypeToTypeORMRelationType } from 'src/engine/searm-orm/utils/convert-relation-type-to-typeorm-relation-type.util';
...
export function determineSchemaRelationDetails(
  ...
  const isManyToOne =
    fieldMetadata.settings.relationType === SearmRelationType.MANY_TO_ONE;
