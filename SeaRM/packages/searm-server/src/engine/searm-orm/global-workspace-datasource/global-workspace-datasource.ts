import { type ObjectsPermissionsByRoleId } from 'searm-shared/types';
...
import { WorkspaceEntityManager } from 'src/engine/searm-orm/entity-manager/workspace-entity-manager';
import { type WorkspaceQueryRunner } from 'src/engine/searm-orm/query-runner/workspace-query-runner';
import { type WorkspaceRepository } from 'src/engine/searm-orm/repository/workspace.repository';
