...
import { QUERY_MAX_RECORDS } from 'searm-shared/constants';
...
import { type RelationDisconnectQueryFieldsByEntityIndex } from 'src/engine/searm-orm/entity-manager/types/relation-nested-query-fields-by-entity-index.type';
...
import { FilesFieldSync } from 'src/engine/searm-orm/field-operations/files-field-sync/files-field-sync';
import { RelationNestedQueries } from 'src/engine/searm-orm/field-operations/relation-nested-queries/relation-nested-queries';
...
import { WorkspaceSelectQueryBuilder } from 'src/engine/searm-orm/repository/workspace-select-query-builder';
import { type WorkspaceSoftDeleteQueryBuilder } from 'src/engine/searm-orm/repository/workspace-soft-delete-query-builder';
...
import { formatData } from 'src/engine/searm-orm/utils/format-data.util';
...
import { validateRLSPredicatesForRecords } from 'src/engine/searm-orm/utils/validate-rls-predicates-for-records.util';
    ...
    try {
      ...
      if (before.length > QUERY_MAX_RECORDS) {
        throw new SearmORMException(
          ...
          SearmORMExceptionCode.TOO_MANY_RECORDS_TO_UPDATE,
          {
      ...
      throw await computeSearmORMException(
        error,
        objectMetadata,
