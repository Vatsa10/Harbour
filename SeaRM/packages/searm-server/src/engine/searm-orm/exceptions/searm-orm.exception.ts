...
export enum SearmORMExceptionCode {
...
const getSearmORMExceptionUserFriendlyMessage = (
  code: SearmORMExceptionCode,
) => {
  switch (code) {
    case SearmORMExceptionCode.WORKSPACE_SCHEMA_NOT_FOUND:
      return msg`Workspace schema not found.`;
    case SearmORMExceptionCode.ROLES_PERMISSIONS_VERSION_NOT_FOUND:
      return msg`Roles and permissions configuration not found.`;
    case SearmORMExceptionCode.FEATURE_FLAG_MAP_VERSION_NOT_FOUND:
      return msg`Feature configuration not found.`;
    case SearmORMExceptionCode.USER_WORKSPACE_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`User workspace role configuration not found.`;
    case SearmORMExceptionCode.API_KEY_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`API key role configuration not found.`;
    case SearmORMExceptionCode.MALFORMED_METADATA:
      return msg`Data structure is invalid.`;
    case SearmORMExceptionCode.WORKSPACE_NOT_FOUND:
    ...
    case SearmORMExceptionCode.MISSING_MAIN_ALIAS_TARGET:
      return msg`Missing main alias target.`;
    case SearmORMExceptionCode.METHOD_NOT_ALLOWED:
      return msg`This operation is not allowed.`;
    case SearmORMExceptionCode.QUERY_READ_TIMEOUT:
    ...
    case SearmORMExceptionCode.ENUM_TYPE_NAME_NOT_FOUND:
    case SearmORMExceptionCode.ORM_EVENT_DATA_CORRUPTED:
      return STANDARD_ERROR_MESSAGE;
    case SearmORMExceptionCode.NO_ROLE_FOUND_FOR_USER_WORKSPACE:
...
export class SearmORMException extends CustomException<SearmORMExceptionCode> {
  constructor(
    message: string,
    code: SearmORMExceptionCode,
    ...
    super(message, code, {
      userFriendlyMessage:
        userFriendlyMessage ?? getSearmORMExceptionUserFriendlyMessage(code),
    });
  }
}
