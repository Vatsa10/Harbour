...
> {
  ...
  @Inject()
  protected readonly searmConfigService: SearmConfigService;
  @Inject()
  ...
  private async throttleApplicationQueryExecution(
    ...
    try {
      await this.throttlerService.tokenBucketThrottleOrThrow(
        ...
        1,
        this.searmConfigService.get('APPLICATION_API_RATE_LIMITING_LIMIT'),
        this.searmConfigService.get('APPLICATION_API_RATE_LIMITING_TTL_IN_MS'),
      );
    } catch (error) {
  ...
  private async throttleApiKeyQueryExecution(
    ...
    try {
      ...
      const shortConfig = {
        ...
        maxTokens: this.searmConfigService.get(
          'API_RATE_LIMITING_SHORT_LIMIT',
        ),
        timeWindow: this.searmConfigService.get(
      ...
      const longConfig = {
        ...
        maxTokens: this.searmConfigService.get('API_RATE_LIMITING_LONG_LIMIT'),
        timeWindow: this.searmConfigService.get(
  ...
  private validateQueryComplexity(
    ...
    const maximumComplexity = this.searmConfigService.get(
