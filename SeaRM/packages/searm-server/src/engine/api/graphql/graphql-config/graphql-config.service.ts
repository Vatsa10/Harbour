  ...
  createGqlOptions(): YogaDriverConfig {
    ...
    const plugins = [
      ...
      useGraphQLErrorHandlerHook({
        ...
        searmConfigService: this.searmConfigService,
      }),
      useDisableIntrospectionAndSuggestionsForUnauthenticatedUsers(
        this.searmConfigService.get('NODE_ENV') === NodeEnvironment.PRODUCTION,
      ),
      useValidateGraphqlQueryComplexity({
        maximumAllowedFields:
          this.searmConfigService.get('GRAPHQL_MAX_FIELDS'),
        maximumAllowedRootResolvers: this.searmConfigService.get(
