...
import { type StandardRecordPageLayouts } from 'src/engine/workspace-manager/searm-standard-application/utils/page-layout-config/standard-page-layout-config.type';
