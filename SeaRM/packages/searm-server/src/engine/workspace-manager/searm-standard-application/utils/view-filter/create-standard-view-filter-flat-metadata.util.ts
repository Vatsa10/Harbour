...
import { type ViewFilterOperand } from 'searm-shared/types';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/searm-standard-application/types/all-standard-object-view-filter-name.type';
