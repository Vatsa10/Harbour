import { AggregateOperations, ViewType, ViewKey } from 'searm-shared/types';
...
} from 'src/engine/workspace-manager/searm-standard-application/utils/view/create-standard-view-flat-metadata.util';
