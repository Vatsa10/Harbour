...
export class CleanerWorkspaceService {
  ...
  constructor(
    ...
    this.inactiveDaysBeforeSoftDelete = this.searmConfigService.get(
      'WORKSPACE_INACTIVE_DAYS_BEFORE_SOFT_DELETION',
    );
    this.inactiveDaysBeforeDelete = this.searmConfigService.get(
      'WORKSPACE_INACTIVE_DAYS_BEFORE_DELETION',
    );
    this.inactiveDaysBeforeWarn = this.searmConfigService.get(
