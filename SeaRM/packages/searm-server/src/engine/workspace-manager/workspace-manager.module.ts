...
import { SearmStandardApplicationModule } from 'src/engine/workspace-manager/searm-standard-application/searm-standard-application.module';
...
@Module({
  imports: [
    ...
    PermissionsModule,
    AiAgentModule,
    SearmStandardApplicationModule,
