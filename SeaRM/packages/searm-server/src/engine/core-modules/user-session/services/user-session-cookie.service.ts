...
export class UserSessionCookieService {
  ...
  private isSecureDeployment(): boolean {
    ...
    const sameSite = this.searmConfigService.get('AUTH_COOKIE_SAME_SITE');
  ...
  private areCookieSessionsEnabled(): boolean {
    return this.searmConfigService.get('AUTH_COOKIE_SESSIONS_ENABLED');
  }
  ...
  private resolveCookieOptions(): CookieOptions {
    return {
      ...
      sameSite: this.searmConfigService.get('AUTH_COOKIE_SAME_SITE'),
      path: '/',
    };
  }
