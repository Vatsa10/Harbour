...
import { type Manifest } from 'searm-shared/application';
...
const CONFIG_VALUES: Record<string, string> = {
  SERVER_URL: 'https://api.searm.com',
...
describe('ApplicationRegistrationAssetUrlService', () => {
  ...
  describe('buildLogoUrl', () => {
    it('should build a server file url when a logoFileId is set', () => {
      ...
      expect(logoUrl).toBe(
        'https://api.searm.com/files/application-registrations/registration-id/public/logo.png',
      );
    });
    ...
    it('should url-encode stored asset path segments', () => {
      ...
      expect(logoUrl).toBe(
        'https://api.searm.com/files/application-registrations/registration-id/public/logo%20%231.png',
      );
    });
    ...
    it('should build a registry cdn url for npm registrations', () => {
      const logoUrl = service.buildLogoUrl({
        ...
        sourcePackage: '@searm/my-app',
        latestAvailableVersion: '2.3.4',
        logo: 'public/logo.png',
      });

      expect(logoUrl).toBe(
        'https://cdn.registry.com/@searm/my-app@2.3.4/public/logo.png',
      );
    });
  ...
  describe('buildGalleryImageUrls', () => {
    it('should resolve stored gallery images by fileId and keep absolute urls', () => {
      ...
      expect(urls).toEqual([
        'https://api.searm.com/files/application-registrations/registration-id/public/one.png',
    ...
    it('should resolve npm gallery images from the registry cdn', () => {
      ...
      expect(urls).toEqual([
        'https://cdn.registry.com/@searm/my-app@2.3.4/public/one.png',
      ]);
    });
