...
describe('AccessTokenService', () => {
  ...
  describe('generateAccessToken', () => {
    it('should generate an access token successfully', async () => {
      ...
      jest.spyOn(searmConfigService, 'get').mockReturnValue('1h');
      jest
  ...
  describe('validateToken', () => {
    ...
    it('should throw an error if token is missing', async () => {
      ...
      jest.spyOn(searmConfigService, 'get').mockReturnValue(false);
    ...
    it('should resolve the session cookie when cookie sessions are enabled', async () => {
      ...
      const mockRequest = {
        headers: {
          cookie: `searm-session=${mockSessionToken}`,
        },
      } as Request;
      const mockPayload = {
        sub: 'user-id',
    ...
    it('should ignore the session cookie when cookie sessions are disabled', async () => {
      const mockRequest = {
        headers: {
          cookie: 'searm-session=sess_opaque-session-token',
        },
      } as Request;
