...
export class MicrosoftAPIsOauthRequestCodeGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    ...
    try {
      if (
        !this.searmConfigService.get('MESSAGING_PROVIDER_MICROSOFT_ENABLED') &&
        !this.searmConfigService.get('CALENDAR_PROVIDER_MICROSOFT_ENABLED')
      ) {
      ...
      new MicrosoftAPIsOauthRequestCodeStrategy(this.searmConfigService);
