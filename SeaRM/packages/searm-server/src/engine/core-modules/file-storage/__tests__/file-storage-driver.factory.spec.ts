...
describe('FileStorageDriverFactory', () => {
  ...
  describe('buildConfigKey', () => {
    it('should build config key for local storage', () => {
      ...
      expect(searmConfigService.get).toHaveBeenCalledWith('STORAGE_TYPE');
      expect(searmConfigService.get).toHaveBeenCalledWith(
        'STORAGE_LOCAL_PATH',
      );
    });
  ...
  describe('createDriver', () => {
    ...
    it('should throw error for invalid storage driver type', () => {
      jest.spyOn(searmConfigService, 'get').mockReturnValue('invalid-type');
