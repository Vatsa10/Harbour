...
import { type ServerFileFolder } from 'searm-shared/types';
...
export class ServerFileStorageService {
  ...
  constructor(
    ...
    // eslint-disable-next-line searm/prefer-workspace-scoped-repository -- server-scoped rows (workspaceId IS NULL) are unreachable through the scoped wrapper; every query below pins workspaceId to IsNull()
