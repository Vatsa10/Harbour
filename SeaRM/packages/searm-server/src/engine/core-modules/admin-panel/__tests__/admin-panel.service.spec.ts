...
const SearmConfigServiceGetAllMock = jest.fn();
const SearmConfigServiceGetVariableWithMetadataMock = jest.fn();
const mockHttpClientGet = jest.fn();
const mockGetHttpClient = jest.fn().mockReturnValue({ get: mockHttpClientGet });

jest.mock(
  'src/engine/core-modules/searm-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelConfigService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminPanelConfigService,
        {
          ...
          useValue: {
            getAll: SearmConfigServiceGetAllMock,
            getVariableWithMetadata:
              SearmConfigServiceGetVariableWithMetadataMock,
          },
        },
      ],
    }).compile();
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      SearmConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      SearmConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      SearmConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
...
describe('AdminPanelVersionService', () => {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      versionService['searmConfigService'].get = mockEnvironmentGet;
    });
