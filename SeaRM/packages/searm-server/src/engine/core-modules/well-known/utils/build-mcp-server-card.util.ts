...
export const buildMcpServerCard = ({
  ...
  name: 'com.searm/searm',
  version,
  title: 'SeaRM CRM',
  description:
    'Read and write your SeaRM CRM data - companies, people, opportunities, tasks, notes and any custom objects - from AI assistants. Tools are discovered at runtime and scoped to the authenticated workspace.',
  websiteUrl: 'https://searm.com',
  repository: {
