...
export const DPA_REGION_CONFIGS: Record<DpaRegion, DpaRegionConfig> = {
  [DpaRegion.EU]: {
    ...
    values: {
      PROCESSOR_ENTITY: 'SeaRM.com SAS',
      ...
      DPO_NAME_AND_CONTACT: 'Stéphanie Joly, privacy@searm.com',
    },
  },
  [DpaRegion.US]: {
    region: DpaRegion.US,
    ...
    values: {
      PROCESSOR_ENTITY: 'SeaRM.com PBC',
      PROCESSOR_LEGAL_FORM:
...
export const SEARM_PRESIGNED_SIGNATORY = {
  name: 'Félix Malfait',
