...
import { FeatureFlagKey, FileFolder } from 'searm-shared/types';
...
export class WorkspaceResolver {
  ...
  isGoogleAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.searmConfigService.get('AUTH_GOOGLE_ENABLED')
    );
  }
  ...
  isMicrosoftAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.searmConfigService.get('AUTH_MICROSOFT_ENABLED')
    );
  }
  ...
  isPasswordAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.searmConfigService.get('AUTH_PASSWORD_ENABLED')
    );
  }
