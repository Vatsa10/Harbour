...
jest.mock(
  'src/engine/searm-orm/utils/build-row-level-permission-record-filter.util',
  () => ({
...
jest.mock(
  'src/engine/searm-orm/utils/is-record-matching-rls-row-level-permission-predicate.util',
  () => ({
...
} = require('src/engine/searm-orm/utils/build-row-level-permission-record-filter.util');
const {
  isRecordMatchingRLSRowLevelPermissionPredicate,
} = require('src/engine/searm-orm/utils/is-record-matching-rls-row-level-permission-predicate.util');
