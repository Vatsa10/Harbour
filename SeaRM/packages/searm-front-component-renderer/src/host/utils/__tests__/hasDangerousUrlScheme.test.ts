...
describe('hasDangerousUrlScheme', () => {
  ...
  it('should allow safe schemes and relative urls', () => {
    expect(hasDangerousUrlScheme('https://searm.com')).toBe(false);
    expect(hasDangerousUrlScheme('mailto:hi@searm.com')).toBe(false);
    expect(hasDangerousUrlScheme('/relative/path')).toBe(false);
    expect(hasDangerousUrlScheme('#anchor')).toBe(false);
    expect(hasDangerousUrlScheme('blob:https://searm.com/abc')).toBe(false);
  });
