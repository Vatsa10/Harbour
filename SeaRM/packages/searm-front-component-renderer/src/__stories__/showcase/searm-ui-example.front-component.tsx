...
import { Chip, ChipVariant, Status, Tag } from 'searm-ui/data-display';
...
const SearmUiComponent = () => {
  const [count, setCount] = useState(0);

  return (
    <ThemeProvider colorScheme="light">
      <div data-testid="searm-ui-component" style={CARD_STYLE}>
        <H2Title
          title="SeaRM UI"
...
export default defineFrontComponent({
  ...
  name: 'searm-ui-component',
  description: 'A front component using SeaRM UI remote components',
  component: SearmUiComponent,
});
