...
import { Modal } from 'searm-ui/surfaces';
...
const ModalOpenGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery
      title="searm-ui/surfaces Modal (open)"
...
export default defineFrontComponent({
  ...
  name: 'searm-ui-modal-open-gallery',
  description: 'Renders an open searm-ui Modal in the sandbox',
