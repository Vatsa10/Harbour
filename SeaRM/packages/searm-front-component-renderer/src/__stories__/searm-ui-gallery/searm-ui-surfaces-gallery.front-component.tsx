...
const SURFACES_ENTRIES: GalleryEntry[] = [
  ...
  // open-Modal known issue is exposed by searm-ui-modal-open-gallery.
  {
    name: 'Modal',
    node: (
...
const SurfacesGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="searm-ui/surfaces" entries={SURFACES_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000105',
  name: 'searm-ui-surfaces-gallery',
  description: 'Renders every searm-ui/surfaces component in the sandbox',
