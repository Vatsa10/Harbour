...
import { IconPlus, IconSearch, IconStar, IconTrash } from 'searm-ui/icon';
import {
...
const InputGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="searm-ui/input" entries={INPUT_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000107',
  name: 'searm-ui-input-gallery',
  description:
    'Renders every searm-ui/input component (except monaco CodeEditor) in the sandbox',
