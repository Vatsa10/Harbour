...
import { IconHome, IconUser } from 'searm-ui/icon';
import {
  ClickToActionLink,
  ContactLink,
  GithubVersionLink,
...
const NAVIGATION_ENTRIES: GalleryEntry[] = [
  ...
  {
    name: 'ContactLink',
    node: <ContactLink href="https://searm.com">Contact</ContactLink>,
  },
  {
  ...
  {
    name: 'RoundedLink',
    node: <RoundedLink href="https://searm.com" label="Rounded link" />,
  },
  {
    name: 'SocialLink',
    node: (
      <SocialLink href="https://twitter.com/searm" type={LinkType.Twitter} />
    ),
  },
  {
...
export default defineFrontComponent({
  ...
  name: 'searm-ui-navigation-gallery',
  description: 'Renders every searm-ui/navigation component in the sandbox',
