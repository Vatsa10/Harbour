...
const FeedbackGallery = () => (
  <ThemeProvider colorScheme="light">
    <ComponentGallery title="searm-ui/feedback" entries={FEEDBACK_ENTRIES} />
  </ThemeProvider>
);

export default defineFrontComponent({
  universalIdentifier: 'test-20ui0-0000-0000-0000-000000000102',
  name: 'searm-ui-feedback-gallery',
  description: 'Renders every searm-ui/feedback component in the sandbox',
