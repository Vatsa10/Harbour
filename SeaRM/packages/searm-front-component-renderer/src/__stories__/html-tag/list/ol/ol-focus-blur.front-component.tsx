...
const OlFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="ol:focus-blur">
      <ol
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-ol-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'ol-focus-blur-front-component',
  description: 'Front component covering focus-blur on <ol>',
  component: OlFocusBlurFrontComponent,
});
