...
const DlFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="dl:focus-blur">
      <dl
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-dl-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'dl-focus-blur-front-component',
  description: 'Front component covering focus-blur on <dl>',
  component: DlFocusBlurFrontComponent,
});
