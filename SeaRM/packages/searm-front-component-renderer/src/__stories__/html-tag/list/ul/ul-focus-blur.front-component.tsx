...
const UlFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="ul:focus-blur">
      <ul
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-ul-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'ul-focus-blur-front-component',
  description: 'Front component covering focus-blur on <ul>',
  component: UlFocusBlurFrontComponent,
});
