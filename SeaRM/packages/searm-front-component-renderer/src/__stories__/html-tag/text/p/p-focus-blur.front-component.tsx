...
const PFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="p:focus-blur">
      <p
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-p-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'p-focus-blur-front-component',
  description: 'Front component covering focus-blur on <p>',
  component: PFocusBlurFrontComponent,
});
