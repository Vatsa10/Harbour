...
const RtClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="rt:click">
      <ruby>
        kanji
        <rt
          data-testid="subject"
...
export default defineFrontComponent({
  universalIdentifier: 'fc-rt-c-click-00000000-0000-0000-0000-000000000020',
  name: 'rt-click-front-component',
  description: 'Front component covering click on <rt>',
  component: RtClickFrontComponent,
});
