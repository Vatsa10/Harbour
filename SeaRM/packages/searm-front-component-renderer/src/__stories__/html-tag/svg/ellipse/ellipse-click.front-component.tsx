...
const EllipseClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="ellipse:click">
...
export default defineFrontComponent({
  universalIdentifier:
    'fc-ellipse-c-click-00000000-0000-0000-0000-000000000020',
  name: 'ellipse-click-front-component',
  description: 'Front component covering click on <ellipse>',
  component: EllipseClickFrontComponent,
});
