...
const InsFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="ins:focus-blur">
      <ins
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-ins-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'ins-focus-blur-front-component',
  description: 'Front component covering focus-blur on <ins>',
  component: InsFocusBlurFrontComponent,
});
