...
const SampFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="samp:focus-blur">
      <samp
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-samp-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'samp-focus-blur-front-component',
  description: 'Front component covering focus-blur on <samp>',
  component: SampFocusBlurFrontComponent,
});
