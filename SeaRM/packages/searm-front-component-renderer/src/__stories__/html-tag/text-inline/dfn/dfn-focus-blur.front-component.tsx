...
const DfnFocusBlurFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="dfn:focus-blur">
      <dfn
        data-testid="subject"
        onFocus={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-dfn-fb-fb-00000000-0000-0000-0000-000000000020',
  name: 'dfn-focus-blur-front-component',
  description: 'Front component covering focus-blur on <dfn>',
  component: DfnFocusBlurFrontComponent,
});
