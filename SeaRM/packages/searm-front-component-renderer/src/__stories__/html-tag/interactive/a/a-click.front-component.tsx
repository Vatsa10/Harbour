...
const AClickFrontComponent = () => {
  const [interactionCount, setInteractionCount] = useState(0);
  const { entries, pushEvent } = useEventLog();

  return (
    <FrontComponentCard title="a:click">
      <a
        data-testid="subject"
        onClick={(event) => {
...
export default defineFrontComponent({
  universalIdentifier: 'fc-a-c-click-00000000-0000-0000-0000-000000000020',
  name: 'a-click-front-component',
  description: 'Front component covering click on <a>',
  component: AClickFrontComponent,
});
