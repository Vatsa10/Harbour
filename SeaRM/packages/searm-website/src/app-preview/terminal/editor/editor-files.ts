...
// old editor-data (30 files of authored searm-sdk source fiction).
...
const rocketObjectSource = `import { defineObject, FieldType, RelationType } from 'searm-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      // Customer object — we reuse what ships with SeaRM).
...
const launchSiteObjectSource = `import { defineObject, FieldType, RelationType } from 'searm-sdk/define';
...
const launchesViewSource = `import { defineView, ViewKey } from 'searm-sdk/define';
...
const rocketsViewSource = `import { defineView, ViewKey } from 'searm-sdk/define';
...
const payloadsViewSource = `import { defineView, ViewKey } from 'searm-sdk/define';
...
const launchSitesViewSource = `import { defineView, ViewKey } from 'searm-sdk/define';
...
const applicationConfigSource = `import { defineApplication } from 'searm-sdk/define';
