...
const buildCustomerParagraph = (
  ...
  text(
    ' object that ships with SeaRM, so accounts, domain favicons, and the People relation work for free. ',
  ),
...
const WRAPUP_PARAGRAPH: StreamingSegment[] = [
  ...
  text(', and '),
  node('w-dev', <InlineCode>yarn searm dev --once</InlineCode>),
  text('. Reference: '),
  node(
    'w-docs',
    <ReferenceLink
      href="https://searm.com/developers"
      onClick={(event) => event.preventDefault()}
    >
      SeaRM app-building docs
    </ReferenceLink>,
  ),
  text('.'),
];
