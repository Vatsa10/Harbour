...
describe('halftone export naming', () => {
  ...
  it('sanitizes generated React component identifiers for the default SeaRM export', () => {
...
describe('halftone react export presets', () => {
  it('emits a SeaRM-ready GLB export with Draco support and no torus fallback', () => {
    const output = HALFTONE_EXPORTERS.generateReactComponent(
      DEFAULT_HALFTONE_SETTINGS,
      IMPORTED_GLB_SHAPE,
      'PartnerConnect',
  ...
  it('emits a SeaRM-ready image export without model loaders', () => {
  ...
  it('parses SeaRM exports with header comments and named/default exports', () => {
    const output = HALFTONE_EXPORTERS.generateReactComponent(
      DEFAULT_HALFTONE_SETTINGS,
      IMPORTED_GLB_SHAPE,
      'PartnerConnect',
