...
export const PARTNER_APPLICATION_COPY = {
  ...
  validation: {
    ...
    notesTooShort: msg`Please write at least ${SEARM_EXPERIENCE_NOTES_MIN_LENGTH} characters about the implementation.`,
  ...
  fields: {
    ...
    searmExperience: msg`What you've built in SeaRM *`,
    searmExperienceHint: msg`Select every area you used in a real project — not what you offer, what you actually did.`,
    searmExperienceNotes: msg`Tell us about the implementation *`,
    searmExperienceNotesHint: msg`Describe a real SeaRM project (customer or internal): who it was for, what you built, and how you used the areas you selected. Min. ${SEARM_EXPERIENCE_NOTES_MIN_LENGTH} characters.`,
    searmExperienceNotesPlaceholder: msg`Who it was for, what you built, which of the four areas you used…`,
    searmExperienceProofLink: msg`Proof URL *`,
    searmExperienceProofLinkHint: msg`Link that shows the work (Loom, GitHub, Notion, Drive, public write-up…). No public workspace? Share a short Loom.`,
