...
import { type PartnerSearmExperienceValue } from './data/partner-searm-experience-options';
...
export type PartnerApplicationState = {
  ...
  // Experience (what they've built in SeaRM)
  searmExperience: PartnerSearmExperienceValue[];
...
// multi-value fields (languages, partnerScope, skills, searmExperience) have
// their own actions.
...
export type PartnerApplicationAction =
  ...
  | { type: 'TOGGLE_EXPERIENCE'; value: PartnerSearmExperienceValue }
