...
export const PARTNER_SEARM_EXPERIENCE_OPTIONS = defineFieldOptions([
...
export type PartnerSearmExperienceValue =
  (typeof PARTNER_SEARM_EXPERIENCE_OPTIONS)[number]['value'];
