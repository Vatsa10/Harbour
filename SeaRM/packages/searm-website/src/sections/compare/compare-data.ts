...
export type CompareRow = {
  ...
  searm: { detail: MessageDescriptor };
};
...
export type CompetitorComparison = {
  ...
  receipt: {
    ...
    searmLines: CompareReceiptLine[];
    searmPerUser: MessageDescriptor;
    searmTotalAmount: MessageDescriptor;
    searmTotalSuffix: MessageDescriptor;
  };
  rows: CompareRow[];
  slug: string;
...
const HUBSPOT_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`SeaRM vs HubSpot`,
  heading: msg`What does\n*HubSpot* really cost?`,
  intro: msg`A feature-by-feature price check, with sources.\nMost of what HubSpot gates behind tiers is simply included in SeaRM.`,
  ...
  rows: [
    {
      ...
      searm: { detail: msg`Included from Pro, $9/user` },
    },
    {
      ...
      searm: { detail: msg`Included from Pro` },
    },
    {
      ...
      searm: { detail: msg`Roles from Pro, row-level on Organization` },
    },
    {
      ...
      searm: { detail: msg`Organization, $19/user` },
    },
    {
      ...
      searm: { detail: msg`Local environment included` },
    },
    {
      ...
      searm: { detail: msg`None, start in minutes` },
    },
  ],
  receipt: {
    ...
    searmTotalAmount: msg`$4,560`,
    searmTotalSuffix: msg`in year one`,
    searmPerUser: msg`$19 per user per month, that's it`,
...
const SALESFORCE_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`SeaRM vs Salesforce`,
  ...
  migrationLine: msg`Import your data and see your own numbers. SeaRM's importer handles Salesforce exports out of the box.`,
  slug: 'salesforce',
  ...
  rows: [
    {
      ...
      searm: { detail: msg`$9 to $19/user, everything included` },
    },
    {
      ...
      searm: { detail: msg`AI agents included, usage credits` },
    },
    {
      ...
      searm: { detail: msg`Credit-based, no per-chat fee` },
    },
    {
      ...
      searm: { detail: msg`Priority support on Organization` },
    },
    {
    ...
    },
    {
      ...
      searm: { detail: msg`Self-serve, partners optional` },
    },
  ],
  receipt: {
    scenario: msg`A 20-person sales team, billed annually`,
...
//       },
//       searm: { detail: msg`$9/user on Pro` },
//     },
//     {
...
//         sourceUrl: ATTIO_PRICING_URL,
//       },
//       searm: { detail: msg`Credit allowance included with every plan` },
//     },
//     {
...
//     searmTotalAmount: msg`$4,560`,
//     searmTotalSuffix: msg`per year`,
//     searmPerUser: msg`$19 per user per month, SSO included`,
...
const PIPEDRIVE_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`SeaRM vs Pipedrive`,
  heading: msg`What does\n*Pipedrive* really cost?`,
  intro: msg`A friendly price on the front page.\nThe caps show up after you sign.`,
  migrationLine: msg`Import your data and see your own numbers. Pipedrive exports map cleanly onto SeaRM objects.`,
  slug: 'pipedrive',
  ...
  rows: [
    ...
    },
    {
      ...
      searm: { detail: msg`Unlimited workflows` },
    },
    {
      ...
      searm: { detail: msg`Unlimited from Pro` },
    },
    {
      feature: msg`Custom objects`,
...
const DYNAMICS_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`SeaRM vs Microsoft Dynamics`,
  ...
  migrationLine: msg`Import your data and see your own numbers. SeaRM's importer handles Dynamics exports without a consulting project.`,
  ...
  rows: [
    ...
    },
    {
      ...
      searm: { detail: msg`Full customization included` },
    },
    {
      feature: msg`Implementation`,
      description: msg`Getting to a working CRM`,
...
const SAP_COMPARISON: CompetitorComparison = {
  ...
  eyebrow: msg`SeaRM vs SAP Sales Cloud`,
  ...
  rows: [
    ...
    },
    {
      ...
      searm: { detail: msg`Monthly or yearly, cancel anytime` },
    },
    {
      feature: msg`Implementation`,
      description: msg`Getting to a working CRM`,
    ...
    },
    {
      ...
      searm: { detail: msg`REST & GraphQL APIs included` },
    },
    {
      ...
      searm: { detail: msg`Public pricing, this page included` },
    },
  ],
  receipt: {
    scenario: msg`A 20-person sales team, billed annually`,
