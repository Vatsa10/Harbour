...
export const HELPED_CARDS: readonly HelpedCardRecord[] = [
  {
    wordmark: 'W3villa',
    heading: msg`Ship a product on SeaRM`,
    body: msg`W3villa built W3Grads for AI mock interviews at scale, with SeaRM as the operational backbone.`,
    illustration: 'target',
  ...
  },
  {
    ...
    body: msg`AC&T replaced a shuttered vendor CRM with self-hosted SeaRM and cut CRM costs by more than 90%.`,
  ...
  },
  {
    ...
    body: msg`NetZero runs a modular SeaRM setup across carbon credits, ag products, and industrial systems.`,
    illustration: 'money',
