  ...
  return (
    <>
      ...
      <p>
        ...
        contact@searm.com so we can try to find a solution. These Terms apply
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or SeaRM.com
        PBC cancels it. You may cancel your Subscription renewal either through
        your online account management page or by contacting SeaRM.com PBC
        customer support team.
      </p>
      <p>
        A valid payment method, including credit card, is required to process
        the payment for your subscription. You shall provide SeaRM.com PBC with
        ...
        authorize SeaRM.com PBC to charge all Subscription fees incurred
        through your account to any such payment instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, SeaRM.com PBC
      ...
      <h2>Free Trial</h2>
      <p>
        SeaRM.com PBC may, at its sole discretion, offer a Subscription with a
      ...
      <p>
        ...
        you will not be charged by SeaRM.com PBC until Free Trial has expired.
      ...
      <p>
        At any time and without notice, SeaRM.com PBC reserves the right to (i)
      ...
      <h2>Fee changes</h2>
      <p>
        SeaRM.com PBC, in its sole discretion and at any time, may modify
      ...
      <p>
        SeaRM.com PBC will provide you with a reasonable prior notice of any
      ...
      <p>
        SeaRM.com PBC has the right but not the obligation to monitor and edit
      ...
      <p>
        ...
        SeaRM.com PBC and its licensors. Service is protected by copyright,
        ...
        the prior written consent of SeaRM.com PBC.
      </p>

      <h2>Error Reporting and Feedback</h2>
      <p>
        You may provide us either directly at contact@searm.com or via third
      ...
      <p>
        ...
        are not owned or controlled by SeaRM.com PBC.
      </p>
      <p>
        SeaRM.com PBC has no control over, and assumes no responsibility for
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT SEARM.COM PBC SHALL NOT BE RESPONSIBLE
      ...
      <p>
        By email: <a href="mailto:contact@searm.com">contact@searm.com</a>.
      </p>
    </>
  );
}
