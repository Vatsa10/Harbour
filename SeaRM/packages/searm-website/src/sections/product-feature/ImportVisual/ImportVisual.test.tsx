...
describe('ImportVisual', () => {
  it('renders the imported-data and searm-fields columns', () => {
    renderVisual();

    expect(screen.getByText('Imported data')).toBeInTheDocument();
    expect(screen.getByText('SeaRM fields')).toBeInTheDocument();
  });
  ...
  it('maps the imported columns onto SeaRM fields', () => {
    renderVisual();
