...
const PACKAGE_TAG_MAP: Record<string, string[]> = {
  'searm-front': ['scope:frontend'],
  'searm-server': ['scope:backend'],
  'searm-ui': ['scope:shared'],
  'searm-shared': ['scope:shared'],
  'searm-emails': ['scope:backend'],
  'searm-sdk': ['scope:sdk', 'scope:shared'],
  'searm-zapier': ['scope:zapier'],
  'searm-oxlint-rules': ['scope:shared'],
  'searm-docs': ['scope:docs'],
  'searm-e2e-testing': ['scope:testing'],
  'create-searm-app': ['scope:create-app'],
};
