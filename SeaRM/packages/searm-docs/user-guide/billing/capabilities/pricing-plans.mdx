---
title: Pricing Plans
description: Learn about SeaRM's pricing plans and how to switch between them.
---

## Overview

SeaRM offers flexible pricing to fit teams of all sizes, whether you prefer cloud hosting or self-hosting.
...
### Free (Self-Hosted)
Host SeaRM on your own infrastructure at no cost:
