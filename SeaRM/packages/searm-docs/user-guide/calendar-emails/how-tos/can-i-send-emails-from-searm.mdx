---
title: Can I Send Emails from SeaRM?
description: Information about sending emails directly from SeaRM.
---

## Current Status

SeaRM's email integration is designed to **sync and display** your email history as well as compose and send emails.

When you view an email thread on a record page and click **Reply**, you're able to directly compose and send an email.

## How to send a message from SeaRM
...
For email sequences and newsletters, we recommend using workflows to connect SeaRM to a dedicated email marketing tool.
...
Native email composition from within SeaRM is on our roadmap. Join our [GitHub discussions](https://github.com/Vatsa10/Harbour/discussions) to share your use case and help prioritize this feature.
