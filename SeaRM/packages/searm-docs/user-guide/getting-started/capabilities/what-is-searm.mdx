---
title: What is SeaRM
description: SeaRM is an open-source CRM that gives you the building blocks to create exactly what your business needs.
---
...
At first, SeaRM looks like most CRMs you already know: you can track deals, organize contacts, manage tasks and notes.
...
Open-source is the bedrock of our approach, ensuring that SeaRM evolves with its community, for its community.
...
[Register here](https://app.searm.com) or [become a contributor on GitHub](https://github.com/Vatsa10/Harbour).
