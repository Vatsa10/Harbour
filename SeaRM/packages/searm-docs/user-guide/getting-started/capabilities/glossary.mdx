---
title: Glossary
description: Get familiar with essential terminology used in SeaRM.
---

## API
API (Application Programming Interface) allows you to connect SeaRM with other software systems and build custom integrations.
...
## Opportunities
Opportunities in SeaRM CRM are potential deals or sales with accounts or contacts.
...
## Tasks
Tasks in SeaRM CRM are assigned activities relating to contacts, accounts, or opportunities.
...
## Webhooks
Webhooks are automated messages sent from SeaRM to other applications when specific events occur, enabling real-time data synchronization.
...
## Workspace
A `Workspace` typically represents a company using SeaRM. It holds all the records and data that you and your team members add to SeaRM.
It has a single domain name, which is typically the domain name your company uses for employee email addresses.

## Workspace Members
Workspace Members are the SeaRM users from your team who have access to your workspace. They can be assigned as owners or assignees for records.
