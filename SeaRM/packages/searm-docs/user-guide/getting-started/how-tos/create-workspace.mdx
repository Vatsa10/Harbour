...
description: Follow a step-by-step guide on how to register on SeaRM, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [SeaRM Sign Up](https://app.searm.com).
...
## Support
For queries or help, connect with the dedicated support team at [contact@searm.com](mailto:contact@searm.com) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).
