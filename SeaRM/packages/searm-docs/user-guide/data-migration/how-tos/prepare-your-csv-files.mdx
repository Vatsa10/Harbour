...
description: Complete step-by-step guide to format your data for import into SeaRM.
---
...
**This is the most important step.** The sample file shows you the exact column names and format SeaRM expects.
...
SeaRM enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in SeaRM
...
- Must be unique (no duplicates in file or in SeaRM)
...
- Must be unique within your file and in SeaRM
...
### ID Fields
- **Optional**: SeaRM auto-generates IDs if not provided
...
- The parent record must already exist in SeaRM
...
## Step 6: Ensure Fields Exist in SeaRM
