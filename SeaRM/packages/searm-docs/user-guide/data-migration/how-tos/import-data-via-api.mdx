...
description: When and how to use SeaRM's APIs for large-scale data imports.
---

## Overview

SeaRM provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
SeaRM enforces rate limits to ensure system stability:
...
- Verify formats match SeaRM's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in SeaRM
...
Contact us at [contact@searm.com](mailto:contact@searm.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
