...
SeaRM comes with standard objects:
...
Every business works differently. Customizing your data model means you can shape SeaRM around **your** processes instead of forcing yours into a rigid system.

SeaRM offers full flexibility:
...
Identify the main concepts you work with. SeaRM already provides:
...
<Tip>
  Want help designing your data model? [Find a certified SeaRM partner](https://searm.com/partners/list?categories=SOLUTIONING&ref=docs-data-model) to design and build your objects, fields, and relationships.
</Tip>
