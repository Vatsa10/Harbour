...
description: Frequently asked questions about SeaRM's data model.
---
...
You can rename the label of standard objects (People, Companies, Opportunities), but not their API names. The API names are fixed for consistency across all SeaRM workspaces.
</Accordion>
...
The maximum number of fields a single object can have is 1600 fields as per Postgres limits, including both existing and deleted fields. Be aware that SeaRM won't fix your workspace if the limit of 1600 fields is reached as it falls under our Fair Usage policy.
</Accordion>
</AccordionGroup>
