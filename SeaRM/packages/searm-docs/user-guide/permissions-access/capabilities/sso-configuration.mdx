...
Single Sign-On (SSO) allows your team members to log into SeaRM using your organization's identity provider. This provides:
...
- Admin access to your SeaRM workspace
...
- Remove them from the SeaRM workspace
...
- **Group mapping**: Map IdP groups to SeaRM roles (if available)
- **Offboarding process**: Include SeaRM in your deprovisioning workflow
...
<Tip>
Need SSO configured for your organization? [Find a certified SeaRM partner](https://searm.com/partners/list?categories=SOLUTIONING&ref=docs-sso) who specializes in SSO and identity setup. *(Prefer to loop in SeaRM directly? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
