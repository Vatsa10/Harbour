---
title: AI
description: AI-powered features in SeaRM.
---
...
Currently, SeaRM offers:

### 1. AI Chatbot

A conversational assistant that understands your context and has access to all your SeaRM data.

**Key capabilities:**
- **Full data access**: Query any record, relationship, or metric in your workspace
- **Page context awareness**: Reference "this company" or "this opportunity" based on where you are in SeaRM
...
- Follow our [GitHub](https://github.com/Vatsa10/Harbour) for development updates
