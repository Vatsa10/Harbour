---
title: AI FAQ
description: Frequently asked questions about AI features in SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="What AI capabilities are available?">
    ...
    1. **AI Chatbot**: A context-aware assistant that can access your SeaRM data and help you with queries
  ...
  <Accordion title="Can I use my own AI models?">
    On cloud, you can use only AI models provided by SeaRM. On your self-hosted instance, you can use your own AI models after obtaining an Organization license.
  </Accordion>
