...
### Documentation Files
- **69 MDX files** copied from searm-website to searm-docs
...
3. Set subdirectory to `packages/searm-docs`
4. Mintlify will auto-deploy and generate search embeddings

## Status

This migration has been completed. The legacy `packages/searm-website` package
has been removed, and documentation now lives in `packages/searm-docs`.
