...
- Predicates can reference objects and fields owned by your app or by SeaRM's standard objects.
...
- See a working example: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
