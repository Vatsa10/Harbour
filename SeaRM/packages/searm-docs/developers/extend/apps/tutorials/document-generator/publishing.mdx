...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/developers/extend/apps',
...
Also add the `searm-app` keyword to `package.json` so the app is discoverable:
...
tarball to a SeaRM server's private registry instead. To surface a published app
