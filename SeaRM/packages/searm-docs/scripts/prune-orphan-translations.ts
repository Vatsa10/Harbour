...
// Removes orphan localized docs: files under packages/searm-docs/l/<lang>/**
...
//
// Usage:
//   tsx packages/searm-docs/scripts/prune-orphan-translations.ts
//   tsx packages/searm-docs/scripts/prune-orphan-translations.ts --apply
...
const main = (): void => {
  if (!fs.existsSync(LOCALIZED_DIR)) {
    console.log('No localized docs directory (packages/searm-docs/l) — nothing to prune.');
    return;
  }
