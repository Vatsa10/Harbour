...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/ko/developers/extend/apps',
...
앱을 쉽게 찾을 수 있도록 `package.json`에 `searm-app` 키워드도 추가하세요:
...
`app:publish`는 기본적으로 빌드하고 npm에 게시합니다. `--private`는 대신 SeaRM 서버의 프라이빗 레지스트리에 tarball을 업로드합니다. 배포된 앱을 인스턴스의 마켓플레이스에 표시하려면 카탈로그 동기화를 트리거하세요:
...
완성된 앱은
[`packages/searm-apps/examples/document-generator`](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/examples/document-generator)에 있습니다.
