---
title: Generar una cotización o una factura desde SeaRM
...
* [Generar un PDF desde SeaRM](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — adjuntar los PDF generados a los registros
