...
* Para solicitudes POST, define la estructura del cuerpo esperada para que SeaRM sepa qué datos esperar. Añade aquí los campos que recibirás y que se necesitarán más abajo en tu flujo de trabajo.
