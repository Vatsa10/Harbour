...
Las relaciones de muchos a muchos usan un patrón de **objeto de unión**: un objeto intermedio que conecta ambos lados. Con la función de relaciones de unión, SeaRM muestra directamente los registros finales vinculados, ocultando el objeto intermedio de la UI.
...
SeaRM incluye relaciones predefinidas entre objetos estándar:
