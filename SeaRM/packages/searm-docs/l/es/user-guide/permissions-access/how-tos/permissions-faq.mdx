...
<AccordionGroup>
<Accordion title="¿Qué roles incluye SeaRM por defecto?">
...
Puedes controlar:
* **Send Email**: Capacidad para enviar correos desde SeaRM
...
Con el aprovisionamiento JIT, las cuentas de usuario se crean automáticamente en SeaRM cuando alguien inicia sesión mediante SSO por primera vez. Se les asigna automáticamente el rol predeterminado.
</Accordion>
