...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en SeaRM.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que SeaRM espera.
...
SeaRM exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en SeaRM
...
* Debe ser único (sin duplicados en el archivo ni en SeaRM)
...
* Debe ser único dentro de tu archivo y en SeaRM
...
* **Enlaces / Etiqueta del enlace**: `SeaRM`
* **Enlaces / URL del enlace**: `https://searm.com`
...
* **Opcional**: SeaRM genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en SeaRM
...
## Paso 6: Asegúrate de que los campos existan en SeaRM
