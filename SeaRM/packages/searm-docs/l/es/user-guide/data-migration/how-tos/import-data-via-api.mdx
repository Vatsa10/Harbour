...
description: Cuándo y cómo usar las API de SeaRM para importaciones de datos a gran escala.
---

## Resumen

SeaRM ofrece tanto **GraphQL** como **API REST** para la importación programática de datos. Utiliza la API cuando la importación mediante CSV no sea práctica para tu volumen de datos o cuando necesites importaciones automatizadas y recurrentes.
...
SeaRM aplica límites de tasa para garantizar la estabilidad del sistema:
...
SeaRM admite dos tipos de API:

| API         | Ideal para                                                                  | Documentación                                     |
| ----------- | --------------------------------------------------------------------------- | ------------------------------------------------- |
| **GraphQL** | Consultas flexibles, obtención de datos relacionados, operaciones complejas | [Documentación de la API](/l/es/developers/extend/api) |
| **REST**    | Operaciones CRUD simples, patrones REST familiares                          | [Documentación de la API](/l/es/developers/extend/api) |
...
* Verifica que los formatos cumplan los requisitos de SeaRM (consulta [Asignación de campos](/l/es/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica que los datos aparezcan correctamente en SeaRM
...
Contáctanos en [contact@searm.com](mailto:contact@searm.com) o explora nuestros [Servicios de implementación](/l/es/user-guide/getting-started/capabilities/implementation-services).
...
* [Documentación de la API](/l/es/developers/extend/api)
