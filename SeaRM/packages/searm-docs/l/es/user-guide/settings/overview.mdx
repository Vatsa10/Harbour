---
title: Configuración
description: Configura tu espacio de trabajo de SeaRM con ajustes esenciales.
---
...
<Note>
Antes de invitar a tu equipo, verifica el rol predeterminado en **Ajustes → Miembros → Roles**. A los nuevos miembros se les asigna automáticamente este rol al unirse.
</Note>
