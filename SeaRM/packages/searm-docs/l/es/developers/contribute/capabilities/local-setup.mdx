...
icon: laptop-code
description: La guía para los colaboradores (o desarrolladores curiosos) que quieren ejecutar SeaRM localmente.
---
...
Antes de que puedas instalar y usar SeaRM, asegúrate de instalar lo siguiente en tu computadora:
...
SeaRM requiere un caché de Redis para proporcionar el mejor rendimiento.
...
El frontend de SeaRM estará ejecutándose en [http://localhost:3001](http://localhost:3001).
Puede iniciar sesión usando la cuenta demo por defecto: `tim@apple.dev` (contraseña: `tim@apple.dev`)

**Backend**

* El servidor de SeaRM estará operativo en [http://localhost:3000](http://localhost:3000)
