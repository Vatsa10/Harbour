...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/es/developers/extend/apps',
...
También añade la palabra clave `searm-app` a `package.json` para que la aplicación sea detectable:
