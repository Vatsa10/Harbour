...
en el interior de SeaRM. Nuestra nuestra lee el registro seleccionado, carga las plantillas
...
`searm-ui`. El SDK simula ese paquete durante la compilación, por lo que las importaciones a nivel de módulo de
constantes de tema serían `undefined`. Ver el
[componente completo](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/front-components/generate-document-form.front-component.tsx).
</Warning>
...
inline mediante un pequeño helper [`Markdown`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/markdown-to-react.tsx).
...
vea el
completo [`template-record. age-layout.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/page-layouts/template-record.page-layout.ts).
