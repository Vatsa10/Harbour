...
* `objectUniversalIdentifier` especifica a qué objeto se aplica esta vista. Puede ser un objeto personalizado que hayas definido o un objeto estándar de SeaRM.
...
Todos los enums anteriores se exportan desde `searm-sdk/define`.
