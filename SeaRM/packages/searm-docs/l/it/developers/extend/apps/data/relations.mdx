...
Le relazioni collegano due oggetti tra loro. In SeaRM, le relazioni sono sempre **bidirezionali** — ogni relazione ha due lati e ciascun lato è dichiarato come un campo che fa riferimento all'altro.
...
Per creare una relazione con un oggetto SeaRM integrato (Person, Company, ecc.), usa `STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS`:
