...
* I predicati possono fare riferimento a oggetti e campi di proprietà della tua app o degli oggetti standard di SeaRM.
...
* Vedi un esempio di lavoro: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
