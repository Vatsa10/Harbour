...
e self-hosted, tale percorso è gestito dal tuo server SeaRM
(ad es. `http://localhost:2020/s/documents/generate`). Su SeaRM Cloud, `RestApiClient`
...
[Vedi l'helper](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/render-document.ts).
