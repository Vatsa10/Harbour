...
description: Crea una vera app SeaRM che genera documenti personalizzati a partire dai dati del tuo CRM.
---
...
un server SeaRM locale in esecuzione sulla porta `2020` e la CLI autenticata ad esso.
...
Lascia `yarn searm dev` in esecuzione in un terminale per l’intero tutorial. Ogni volta che
