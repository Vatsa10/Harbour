...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a SeaRM utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore al tuo spazio di lavoro SeaRM
...
* Rimuovili dallo spazio di lavoro SeaRM
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di SeaRM (se disponibile)
* **Processo di offboarding**: Includi SeaRM nel tuo flusso di lavoro di deprovisioning
...
<Tip>
Hai bisogno di configurare l’SSO per la tua organizzazione? [Trova un partner SeaRM certificato](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializzato in SSO e configurazione dell’identità. *(Preferisci coinvolgere direttamente SeaRM? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
