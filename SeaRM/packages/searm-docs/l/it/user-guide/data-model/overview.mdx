...
SeaRM include oggetti standard:
...
Ogni azienda lavora in modo diverso. Personalizzare il tuo modello di dati significa poter modellare SeaRM attorno ai **tuoi** processi invece di forzarli dentro un sistema rigido.

SeaRM offre massima flessibilità:
...
Identifica i concetti principali con cui lavori. SeaRM offre già:
...
<Tip>
  Vuoi aiuto a progettare il tuo modello di dati? [Trova un partner di 20 certificati](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) per progettare e costruire i tuoi oggetti, campi e relazioni.
</Tip>
