---
title: Oggetti
description: Scopri gli oggetti standard e personalizzati in SeaRM.
---
...
Gli oggetti standard sono entità predefinite nel tuo spazio di lavoro per aiutarti a iniziare. Fanno parte di un modello di dati condiviso accessibile a tutti gli utenti di SeaRM. Puoi usarli così come sono, personalizzarli o disattivarli.
...
2. Trova l'oggetto che vuoi disattivare e fai clic su di esso
3. Vai alla scheda **Impostazioni** dell'oggetto
4. Clicca sul pulsante `Deactivate`
5. L'oggetto sarà nascosto dal tuo spazio di lavoro, ma i dati verranno conservati
...
1. Vai a Impostazioni → Modello dati
2. Abilita il filtro `Disattivato`
3. Cerca oggetti disattivati (hanno `Deactivated` accanto al loro nome)
4. Fai clic su `⋮` e quindi su `Attiva` per riattivarlo
5. L'oggetto e tutti i suoi dati verranno ripristinati
