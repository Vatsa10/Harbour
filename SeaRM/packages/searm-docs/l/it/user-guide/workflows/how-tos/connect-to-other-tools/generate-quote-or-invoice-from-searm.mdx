---
title: Genera un preventivo o una fattura da SeaRM
...
* [Generare un PDF da SeaRM](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — allegare i PDF generati ai record
