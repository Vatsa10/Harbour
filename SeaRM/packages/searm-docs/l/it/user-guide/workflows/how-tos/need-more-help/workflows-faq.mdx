...
description: Domande frequenti sui flussi di lavoro in SeaRM.
---
...
<AccordionGroup>
  ...
  <Accordion title="Perché non vedo le esecuzioni dei miei flussi di lavoro?">
    Le esecuzioni dei flussi di lavoro potrebbero non riuscire immediatamente a causa dei limiti di frequenza. SeaRM impone un limite rigido di 5.000 esecuzioni all'ora per spazio di lavoro.
  ...
  <Accordion title="Quali sono i limiti di frequenza dei flussi di lavoro?">
    SeaRM ha due limiti di frequenza per garantire la stabilità del sistema:
