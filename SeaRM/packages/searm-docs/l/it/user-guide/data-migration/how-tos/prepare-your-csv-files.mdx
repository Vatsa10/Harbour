...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in SeaRM.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che SeaRM si aspetta.
...
SeaRM impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in SeaRM
...
* Deve essere univoco (nessun duplicato nel file o in SeaRM)
...
* Deve essere univoco all'interno del tuo file e in SeaRM
...
* **Link / Etichetta del link**: `SeaRM`
* **Link / URL del link**: `https://searm.com`
...
* **Opzionale**: SeaRM genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in SeaRM
...
## Passaggio 6: Verifica che i campi esistano in SeaRM
