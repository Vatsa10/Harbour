---
title: IA
description: Funcionalidades com IA no SeaRM.
---
...
Atualmente, o SeaRM oferece:

### 1. Chatbot de IA

Um assistente conversacional que entende seu contexto e tem acesso a todos os seus dados do SeaRM.

**Principais capacidades:**

* **Acesso completo aos dados**: Consulte qualquer registro, relacionamento ou métrica no seu espaço de trabalho
* **Consciência do contexto da página**: Faça referência a "esta empresa" ou "esta oportunidade" com base em onde você está no SeaRM
...
* Siga nosso [GitHub](https://github.com/Vatsa10/Harbour) para atualizações de desenvolvimento
