...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no SeaRM usando o provedor de identidade da sua organização. Isso oferece:
...
O SeaRM oferece suporte a SSO com:
...
* Remova-os do workspace do SeaRM
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do SeaRM (se disponível)
* **Processo de desligamento**: Inclua o SeaRM no seu fluxo de trabalho de desprovisionamento
...
<Tip>
Precisa de SSO configurado para a sua organização? [Encontre um parceiro SeaRM certificado](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) que seja especialista em SSO e configuração de identidade. *(Prefere envolver a SeaRM diretamente? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
