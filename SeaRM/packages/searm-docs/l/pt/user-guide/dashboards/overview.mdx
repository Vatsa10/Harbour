---
title: Painéis
description: Aprenda o básico sobre relatórios e painéis no SeaRM.
---

## Entendendo os painéis

Os painéis no SeaRM oferecem uma forma visual de acompanhar suas principais métricas de desempenho e obter insights dos seus dados de CRM.
...
<Note>
**Limitações atuais**:
* A exportação de painéis e o compartilhamento com usuários externos (usuários não-SeaRM) não estão disponíveis no momento.
