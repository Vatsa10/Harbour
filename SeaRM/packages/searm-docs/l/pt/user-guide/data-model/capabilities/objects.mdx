---
title: Objetos
description: Saiba mais sobre objetos padrão e personalizados no SeaRM.
---
...
Objetos padrão são entidades predefinidas no seu espaço de trabalho para ajudar você a começar. Eles fazem parte de um modelo de dados compartilhado acessível a todos os usuários do SeaRM. Você pode usá-los como estão, personalizá-los ou desativá-los.
