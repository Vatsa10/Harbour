...
As relações muitos-para-muitos utilizam um padrão de **objeto de junção**: um objeto intermediário que conecta ambos os lados. Com o recurso de relação de junção, SeaRM exibe diretamente os registros finais vinculados, ocultando o objeto intermediário da IU.
...
O SeaRM inclui relações pré-criadas entre objetos padrão:
