...
description: Guia completo passo a passo para formatar seus dados para importação no SeaRM.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o SeaRM espera.
...
O SeaRM impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no SeaRM
...
* Deve ser exclusivo (sem duplicados no arquivo ou no SeaRM)
...
* Deve ser exclusivo dentro do seu arquivo e no SeaRM
...
* **Links / Rótulo do Link**: `SeaRM`
* **Links / URL do Link**: `https://searm.com`
...
* **Opcional**: a SeaRM gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na SeaRM
...
## Etapa 6: Garanta que os campos existam na SeaRM
