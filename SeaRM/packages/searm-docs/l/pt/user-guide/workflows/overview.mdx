...
description: Aprenda a criar automações no SeaRM.
---

## Por que Workflows Importam

SeaRM foi criado para trazer flexibilidade máxima aos seus usuários. Em vez de forçá-lo a adaptar seus processos de negócios a recursos rígidos e pré-construídos, os workflows permitem que você crie automações que criem o CRM que melhor apoie seus casos de uso de negócios exclusivos.

Workflows são o recurso interno de SeaRM para criar essas automações. Eles oferecem os blocos de construção para criar exatamente o que seu negócio precisa, quando precisa.
...
2. **Traga dados para dentro e para fora do SeaRM**: Conecte-se ao SeaRM por meio de chamadas de API e webhooks para seu banco de dados e outras ferramentas.
...
* **Formulário**: Obter entradas de usuários na interface do SeaRM no momento da execução
...
<Tip>
  Quer ajuda para automatizar seus fluxos de trabalho? [Encontre um Vinte Parceiro certificado](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-workflows) para projetar e construir suas automações de ponta a ponta.
</Tip>
