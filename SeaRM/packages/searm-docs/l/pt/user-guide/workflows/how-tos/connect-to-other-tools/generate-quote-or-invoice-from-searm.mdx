---
title: Gerar um orçamento ou fatura no SeaRM
...
* [Gerar um PDF a partir do SeaRM](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — anexar PDFs gerados aos registros
