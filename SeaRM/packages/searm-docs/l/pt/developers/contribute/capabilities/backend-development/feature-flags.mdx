...
As flags de recurso são usadas para ocultar recursos experimentais. Para a SeaRM, eles são definidos no nível do espaço de trabalho e não no nível do usuário.
