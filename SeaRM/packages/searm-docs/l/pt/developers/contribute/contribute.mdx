---
title: Contribuir
description: Contribua para o desenvolvimento de código aberto do SeaRM.
---
...
O SeaRM é de código aberto e recebe contribuições da comunidade. Seja corrigindo bugs, adicionando funcionalidades ou aprimorando a documentação, suas contribuições ajudam a tornar o SeaRM melhor para todos.
