...
Os aplicativos SeaRM são escritos em **inglês**: as strings no seu código-fonte e no manifesto
...
`searm dev:build` compila os catálogos e fornece o idioma correto para o
