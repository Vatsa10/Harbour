...
description: Steuern Sie, welche E-Mails in SeaRM importiert werden.
---

## Übersicht

Standardmäßig synchronisiert SeaRM alle externen E-Mails aus Ihrem verbundenen Postfach. Sie können den Import mithilfe der **Ordnerauswahl** und der **Sichtbarkeitseinstellungen** begrenzen.
...
Nachrichten zwischen Kolleginnen und Kollegen (gleiche Domain) können in SeaRM synchronisiert werden:
