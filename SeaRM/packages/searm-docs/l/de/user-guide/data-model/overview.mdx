...
Jedes Unternehmen arbeitet anders. Die Anpassung Ihres Datenmodells bedeutet, dass Sie SeaRM um **Ihre** Prozesse herum gestalten können, anstatt Ihre in ein starres System zu zwängen.

SeaRM bietet volle Flexibilität:
...
Identifizieren Sie die wichtigsten Konzepte, mit denen Sie arbeiten. SeaRM bietet bereits:
...
<Tip>
  Möchten Sie Hilfe bei der Gestaltung Ihres Datenmodells? [Finde einen zertifizierten Zwanzig Partner](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) um Objekte, Felder und Beziehungen zu entwerfen und zu bauen.
</Tip>
