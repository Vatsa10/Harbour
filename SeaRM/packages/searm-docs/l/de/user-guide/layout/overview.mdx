---
title: Layout
description: Passen Sie die Navigation, das Durchsuchen und die Anzeige von Datensätzen in SeaRM an.
---

Das Layout von SeaRM ist auf drei Ebenen anpassbar: wie Sie in der App navigieren, wie Sie Listen von Datensätzen durchsuchen und was Sie sehen, wenn Sie einen einzelnen Datensatz öffnen.
...
Ansichten steuern, wie Listen von Datensätzen angezeigt werden. SeaRM unterstützt drei Ansichtstypen:
