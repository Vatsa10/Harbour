...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten SeaRM-Instanz zu SeaRM Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten SeaRM-Instanz zu SeaRM Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.searm.com](https://app.searm.com) und erstellen Sie einen neuen Arbeitsbereich
...
<Tip>
  Migrieren Sie einen großen oder komplexen Workspace? [Holen Sie sich einen zertifizierten SeaRM-Partner](https://searm.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), der den Umzug Ende-zu-Ende übernimmt. *(Oder binden Sie unser Team ein: [contact@searm.com](mailto:contact@searm.com).)*
</Tip>
