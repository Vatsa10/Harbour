...
Nachdem Sie Ihre Datei hochgeladen und die Spalten zugeordnet haben, validiert SeaRM Ihre Daten:

1. **Validierung läuft** — SeaRM prüft jede Zeile auf Fehler
...
| ------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| Doppelte Werte, gelb hervorgehoben                                             | Wert existiert bereits in SeaRM oder kommt in Ihrer Datei doppelt vor |
...
**Option 3: SeaRM den vorhandenen Datensatz aktualisieren lassen**
...
3. SeaRM aktualisiert den vorhandenen Datensatz, statt ein Duplikat zu erstellen
...
Solange ein eindeutiger Bezeichner übereinstimmt, aktualisiert SeaRM den Datensatz.
</Note>
...
3. Prüfen Sie, ob Datensätze bereits in SeaRM existieren
...
Das bedeutet, dass es in SeaRM kein Unternehmen mit diesem spezifischen Bezeichner gibt.
...
Sie versuchen, auf einen Datensatz zu verweisen, der in SeaRM nicht existiert.
...
Eine Spalte in Ihrer Datei kann nicht zugeordnet werden, weil das Feld in SeaRM nicht existiert.
...
1. **Benutzer hat seine Einladung nicht angenommen** — der Benutzer existiert noch nicht in SeaRM
2. **Benutzer-ID aus altem System verwendet** — SeaRM kann IDs aus einem anderen System nicht zuordnen
3. **Falsches E-Mail-Format** — die E-Mail entspricht nicht dem SeaRM-Konto des Benutzers

### So beheben Sie den Fehler

1. Stellen Sie sicher, dass alle Benutzer **ihre Einladung** zu Ihrem SeaRM-Arbeitsbereich **angenommen haben**
2. Verwenden Sie die **E-Mail-Adresse** des Benutzers (nicht seinen Namen oder die alte System-ID)
3. Verwenden Sie dieselbe E-Mail, mit der sie SeaRM beigetreten sind
...
<Check>Domain-Format entspricht exakt dem Format von SeaRM</Check>
...
1. **Beispieldatei herunterladen** — sehen Sie das genaue Format, das SeaRM erwartet
