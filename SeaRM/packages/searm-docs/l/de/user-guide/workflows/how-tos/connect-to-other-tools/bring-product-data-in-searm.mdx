---
title: Produktdaten in SeaRM importieren
description: Synchronisieren Sie Produktkatalogdaten nach Zeitplan aus einem Data Warehouse in Ihr CRM.
---

Verwenden Sie dieses Muster, um SeaRM mit Produktdaten aus Ihrem Data Warehouse (z. B. Snowflake, BigQuery, PostgreSQL) synchron zu halten.
...
5. **Upsert Record**: In SeaRM erstellen oder aktualisieren
