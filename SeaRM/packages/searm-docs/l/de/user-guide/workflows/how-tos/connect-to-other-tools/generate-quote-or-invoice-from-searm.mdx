---
title: Ein Angebot oder eine Rechnung aus SeaRM erstellen.
...
* [Ein PDF aus SeaRM generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-searm) — generierte PDFs an Datensätze anhängen
