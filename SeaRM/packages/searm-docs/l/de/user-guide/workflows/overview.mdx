...
2. **Daten in und aus SeaRM bringen**: Verbinden Sie SeaRM über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der SeaRM-Oberfläche zum Zeitpunkt der Ausführung abfragen
...
<Tip>
  Möchten Sie Hilfe bei der Automatisierung Ihrer Workflows? [Finde einen zertifizierten Zwanzig Partner](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-workflows) zum Entwerfen und Bauen deiner Automatisierungen Ende-zu-Ende-zu-Ende.
</Tip>
