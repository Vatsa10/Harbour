...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/de/developers/extend/apps',
...
Füge auch das Schlüsselwort "searm-app" zu "package.json" hinzu, damit die App entdeckt werden kann:
