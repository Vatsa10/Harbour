...
description: Erstellen Sie eine echte SeaRM-App, die personalisierte Dokumente aus Ihren CRM-Daten generiert.
---
...
einen lokalen SeaRM-Server, der auf Port `2020` läuft, und die CLI, die damit authentifiziert ist.
...
Lassen Sie `yarn searm dev` während des gesamten Tutorials in einem Terminal laufen. Jedes Mal, wenn
