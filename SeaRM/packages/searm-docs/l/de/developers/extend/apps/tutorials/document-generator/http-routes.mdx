...
und selbstgehosteten Instanzen wird dieser Pfad von Ihrem SeaRM-Server
bereitgestellt (z. B. `http://localhost:2020/s/documents/generate`). In SeaRM Cloud löst `RestApiClient` den Pfad über die Funktionen-Domain des Workspaces auf.
...
[Siehe den Helfer](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/render-document.ts).
