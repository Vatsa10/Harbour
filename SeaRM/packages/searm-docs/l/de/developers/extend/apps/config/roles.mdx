...
* Prädikate können auf Objekte und Felder verweisen, die Ihrer App gehören, oder auf Standardobjekte von SeaRM.
...
* Ein funktionierendes Beispiel finden Sie unter: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
