...
Nesneler, bir kuruluşa özgü verileri (kayıtlar, nitelikler ve değerler) saklamanıza olanak tanır. SeaRM, hem standart hem de özel nesneler sağlar.

Standart nesneler, tüm kullanıcılar için kullanılabilir bir dizi niteliğe sahip yerleşik nesnelerdir. SeaRM'deki standart nesne örnekleri arasında Şirket ve Kişi yer alır. Standart nesneler, tüm SeaRM kullanıcıları için de mevcut olan standart alanlara sahiptir, örneğin Şirket.görünenAd.
