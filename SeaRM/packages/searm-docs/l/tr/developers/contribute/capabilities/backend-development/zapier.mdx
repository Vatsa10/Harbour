...
Zapier'i kullanarak SeaRM'yi 3000+ uygulama ile zahmetsizce senkronize edin. Görevleri otomatikleştirin, verimliliği artırın ve müşteri ilişkilerinizi güçlendirin!
...
`packages/searm-zapier` klasöründen şunu çalıştırın:
