...
description: SeaRM'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
SeaRM açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız SeaRM'yi herkes için daha iyi hâle getirmeye yardımcı olur.
