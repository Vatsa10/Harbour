...
[`load-record-values.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/utils/load-record-values.ts).
...
Girdi şeması, `templateId` ve `recordId` değerlerini tanımlayan basit bir JSON şemasıdır — bkz. [`generate-document-input.schema.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/schemas/generate-document-input.schema.ts).
...
Tam yardımcı işlev şuradadır: [`generate-document-pdf.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/utils/generate-document-pdf.ts).
