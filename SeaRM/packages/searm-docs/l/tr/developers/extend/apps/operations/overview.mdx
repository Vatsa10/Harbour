...
**Operasyon katmanı**, uygulamayı *kullanarak* yaptıklarınızdan ziyade, uygulamanız *üzerinde* yaptığınız her şeyi kapsar: CLI komutlarını çağırmak, gerçek bir SeaRM sunucusunda entegrasyon testleri çalıştırmak, CI'yi yapılandırmak ve sürümleri yayımlamak — tek bir sunucuya dağıtılan bir tarball olarak ya da pazaryerinde listelenen bir npm paketi olarak.
...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/l/tr/developers/extend/apps/operations/cli">
    `yarn searm` referansı — exec, logs, uninstall, remotes.
  </Card>
