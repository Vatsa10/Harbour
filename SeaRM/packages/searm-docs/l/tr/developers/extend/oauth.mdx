...
| UI uzantılarına sahip SeaRM Uygulaması             | [Uygulamalar](/l/tr/developers/extend/apps/getting-started/quick-start) (OAuth otomatik olarak yönetilir) |

## Bir İstemci Kaydedin

SeaRM, [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) uyarınca **dinamik istemci kaydını** destekler. Manuel kurulum gerekmez — programatik olarak kaydedin:
...
Uygulamanız bir SeaRM kullanıcısı adına hareket ettiğinde bu akışı kullanın.
...
Yetkilendirmeden sonra, SeaRM `redirect_uri` adresinize geri yönlendirir:
...
SeaRM, OAuth yapılandırmasını standart bir keşif uç noktasında yayımlar:
