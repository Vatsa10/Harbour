---
title: Posta Kutusu
description: SeaRM'deki e-posta entegrasyonu özelliklerini anlama.
---
...
SeaRM, bağlı posta kutularınızdaki e-postaları ilgili CRM kayıtlarına otomatik olarak bağlar, tüm iletişim geçmişini tek bir yerde tutar.
...
SeaRM e-postaları yaklaşık olarak dakikada **400 ileti** hızında içe aktarır. Bu hız şu anda Gmail API hız sınırlaması tarafından kısıtlanmaktadır (ve benzer şekilde diğer sağlayıcılar için de geçerlidir).
...
SeaRM içinde dahili e-postaların senkronize edilip edilmeyeceğini seçin:
...
* **Eksik Mailler**: Şu durumları kontrol edin:
  ...
  * Otomatik kişi oluşturma devre dışı (e-postaların zaten var olan SeaRM kayıtlarına ihtiyacı var)
