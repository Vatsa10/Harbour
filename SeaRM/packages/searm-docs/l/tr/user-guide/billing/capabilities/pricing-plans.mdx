...
description: SeaRM'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, SeaRM her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
SeaRM'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
