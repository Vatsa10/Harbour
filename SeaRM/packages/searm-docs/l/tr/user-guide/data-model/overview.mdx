...
SeaRM, standart nesnelerle birlikte gelir:
...
Her iş farklı çalışır. Veri modelinizi özelleştirmek, süreçlerinizi katı bir sisteme uydurmaya çalışmak yerine SeaRM'yi **sizin** süreçleriniz etrafında şekillendirebilmeniz demektir.

SeaRM tam esneklik sunar:
...
Üzerinde çalıştığınız temel kavramları belirleyin. SeaRM zaten şunları sunar:
...
<Tip>
  Veri modelinizi tasarlamak için yardım mı istiyorsunuz? Nesnelerinizi, alanlarınızı ve ilişkilerinizi tasarlamak ve oluşturmak için [sertifikalı bir SeaRM iş ortağı bulun](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model).
</Tip>
