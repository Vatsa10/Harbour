...
Dosyanızı yükledikten ve sütunları eşledikten sonra, SeaRM verilerinizi doğrular:

1. **Doğrulama çalışır** — SeaRM her satırı hatalar için kontrol eder
...
| ------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| Yinelenen değerler sarı renkle vurgulanır                                      | Değer SeaRM'de zaten mevcut veya dosyanızda iki kez görünüyor |
...
**Seçenek 3: Mevcut kaydı SeaRM'nin güncellemesine izin verin**
...
3. SeaRM, yinelenen bir kayıt oluşturmak yerine mevcut kaydı güncelleyecektir
...
Benzersiz tanımlayıcılardan biri eşleştiği sürece SeaRM kaydı günceller.
</Note>
...
3. Kayıtların SeaRM'de zaten mevcut olup olmadığını kontrol edin
...
Bu, SeaRM'de o özel tanımlayıcıya sahip bir Şirket olmadığı anlamına gelir.
...
SeaRM'de mevcut olmayan bir kayda bağlanmaya çalışıyorsunuz.
...
Dosyanızdaki bir sütun eşlenemiyor çünkü alan SeaRM'de mevcut değil.
...
1. **Kullanıcı davetini kabul etmedi** — kullanıcı henüz SeaRM'de mevcut değil
2. **Eski sistemdeki kullanıcı kimliğini kullanma** — SeaRM başka bir sistemin kimliklerini eşleştiremez
3. **Yanlış e-posta biçimi** — e-posta, kullanıcının SeaRM hesabıyla eşleşmiyor

### Nasıl Düzeltilir

1. Tüm kullanıcıların SeaRM çalışma alanınıza **davetlerini kabul ettiğinden** emin olun
2. Kullanıcının **e-posta adresini** kullanın (adlarını veya eski sistem kimliğini değil)
3. SeaRM'ye katılmak için kullandıkları aynı e-postayı kullanın
...
<Check>Alan adı biçimi, SeaRM'nin biçimiyle birebir eşleşir</Check>
...
1. **Örnek dosyayı indirin** — SeaRM'nin beklediği tam biçimi görün
