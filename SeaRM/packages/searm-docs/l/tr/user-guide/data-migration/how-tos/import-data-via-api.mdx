...
description: Büyük ölçekli veri içe aktarmaları için SeaRM'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

SeaRM, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
SeaRM, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
SeaRM iki API türünü destekler:
...
* Biçimlerin SeaRM'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin SeaRM'de doğru göründüğünü doğrulayın
...
[contact@searm.com](mailto:contact@searm.com) adresinden bizimle iletişime geçin veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) keşfedin.
