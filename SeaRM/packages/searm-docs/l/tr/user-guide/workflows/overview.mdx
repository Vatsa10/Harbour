---
title: İş Akışları
description: SeaRM'de otomasyonlar oluşturmayı öğrenin.
---

## İş Akışları Neden Önemlidir?

SeaRM, kullanıcılarına maksimum esneklik sağlamak için tasarlandı. İş süreçlerinizi katı, önceden oluşturulmuş özelliklere uyarlamak yerine, iş akışları, benzersiz iş kullanım durumlarınızı en iyi destekleyen CRM'yi oluşturmanıza olanak tanır.

İş akışları, bu otomasyonları oluşturmak için SeaRM'nin uygulama içi özelliğidir. Bunlar, işletmenizin gerektiğinde tam olarak ihtiyaç duyduğu şeyi oluşturmanız için size yapı taşları sunarlar.
...
2. **Verileri içeri ve dışarı getirin**: SeaRM'yi API çağrıları ve webhooks aracılığıyla veritabanınıza ve diğer araçlara bağlayın.
...
* **Form**: Yürütme sırasında SeaRM UI içinde kullanıcı girdilerini alın
...
<Tip>
  İş akışlarınızı otomatikleştirme konusunda yardım mı istiyorsunuz? Otomasyonlarınızı uçtan uca tasarlayıp oluşturmak için [sertifikalı bir SeaRM iş ortağı bulun](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-workflows).
</Tip>
