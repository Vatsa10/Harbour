...
<AccordionGroup>
<Accordion title="SeaRM varsayılan olarak hangi rolleri sunar?">
SeaRM varsayılan olarak **Admin** ve **Member** rollerini içerir. Ekibinizin ihtiyaçlarına göre (ör. Satış Temsilcisi, Yönetici, Salt Okunur Kullanıcı) ek özel roller oluşturabilirsiniz.
</Accordion>
...
* **Send Email**: SeaRM üzerinden e-posta gönderme yeteneği
...
JIT sağlama ile, birisi ilk kez SSO üzerinden oturum açtığında kullanıcı hesapları SeaRM içinde otomatik olarak oluşturulur. Varsayılan rol onlara otomatik olarak atanır.
</Accordion>
