...
<AccordionGroup>
<Accordion title="SeaRM にはデフォルトでどのようなロールがありますか？">
...
JIT プロビジョニングでは、ユーザーが初めて SSO でログインした際に、SeaRM にユーザーアカウントが自動作成されます。 デフォルトのロールが自動的に割り当てられます。
</Accordion>
