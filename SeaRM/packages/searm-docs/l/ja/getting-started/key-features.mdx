---
title: 主な機能
description: SeaRM が実現できるすべてのことを紹介します — カスタムデータモデルから AI を活用した自動化まで。
icon: star
---

import { CardTitle } from "/snippets/card-title.mdx"

SeaRM は、フル機能を備えた CRM プラットフォームです。 それを使って、次のようなものを構築できます。
...
<CardGroup cols={2}>
  ...
  <Card href="/l/ja/developers/self-host/self-host" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    単一の Docker Compose コマンドで、独自のインフラ上に SeaRM を実行できます。
