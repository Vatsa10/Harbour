...
結果を平坦化します。
[`load-record-values.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/utils/load-record-values.ts)を参照してください。
...
は [`generate-document-input.schema.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/schemas/generate-document-input.schema.ts) を参照してください。
...
フルヘルパーは
[`generate-document-pdf.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/utils/generate-document-pdf.ts)。
...
[call-recorder app](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/public/call-recorder)
が使用するパターンと同じです。
</Note>
