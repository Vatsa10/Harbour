...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/ja/developers/extend/apps',
...
tarball を SeaRM サーバーのプライベートレジストリにアップロードします。 公開されたアプリ
...
完成したアプリは
[`packages/20apps/examples/document-generator`](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/examples/document-generator)にあります。
