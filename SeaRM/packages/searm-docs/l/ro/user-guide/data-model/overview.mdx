...
SeaRM include obiecte standard:
...
Fiecare afacere funcționează diferit. Personalizarea modelului tău de date înseamnă că poți modela SeaRM în jurul proceselor **tale**, în loc să le forțezi într-un sistem rigid.

SeaRM oferă flexibilitate totală:
...
Identifică principalele concepte cu care lucrezi. SeaRM oferă deja:
...
<Tip>
  Vrei ajutor la proiectarea modelului tău de date? [Găsește un partener certificat](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) pentru a proiecta și construi obiectele, câmpurile și relațiile tale.
</Tip>
