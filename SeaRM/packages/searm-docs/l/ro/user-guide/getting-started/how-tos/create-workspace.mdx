...
description: Urmați un ghid pas cu pas despre cum să vă înregistrați pe SeaRM, să alegeți un plan de abonament și să vă configurați contul.
---
...
1. Navigați la [SeaRM Sign Up](https://app.searm.com).
...
Pentru întrebări sau ajutor, contactați echipa de suport dedicată la [contact@searm.com](mailto:contact@searm.com) sau trimiteți un mesaj pe [Discord](https://discord.gg/cx5n4Jzs57).
