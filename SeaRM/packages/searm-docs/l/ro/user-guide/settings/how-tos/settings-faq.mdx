...
description: Întrebări frecvente despre setările SeaRM.
---
...
Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@searm.com](mailto:contact@searm.com).
</Accordion>
...
* **Subdomeniu**: Folosiți un subdomeniu SeaRM, de exemplu `yourcompany.searm.com`
