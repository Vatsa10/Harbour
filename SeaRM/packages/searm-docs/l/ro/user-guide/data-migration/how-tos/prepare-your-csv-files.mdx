...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în SeaRM.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă SeaRM.
...
SeaRM impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în SeaRM
...
* Trebuie să fie unic (fără duplicate în fișier sau în SeaRM)
...
* Trebuie să fie unic în fișierul dvs. și în SeaRM
...
* **Linkuri / Etichetă link**: `SeaRM`
* **Linkuri / URL link**: `https://searm.com`
...
* **Opțional**: SeaRM generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în SeaRM
...
## Pasul 6: Asigurați-vă că câmpurile există în SeaRM
