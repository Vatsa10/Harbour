...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către SeaRM.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către SeaRM. Procesul implică auditarea datelor, pregătirea spațiului de lucru SeaRM, exportul din sistemul curent și importul în SeaRM.
...
Creați un document de mapare între CRM-ul curent și SeaRM:
...
## Pasul 3: Configurați spațiul dvs. de lucru SeaRM

Înainte de a importa date, pregătiți spațiul dvs. de lucru SeaRM:
...
Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în SeaRM înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru SeaRM.
...
3. Verificați că nu există deja duplicate în SeaRM
...
Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului SeaRM și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru SeaRM
...
* SeaRM va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în SeaRM.
  </Accordion>
...
<Tip>
  Vrei ajutor cu migrarea? [Găsește un partener certificat de douăzeci de parteneri](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) pentru a-ți muta datele, conductele și utilizatorii de la un capăt la altul.
</Tip>
