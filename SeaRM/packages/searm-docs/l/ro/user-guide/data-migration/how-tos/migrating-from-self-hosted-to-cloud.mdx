...
description: Ghid pas cu pas pentru migrarea instanței SeaRM auto-găzduite la SeaRM Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță SeaRM auto-găzduită către SeaRM Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.searm.com](https://app.searm.com) și creați un nou spațiu de lucru
...
<Tip>
  Migrați un spațiu de lucru mare sau complex? [Găsiți un partener SeaRM certificat](https://searm.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) care să gestioneze migrarea de la un capăt la altul. *(Sau implicați echipa noastră: [contact@searm.com](mailto:contact@searm.com).)*
</Tip>
