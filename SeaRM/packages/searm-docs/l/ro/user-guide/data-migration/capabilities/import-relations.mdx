...
SeaRM acceptă importul relațiilor dintre obiecte în timpul importului CSV. Acest lucru vă permite să conectați înregistrări (de ex., să atașați Persoane la Companii) ca parte a migrării datelor.
...
## Cum funcționează relațiile în SeaRM

### Unu la mulți / Mulți la unu

SeaRM acceptă relații standard în care o înregistrare se leagă de multe altele:
...
Înainte de a importa partea „mulți”, înregistrările de pe partea „unu” trebuie să existe deja în SeaRM.
...
4. SeaRM va lega automat fiecare înregistrare de părintele corespunzător
...
<Note>**Conectarea la Membrii Workspace-ului**: Când relația indică către Membrii Workspace-ului (echipa dvs. care se autentifică în SeaRM), referiți-vă la ei prin **adresa de email**, nu prin nume.</Note>
