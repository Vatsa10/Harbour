...
* Predicatele pot face referire la obiecte și câmpuri deținute de aplicația ta sau de obiectele standard ale SeaRM.
...
* Vedeți un exemplu funcțional: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
