...
description: Implementați și gestionați SeaRM pe propria infrastructură.
---

<Frame>
  <img src="/images/user-guide/what-is-searm/20.png" alt="AI" />
</Frame>

## Prezentare generală

SeaRM poate fi găzduit în regim propriu pe propria infrastructură, oferindu-vă control complet asupra datelor și a implementării.
