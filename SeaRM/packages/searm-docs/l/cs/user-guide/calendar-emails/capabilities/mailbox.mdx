...
description: Porozumění funkcím e-mailové integrace v SeaRM.
---
...
SeaRM automaticky propojuje emaily z vašich připojených schránek s příslušnými CRM záznamy, udržuje historii komunikace na jednom místě.
...
SeaRM importuje e-maily rychlostí přibližně **400 zpráv za minutu**. Tato rychlost je v současnosti omezena omezením rychlosti Gmail API (a podobně to platí i pro další poskytovatele).
...
Zvolte, zda se mají interní e-maily v SeaRM synchronizovat:
...
* **Chybějící emaily**: Zkontrolujte, zda:
  ...
  * Automatické vytváření kontaktů je deaktivováno (emaily potřebují existující záznamy SeaRM)
