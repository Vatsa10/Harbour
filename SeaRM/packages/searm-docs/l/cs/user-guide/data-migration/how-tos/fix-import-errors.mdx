...
Po nahrání souboru a namapování sloupců SeaRM vaše data ověří:

1. **Proběhne validace** — SeaRM zkontroluje každý řádek na chyby
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Duplicitní hodnoty zvýrazněné žlutě                                   | Hodnota již existuje v SeaRM nebo se ve vašem souboru vyskytuje dvakrát |
...
**Možnost 3: Nechte SeaRM aktualizovat existující záznam**
...
3. SeaRM aktualizuje existující záznam místo vytvoření duplicity
...
Pokud se shoduje alespoň jeden jedinečný identifikátor, SeaRM záznam aktualizuje.
</Note>
...
3. Zkontrolujte, zda záznamy v SeaRM již existují
...
To znamená, že v SeaRM neexistuje společnost s tímto konkrétním identifikátorem.
...
Pokoušíte se propojit se záznamem, který v SeaRM neexistuje.
...
Sloupec ve vašem souboru nelze namapovat, protože pole v SeaRM neexistuje.
...
1. **Uživatel nepřijal pozvánku** — uživatel zatím v SeaRM neexistuje
2. **Používáte uživatelské ID ze starého systému** — SeaRM nedokáže spárovat ID z jiného systému
3. **Nesprávný formát e-mailu** — e-mail neodpovídá účtu uživatele v SeaRM

### Jak to opravit

1. Ujistěte se, že všichni uživatelé **přijali svou pozvánku** do vašeho pracovního prostoru SeaRM
2. Použijte **e-mailovou adresu** uživatele (ne jeho jméno nebo ID ze starého systému)
3. Použijte stejný e-mail, jaký použili k připojení do SeaRM
...
<Check>Formát domény přesně odpovídá formátu SeaRM</Check>
...
1. **Stáhněte si ukázkový soubor** — uvidíte přesný formát, který SeaRM očekává
