...
description: Podrobný průvodce krok za krokem pro migraci vaší instance SeaRM hostované na vlastním serveru do SeaRM Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance SeaRM hostované na vlastním serveru do SeaRM Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.searm.com](https://app.searm.com) a vytvořte nový pracovní prostor
...
<Tip>
  Migrujete velký nebo složitý pracovní prostor? [Najměte si certifikovaného partnera SeaRM](https://searm.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), který za vás zajistí kompletní přesun od začátku do konce. *(Nebo do komunikace zapojte náš tým: [contact@searm.com](mailto:contact@searm.com).)*
</Tip>
