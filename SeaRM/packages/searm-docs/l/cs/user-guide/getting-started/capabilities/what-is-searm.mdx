---
title: Co je SeaRM
description: SeaRM je open-source CRM systém, který vám poskytuje stavební bloky k vytvoření přesně toho, co vaše firma potřebuje.
---
...
Zpočátku vypadá SeaRM jako většina CRM, které již znáte: můžete sledovat obchody, organizovat kontakty, řídit úkoly a poznámky.
...
Open-source je základ našeho přístupu, zajišťuje, že SeaRM se vyvíjí se svou komunitou, pro svou komunitu.
...
[Zaregistrujte se zde](https://app.searm.com) nebo [připojte se jako přispěvatel na GitHub] (https://github.com/Vatsa10/Harbour).
