...
description: Zjistěte, jaké akce jsou k dispozici v pracovních postupech SeaRM.
---
...
<Note>
E-maily můžete odesílat pouze z poštovních schránek synchronizovaných s vaším vlastním účtem SeaRM. Odesílání z poštovních schránek ostatních členů týmu (např. e-mail vlastníka účtu) je v plánu.
</Note>
...
Na pozadí je každá akce Code podpořena vlastní **logickou funkcí** — serverovou funkcí v TypeScriptu, která běží na platformě SeaRM. Když přidáte akci Code, SeaRM vytvoří pro tento krok vyhrazenou logickou funkci a zobrazí její editor přímo inline, takže kód, který napíšete, zůstává u pracovního postupu.
