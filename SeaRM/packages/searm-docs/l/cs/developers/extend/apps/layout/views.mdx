...
* `objectUniversalIdentifier` určuje, na který objekt se toto zobrazení vztahuje. Může to být vlastní objekt, který jste definovali, nebo standardní objekt SeaRM.
...
Všechny výše uvedené výčtové typy jsou exportovány z `searm-sdk/define`.
