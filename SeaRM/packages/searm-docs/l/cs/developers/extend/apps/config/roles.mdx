...
* Predikáty mohou odkazovat na objekty a pole vlastněné vaší aplikací nebo na standardní objekty SeaRM.
...
* Podívejte se na funkční příklad: [`examples/hello-world/src/roles/default-role.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/hello-world/src/roles/default-role.ts).
