...
description: Vytvořte skutečnou aplikaci SeaRM, která generuje personalizované dokumenty z vašich CRM dat.
---
...
lokální server SeaRM běžící na portu `2020` a CLI k němu přihlášené.
...
Nechte `yarn searm dev` běžet v terminálu po celý tutoriál. Pokaždé, když
