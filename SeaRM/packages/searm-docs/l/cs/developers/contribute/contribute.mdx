---
title: Přispět
description: Přispějte k open-source vývoji SeaRM.
---
...
SeaRM je open-source a vítá příspěvky od komunity. Ať už opravujete chyby, přidáváte funkce nebo zlepšujete dokumentaci, vaše příspěvky pomáhají zlepšovat SeaRM pro všechny.
