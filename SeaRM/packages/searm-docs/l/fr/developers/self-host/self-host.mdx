...
description: Déployez et gérez SeaRM sur votre propre infrastructure.
---

<Frame>
  <img src="/images/user-guide/what-is-searm/20.png" alt="IA" />
</Frame>

## Vue d'ensemble

SeaRM peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
