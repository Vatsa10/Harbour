...
voir [`generate-document-input.schema.ts`](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/logic-functions/schemas/generate-document-input.schema.ts).
