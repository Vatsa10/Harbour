...
description: Suivez un guide étape par étape expliquant comment s'inscrire sur SeaRM, choisir un plan d'abonnement et configurer votre compte.
---
...
1. Allez sur [Inscription à SeaRM](https://app.searm.com).
...
Pour toute question ou aide, contactez l'équipe de support dédiée à [contact@searm.com](mailto:contact@searm.com) ou envoyez un message sur [Discord](https://discord.gg/cx5n4Jzs57).
