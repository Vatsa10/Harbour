...
description: Formats de fichiers pris en charge pour l’importation de données dans SeaRM.
---

## Formats pris en charge

SeaRM prend en charge trois formats de fichiers pour l’importation :
