...
Après avoir téléversé votre fichier et fait la correspondance des colonnes, SeaRM valide vos données :

1. **Exécution de la validation** — SeaRM vérifie chaque ligne pour détecter des erreurs
...
| ----------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Valeurs en double surlignées en jaune                                         | La valeur existe déjà dans SeaRM ou apparaît deux fois dans votre fichier |
...
**Option 3 : Laisser SeaRM mettre à jour l'enregistrement existant**
...
3. SeaRM mettra à jour l'enregistrement existant au lieu de créer un doublon
...
Tant qu'un identifiant unique correspond, SeaRM met à jour l'enregistrement.
</Note>
...
3. Vérifiez si des enregistrements existent déjà dans SeaRM
...
Cela signifie qu'il n'existe aucune entreprise dans SeaRM avec cet identifiant précis.
...
Vous essayez de lier un enregistrement qui n'existe pas dans SeaRM.
...
Une colonne de votre fichier ne peut pas être mise en correspondance car le champ n'existe pas dans SeaRM.
...
1. **L'utilisateur n'a pas accepté son invitation** — l'utilisateur n'existe pas encore dans SeaRM
2. **Utilisation de l'ID utilisateur de l'ancien système** — SeaRM ne peut pas faire correspondre les ID d'un autre système
3. **Format d'e-mail incorrect** — l'adresse e-mail ne correspond pas au compte SeaRM de l'utilisateur

### Comment corriger

1. Assurez-vous que tous les utilisateurs ont **accepté leur invitation** à votre espace de travail SeaRM
2. Utilisez l'**adresse e-mail** de l'utilisateur (pas son nom ni l'ID de l'ancien système)
3. Utilisez la même adresse e-mail que celle utilisée pour rejoindre SeaRM
...
<Check>Le format de domaine correspond exactement au format de SeaRM</Check>
...
1. **Téléchargez le fichier d'exemple** — voyez le format exact attendu par SeaRM
