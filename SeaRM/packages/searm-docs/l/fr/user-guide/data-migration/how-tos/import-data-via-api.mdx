...
description: Quand et comment utiliser les API de SeaRM pour des importations de données à grande échelle.
---

## Vue d'ensemble

SeaRM propose des **API GraphQL** et **REST** pour l'importation programmatique de données. Utilisez l'API lorsque l'importation CSV n'est pas pratique pour votre volume de données ou lorsque vous avez besoin d'importations automatisées et récurrentes.
...
SeaRM applique des limites de débit pour garantir la stabilité du système :
...
SeaRM prend en charge deux types d'API :
...
* Vérifiez que les formats correspondent aux exigences de SeaRM (voir [Correspondance des champs](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
* Vérifiez que les données s'affichent correctement dans SeaRM
...
Contactez-nous à [contact@searm.com](mailto:contact@searm.com) ou découvrez nos [services de mise en œuvre](/l/fr/user-guide/getting-started/capabilities/implementation-services).
