...
L'authentification unique (SSO) permet aux membres de votre équipe de se connecter à SeaRM en utilisant le fournisseur d'identité de votre organisation. Cela offre :
...
SeaRM prend en charge le SSO avec :
...
* Retirez-les de l'espace de travail SeaRM
...
* **Correspondance de groupes** : Faites correspondre les groupes IdP aux rôles SeaRM (si disponible)
* **Processus de départ** : Incluez SeaRM dans votre workflow de déprovisionnement
...
<Tip>
Vous avez besoin de configurer le SSO pour votre organisation ? [Trouvez un partenaire SeaRM certifié](https://searm.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) spécialisé en SSO et en gestion des identités. *(Vous préférez impliquer directement SeaRM ? [contact@searm.com](mailto:contact@searm.com))*
</Tip>
