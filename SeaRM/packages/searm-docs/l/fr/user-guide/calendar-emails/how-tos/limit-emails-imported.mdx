...
description: Contrôlez quels e-mails sont importés dans SeaRM.
---

## Vue d'ensemble

Par défaut, SeaRM synchronise tous les e-mails externes depuis votre boîte aux lettres connectée. Vous pouvez limiter ce qui est importé à l’aide de la **sélection de dossiers** et des **paramètres de visibilité**.
...
Les messages entre collègues (même domaine) peuvent être synchronisés dans SeaRM :
