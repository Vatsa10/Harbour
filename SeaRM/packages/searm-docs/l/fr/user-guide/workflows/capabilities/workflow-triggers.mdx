...
* Pour les requêtes POST, définissez la structure attendue du corps afin que SeaRM sache quelles données attendre. Ajoutez ici les champs que vous recevrez et qui seront nécessaires plus bas dans votre flux de travail.
