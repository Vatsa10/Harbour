---
title: Générer un PDF depuis SeaRM
description: Créez un flux de travail pour générer et joindre un PDF (par exemple un devis) à un enregistrement.
---

Générez ou récupérez automatiquement un PDF et joignez-le à un enregistrement dans SeaRM. Cette fonctionnalité est couramment utilisée pour créer des devis, des factures ou des rapports liés aux Entreprises, aux Opportunités ou à d'autres objets.
...
2. Téléversement du fichier dans SeaRM
...
export const main = async (
  ...
  // Replace with your SeaRM GraphQL endpoints (/metadata for metadata and files or /graphql for your records)
  // Cloud: https://api.searm.com/graphql
  // Self-hosted: https://your-domain.com/graphql

  const metadataGraphqlEndpoint = 'https://api.searm.com/metadata';
  const dataGraphqlEndpoint = 'https://api.searm.com/graphql';
...
* [Générer un devis ou une facture depuis SeaRM](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-searm)
