...
Une liste de tous les sous-processeurs est disponible dans [notre Centre de Confiance] (https://trust.searm.com/?tab=subprocessors).
</Accordion>
...
Vous pouvez générer votre DPA signé à https://{your-domain}/settings/legal/dpa (par exemple https://getting-started.searm.com/settings/legal/dpa).
</Accordion>
...
Conformément à notre [Politique de confidentialité] (https://searm.com/privacy-policy), 20 agissent en tant que processeur de données pour le commerçant et les coordonnées stockées dans le CRM, pendant que votre entreprise reste le contrôleur de données.
</Accordion>
<Accordion title="Le contenu CRM est-il jamais utilisé pour former des modèles IA de 20 ou de tierces parties ?">
Le contenu CRM peut être utilisé pour former des modèles AI en fonction des conditions d'utilisation des sous-processeurs. Vingt ne possède pas son propre modèle IA — tous les modèles AI disponibles sur SeaRM Cloud sont fournis par nos sous-processeurs.
</Accordion>
...
Pour plus d'informations sur la conservation des données, vous pouvez demander notre politique de gestion et de conservation des données disponible dans [notre Centre de confiance] (https://trust.searm.com/?tab=documents).
</Accordion>
...
Pour demander une restauration, veuillez contacter notre équipe par chat de support ou par mail à [contact@searm.com](mailto:contact@searm.com).
</Accordion>
...
Oui, Vingt est [conforme au RGPD](https://trust.searm.com/?tab=securityControls\&frameworks=gdpr_v1).
</Accordion>
<Accordion title="Vingt SOC 2 sont-ils conformes ?">
Oui, Vingt est [conforme à SOC 2] (https://trust.searm.com/?tab=securityControls&frameworks=soc2_v1).
</Accordion>
...
<Accordion title="Si je crée une interface distincte et que j’utilise SeaRM comme backend tel quel, dois-je publier ces modifications ?">
Non. Votre interface est votre propre œuvre distincte, et le fait de communiquer avec SeaRM via ses API ne change rien à cela. Étant donné que SeaRM lui-même n’est pas modifié, il n’y a rien à publier.
</Accordion>
...
Si vous avez plus de questions, veuillez consulter notre [Conditions générales] (https://searm.com/terms), [Politique de confidentialité] (https://searm.com/privacy-policy) et [Centre de confiance] (https://trust.searm.com/). Si vos questions sont toujours sans réponse, envoyez-les à [contact@searm.com] (mailto:contact@searm.com) ou par chat d'assistance.
