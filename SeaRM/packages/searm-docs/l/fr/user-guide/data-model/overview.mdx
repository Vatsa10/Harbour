...
SeaRM inclut des objets standard :
...
Chaque entreprise fonctionne différemment. La personnalisation de votre modèle de données vous permet de façonner SeaRM autour de **vos** processus au lieu de forcer les vôtres dans un système rigide.

SeaRM offre une flexibilité totale :
...
Identifiez les principaux concepts avec lesquels vous travaillez. SeaRM propose déjà :
...
<Tip>
  Besoin d'aide pour concevoir votre modèle de données ? [Trouver un partenaire certifié Vingt partenaires] (https://searm.com/partners/list?categories=SOLUTIONING&ref=docs-data-model) pour concevoir et construire vos objets, champs et relations.
</Tip>
