...
icon: laptop-code
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل SeaRM محلياً.
---
...
قبل أن تتمكن من تثبيت واستخدام SeaRM، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب SeaRM مخزن بيانات Redis لتقديم أفضل أداء.
...
## الخطوة الثامنة: استخدم SeaRM

**الواجهة الأمامية**

ستكون واجهة SeaRM الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم SeaRM متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
