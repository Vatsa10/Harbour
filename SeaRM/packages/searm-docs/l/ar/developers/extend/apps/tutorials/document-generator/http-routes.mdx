...
والمستضافة ذاتيًا، يتم تقديم هذا المسار بواسطة خادم SeaRM الخاص بك
(مثلًا: `http://localhost:2020/s/documents/generate`). على SeaRM Cloud، يقوم `RestApiClient`
...
محسوسة) ويسقط في نظيف، صفحة قابلة للطباعة تعرض فقط محتوى القالب- نفس مظهر PDF والمعاينة داخل التطبيق.
  [انظر المساعد](https://github.com/Vatsa10/Harbour/blob/main/packages/searm-apps/examples/document-generator/src/utils/render-document.ts).
