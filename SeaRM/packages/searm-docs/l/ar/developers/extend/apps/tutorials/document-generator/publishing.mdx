...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.searm.com/l/ar/developers/extend/apps',
...
[`packages/XXapps/examples/document-Generator`](https://github.com/Vatsa10/Harbour/tree/main/packages/searm-apps/examples/document-generator).
