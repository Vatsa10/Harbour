...
**طبقة العمليات** هي كل ما تفعله *على* تطبيقك وليس *به*: استدعاء أوامر CLI، وتشغيل اختبارات التكامل على خادم SeaRM حقيقي، وإعداد CI، وإطلاق الإصدارات — إما كملف tarball يُنشر على خادم واحد أو كحزمة npm مُدرجة في المتجر.
...
<CardGroup cols={2}>
  <Card title="CLI" icon="terminal" href="/l/ar/developers/extend/apps/operations/cli">
    مرجع `yarn searm` — exec، logs، uninstall، remotes.
  </Card>
