...
**Your CRM, in the conversation — ask SeaRM anything from Slack and post back to any channel.**

## ✨ What you get

- **A CRM assistant in Slack** — `@searm how many open opportunities do we have?` or `@searm create a company called ACME`. It answers in-thread, remembers the thread, and can read, create, update and soft-delete records
...
- **Send from anywhere in SeaRM** — the **Send Slack message** command opens a side panel to pick a channel and post
...
One Slack workspace answers into one SeaRM workspace.
