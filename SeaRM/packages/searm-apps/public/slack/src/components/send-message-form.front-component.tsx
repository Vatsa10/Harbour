...
import { closeSidePanel, enqueueSnackbar, unmountFrontComponent } from 'searm-sdk/front-component';
...
const callAppRoute = async <TResponse,>(
  ...
  const apiBaseUrl = process.env.SEARM_API_URL;
  const token =
    process.env.SEARM_APP_ACCESS_TOKEN ?? process.env.SEARM_API_KEY;
