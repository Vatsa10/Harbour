# Postcard App — SeaRM App Example

A rich example app showcasing all SeaRM app entity types. Use this as a reference when building your own apps.

## What's included

This app demonstrates every entity type available in the SeaRM SDK:
...
| **Front Components** | `src/components/` | React components rendered inside SeaRM's UI |
...
- [Getting Started](https://docs.searm.com/developers/extend/apps/getting-started)
- [Building Apps](https://docs.searm.com/developers/extend/apps/building)
- [Publishing](https://docs.searm.com/developers/extend/apps/publishing)
