...
- **A hands-on reference** — this is the app built in the [Document Generator tutorial](https://docs.searm.com/developers/extend/apps/tutorials/document-generator/overview), a tour through most of the SeaRM SDK.
