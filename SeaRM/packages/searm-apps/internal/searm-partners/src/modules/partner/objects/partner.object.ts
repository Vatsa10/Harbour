...
export default defineObject({
  ...
  fields: [
    ...
    {
      // Legacy URL picture, kept as LINKS. SeaRM treats field type as
    ...
    },
    {
      ...
      type: FieldType.MULTI_SELECT,
      name: 'searmExperience',
      label: 'SeaRM Experience',
      icon: 'IconTool',
      isNullable: true,
      options: [
        {
    ...
    },
    {
      ...
      label: 'SeaRM Experience Proof Link',
      icon: 'IconLink',
      isNullable: true,
    },
    {
