import { defineObject, FieldType, RelationType, OnDeleteAction, STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS } from 'searm-sdk/define';
...
export default defineObject({
  ...
  fields: [
    ...
    },
    {
      ...
      name: 'isSeaRM',
      label: 'Is SeaRM',
      description: 'Whether the user is from SeaRM',
      defaultValue: false,
      universalIdentifier:
        UNIVERSAL_IDENTIFIERS.objects.selfHostingUser.fields.isSeaRM
          .universalIdentifier,
    },
    {
      type: FieldType.TEXT,
