...
| Page layout tab      | `yarn searm dev:add pageLayoutTab`      | `src/page-layout-tabs/<name>.ts`      |
| Command menu item    | `yarn searm dev:add commandMenuItem`    | `src/command-menu-items/<name>.ts`    |
| View field           | `yarn searm dev:add viewField`          | `src/view-fields/<name>.ts`           |
| Connection provider  | `yarn searm dev:add connectionProvider` | `src/connection-providers/<name>.ts`  |
