...
Publishing with provenance is also how you prove ownership when claiming your app in a SeaRM marketplace.
...
- [SeaRM Apps documentation](https://docs.searm.com/developers/extend/apps/getting-started/quick-start)
- [searm-sdk CLI reference](https://www.npmjs.com/package/searm-sdk)
