...
import { SEARM_LOGO_MARK_PATH } from '@/cli/utilities/build/cover/assets/searm-logo-mark-path';
...
const SEARM_MARK_VIEWBOX = 40;
const SEARM_MARK_SCALE = TILE_SIZE / SEARM_MARK_VIEWBOX;
...
export const generateCoverImage = async ({
  ...
  const svg = [
    ...
    `<g transform="translate(${RIGHT_TILE_X} ${TILE_Y}) scale(${SEARM_MARK_SCALE})"><path d="${SEARM_LOGO_MARK_PATH}" fill="#ffffff" /></g>`,
