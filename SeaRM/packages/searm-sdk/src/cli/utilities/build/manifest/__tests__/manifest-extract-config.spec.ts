...
describe('extractDefineEntity', () => {
  ...
  it('should detect defineField in default export', () => {
    const fileContent = `
      import { defineField } from 'searm-sdk/define';
  ...
  it('should detect defineObject in default export', () => {
    const fileContent = `
      import { defineObject } from 'searm-sdk/define';
  ...
  it('should detect defineRole in default export', () => {
    const fileContent = `
      import { defineRole } from 'searm-sdk/define';
  ...
  it('should detect defineApplicationRole in default export', () => {
    const fileContent = `
      import { defineApplicationRole } from 'searm-sdk/define';
  ...
  it('should not detect non-target function in default export', () => {
    const fileContent = `
      import { someOtherFunction } from 'searm-sdk/define';
