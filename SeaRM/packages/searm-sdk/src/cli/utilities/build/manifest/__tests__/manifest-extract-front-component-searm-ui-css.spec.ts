...
describe('extractManifestFromFile - front component importing searm-ui', () => {
  it('extracts the config from a front component that side-effect imports searm-ui/style.css', async () => {
