...
// stay in `searm-sdk/define` — they are build-time metadata factories that
// the SDK CLI stubs out before bundling. Logic-function source files keep
// importing them from `searm-sdk/define`, but should reach for *types* (and
// future runtime helpers) here, never directly from `searm-shared/*`.
...
export type { ServerRouteDispatchResult } from 'searm-shared/application';
...
} from 'searm-shared/logic-function';
...
export type { RunAgentInput, RunAgentResult } from 'searm-shared/application';
...
export type { AppKeyValue, AppKeyValueScope } from 'searm-shared/application';
