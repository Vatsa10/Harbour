    ...
    cards: [
      {
        ...
        description: t`Open SeaRM's official ChatGPT integration for your workspace.`,
        ctaLabel: t`Open`,
        href: MCP_SETUP.chatGptSearmAppUrl,
        logo: <McpClientLogo src={OpenAiLogo} invertInDarkMode />,
      },
      {
        title: t`Claude`,
        badge: t`Preset link`,
        description: t`Open Claude with the SeaRM connector name and MCP URL prefilled.`,
        ctaLabel: t`Install`,
    ...
    cards: [
      {
        ...
        description: t`Open Cursor's MCP installer with the SeaRM remote server config.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        title: t`Goose`,
        badge: t`Install link`,
        description: t`Add SeaRM as a Streamable HTTP extension in Goose.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        ...
        badge: t`Install link`,
        description: t`Open Replit with the SeaRM remote server config.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        title: t`LM Studio`,
        badge: t`Install link`,
        description: t`Add the SeaRM remote server with LM Studio's install link.`,
        ctaLabel: t`Install`,
      ...
      },
      {
        title: t`Cline`,
        badge: t`Manual`,
        description: t`Configure the SeaRM MCP server manually in Cline.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`Zed`,
        badge: t`Manual`,
        description: t`Add the SeaRM MCP server as a remote context server in Zed.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        ...
        badge: t`Manual`,
        description: t`Configure the SeaRM MCP server manually in Cascade.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`Raycast`,
        badge: t`Settings`,
        description: t`Add the SeaRM MCP server from Raycast's MCP commands or settings.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`Gemini CLI`,
        badge: t`CLI config`,
        description: t`Add the SeaRM MCP server in Gemini CLI settings.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        title: t`LibreChat`,
        badge: t`YAML config`,
        description: t`Add the SeaRM MCP server to your LibreChat configuration file.`,
        ctaLabel: t`Docs`,
      ...
      },
      {
        ...
        badge: t`Settings`,
        description: t`Add the SeaRM MCP server from Augment Code settings.`,
        ctaLabel: t`Docs`,
