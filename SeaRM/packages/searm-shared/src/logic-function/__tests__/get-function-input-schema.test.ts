...
describe('getFunctionInputSchema', () => {
  ...
  it('should resolve SearmRecord markers to record schemas', () => {
    const fileContent = `
        export const main = (params: {
          company: SearmRecord<'company-universal-identifier'>;
          companies: SearmRecord<'company-universal-identifier'>[];
          otherCompanies: Array<SearmRecord<'company-universal-identifier'>>;
        }): void => {
          return;
        };
      `;
  ...
  it('should leave a bare SearmRecord without a literal argument unresolved', () => {
    const fileContent = `
        export const main = (params: { record: SearmRecord }): void => {
          return;
        };
      `;
    const result = getFunctionInputSchema(fileContent);
