...
const PUBLIC_DOCS_MCP_SERVER_NAME = 'searm-docs';
const PUBLIC_DOCS_MCP_URL = 'https://docs.searm.com/mcp';
...
const isAllowedDocumentationHost = (hostname) => {
  ...
  return (
    ...
    host === 'example.searm.com' ||
    host === 'myworkspace.searm.com' ||
    host === 'myworkspace.customdomain.com' ||
    host === 'your-searm-server.com' ||
    host === 'app.searm.com' ||
    host === 'searm.com' ||
    host === 'docs.searm.com' ||
    host === 'www.docker.com' ||
