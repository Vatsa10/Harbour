...
const REQUIRED_REFERENCES = [
  ...
  'references/use-searm-mcp/setup.md',
  'references/use-searm-mcp/result-formatting.md',
];
...
const assertHowAppsWork = (fail) => {
  ...
  // use-searm-mcp is intentionally excluded: it covers consuming the SeaRM MCP
