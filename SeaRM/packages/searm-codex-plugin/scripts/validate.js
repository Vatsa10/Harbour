...
crossDocContracts.assertSearmMcpFormattingContract(fail);
...
if (failures.length > 0) {
  console.error('SeaRM Codex plugin validation failed:');
...
console.log('SeaRM Codex plugin validation passed.');
