...
import { DEFAULT_API_URL_NAME } from 'searm-shared/application';
...
import searmClientTemplateSource from './searm-client-template.ts?raw';
...
export const generateCoreClientFromSchema = async ({
  ...
  const templateSource =
    clientWrapperTemplateSource ?? searmClientTemplateSource;
...
// an installed searm-client-sdk package (dist/core.mjs and dist/core.cjs).
